<template>
    <div>
        ...
        <table cellpadding="0"
            style="border-collapse: collapse; font-size: 12.5px; background-color: rgb(249, 246, 245);">
            <tr>
                <td
                    style="margin: 0.1px; padding: 20px; font: 12.5px / 15.9px &quot;Lucida Console&quot;, Monaco, monospace; color: rgb(0, 0, 1);">
                    <table cellpadding="0" style="border-collapse: collapse;">
                        <tr>
                            ...
                            <td valign="top"
                                style="margin: 0.1px; padding: 0px; font: 12.5px / 15.9px &quot;Lucida Console&quot;, Monaco, monospace; color: rgb(0, 0, 1);">
                                <table cellpadding="0" style="border-collapse: collapse;">
                                    <tr>
                                        <td
                                    ...
                                    <tr>
                                        <td
                                            ...
                                            <table cellpadding="0" style="border-collapse: collapse;">
                                                <tr>
                                                    <td
                                                        style="margin: 0.1px; padding: 0px 5px 0px 0px; font: 12.5px / 15.9px &quot;Lucida Console&quot;, Monaco, monospace; color: rgb(0, 0, 1); cursor: pointer;">
                                                        <span
                                                            style="border-radius: 50%; width: 20px; height: 20px; display: block; text-align: center; background-color: rgb(201, 185, 179); font-size: 12px; font-family: initial; line-height: 1;"><svg
            ...
            <table width="500" cellpadding="0" style="border-collapse: collapse;">
                <tr>
                    <td style="padding: 15px 10px 0px 0px; margin: 0.1px; cursor: pointer;"><span><img
                                alt="Discover our latest business programs"
