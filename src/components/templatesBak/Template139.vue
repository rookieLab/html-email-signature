                    ...
                    <table cellpadding="0" style="border-collapse: collapse;">
                        <tr>
                            <td valign="top" style="margin: 0.1px; padding: 0px 12px 0px 0px; cursor: pointer;"><img
                                    src="https://img.mysignature.io/p/5/4/c/54cc234b-18cb-5bb3-80ac-1a8a4b5371a6.png?time=1708944823"
                                    width="124" alt=" &quot;created with MySignature.io&quot;"
                                    style="display: block; min-width: 124px;"></td>
                            <td valign="top"
                                style="border-left: 1px solid rgb(121, 54, 54); margin: 0.1px; padding: 0px 0px 0px 12px; font: 13.9px / 17.7px &quot;Times New Roman&quot;, Times, serif; color: rgb(0, 0, 1);">
                                <table cellpadding="0" style="border-collapse: collapse;">
                                    <tr>
                                        <td
                                    ...
                                    <tr style="cursor: pointer;">
                                        <td
                                            style="margin: 0.1px; padding: 0px; font: 13.9px / 17.7px &quot;Times New Roman&quot;, Times, serif; color: rgb(0, 0, 1);">
                                            <span
                                                style="color: rgb(121, 54, 54); font-weight: 600;">E:&nbsp;</span><span
                                                style="color: rgb(121, 54, 54); text-decoration: none; font-family: &quot;Times New Roman&quot;, Times, serif;">thompson@nationalhospital.com</span>
                                        </td>
                                    </tr>
                                    <tr style="cursor: pointer;">
                                        <td
                                    ...
                                    <tr>
                                        <td
                                            ...
                                            <table cellpadding="0" style="border-collapse: collapse;">
                                                <tr>
                                                    <td
                                                        style="margin: 0.1px; padding: 0px 5px 0px 0px; font: 13.9px / 17.7px &quot;Times New Roman&quot;, Times, serif; color: rgb(0, 0, 1); cursor: pointer;">
                                                        <span
                                                            style="border-radius: 15%; width: 20px; height: 20px; display: block; text-align: center; background-color: rgb(121, 54, 54); font-size: 12px; font-family: initial; line-height: 1;"><svg
