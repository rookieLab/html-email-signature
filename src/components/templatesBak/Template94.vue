    ...
    <div><!---->
                        ...
                        <tr>
                            ...
                            <td valign="top" style="margin: 0.1px; padding: 0px;">
                                <table cellpadding="0" style="border-collapse: collapse;">
                                    ...
                                    <tr>
                                        <td
                                            style="margin: 0.1px; padding: 0px 0px 8px; font: 600 12.8px / 16.3px &quot;Times New Roman&quot;, Times, serif; color: rgb(0, 0, 0);">
                                            <span style="cursor: pointer;">Chair, Department of
                                                Biology</span>&nbsp;<span style="cursor: pointer;">Pacific
                                                University</span></td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td
                                            ...
                                            <table cellpadding="0" style="border-collapse: collapse;">
                                                <tr>
                                                    <td
                                                        style="margin: 0.1px; padding: 0px 4px 0px 0px; font: 12.8px / 16.3px &quot;Times New Roman&quot;, Times, serif; color: rgb(0, 0, 1); cursor: pointer;">
                                                        <span
                                                            style="border-radius: 50%; width: 20px; height: 20px; display: block; text-align: center; background-color: rgb(52, 57, 74); font-size: 12px; font-family: initial; line-height: 1;"><svg
        ...
        <div>
            ...
            <table cellpadding="0" width="500"
                style="width: 500px; color: rgb(56, 56, 56); line-height: 1; font-size: 14.1px; border-collapse: collapse;">
                <tr style="cursor: pointer;">
                    <td width="27" height="27" align="center"
                        style="padding: 10px 0px 0px; margin: 0.1px; min-width: 27px;"><svg viewBox="0 0 1024 1024"
