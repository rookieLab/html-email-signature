        ...
        <table cellpadding="0" style="border-collapse: collapse;">
            <tr>
                <td style="margin: 0.1px; padding: 10px 0px; cursor: pointer;"><img width="500"
                        src="https://img.mysignature.io/a/v1/3/5/8/358fd47c-6a83-5d84-9eaa-bb65867e6b92.png"
                        alt="Best wishes,"></td>
            </tr>
        </table>
                                ...
                                <table cellpadding="0" style="border-collapse: collapse;">
                                    ...
                                    <tr style="cursor: pointer;">
                                        <td
                                            ...
                                            <span
                                                style="color: rgb(0, 0, 0); font-weight: 600;">mobile:&nbsp;</span><span
                                                style="color: rgb(0, 0, 1); text-decoration: none; font-family: &quot;Courier New&quot;, Courier, monospace;">+2-535-656-12</span>
                                        </td>
                                    </tr>
                                    <tr style="cursor: pointer;">
                                        <td
                                            ...
                                            <span
                                                ...
                                                style="color: rgb(0, 0, 1); text-decoration: none; font-family: &quot;Courier New&quot;, Courier, monospace;">globalsales.io</span>
                                        </td>
                                    </tr>
                                    <tr style="cursor: pointer;">
                                        <td
                                    ...
                                    <tr>
                                        <td
                                            ...
                                            <table cellpadding="0" style="border-collapse: collapse;">
                                                <tr>
                                                    <td
                                                        style="margin: 0.1px; padding: 0px 4px 0px 0px; font: 14.9px / 18.9px &quot;Courier New&quot;, Courier, monospace; color: rgb(0, 0, 1); cursor: pointer;">
                                                        <span
                                                            style="border-radius: 15%; width: 24px; height: 24px; display: block; text-align: center; background-color: rgb(24, 119, 242); font-size: 12px; font-family: initial; line-height: 1;"><svg
                                                    ...
                                                    <td
                                                        style="margin: 0.1px; padding: 0px 4px 0px 0px; font: 14.9px / 18.9px &quot;Courier New&quot;, Courier, monospace; color: rgb(0, 0, 1); cursor: pointer;">
                                                        <span
                                                            style="border-radius: 15%; width: 24px; height: 24px; display: block; text-align: center; background-color: rgb(29, 161, 242); font-size: 12px; font-family: initial; line-height: 1;"><svg
                                                    ...
                                                    <td
                                                        style="margin: 0.1px; padding: 0px 4px 0px 0px; font: 14.9px / 18.9px &quot;Courier New&quot;, Courier, monospace; color: rgb(0, 0, 1); cursor: pointer;">
                                                        <span
                                                            style="border-radius: 15%; width: 24px; height: 24px; display: block; text-align: center; background-color: rgb(255, 0, 105); font-size: 12px; font-family: initial; line-height: 1;"><svg
                                                                viewBox="0 0 1024 1024"
                                                                xmlns="http://www.w3.org/2000/svg"
                                                                style="position: relative; top: 4.8px; width: 14.4px;">
                                                                <path
