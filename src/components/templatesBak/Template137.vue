    ...
    <div>
            ...
            <tr>
                <td style="margin: 0.1px; padding: 0px;">
                    <table cellpadding="0" style="border-collapse: collapse;">
                        <tr>
                            <td valign="top"
                                style="margin: 0.1px; padding: 0px 20px 0px 0px; border-right: 3px solid rgb(212, 0, 0);">
                                <table cellpadding="0" style="border-collapse: collapse;">
                                    <tr>
                                        <td
                                    ...
                                    <tr>
                                        <td
                                            ...
                                            <table cellpadding="0" style="border-collapse: collapse;">
                                                <tr>
                                                    <td
                                                        style="margin: 0.1px; padding: 0px 6px 0px 0px; font: 13.1px / 16.7px &quot;Palatino Linotype&quot;, &quot;Book Antiqua&quot;, Palatino, serif; color: rgb(0, 0, 1); cursor: pointer;">
                                                        <span
                                                            style="border-radius: 15%; width: 20px; height: 20px; display: block; text-align: center; background-color: rgb(212, 0, 0); font-size: 12px; font-family: initial; line-height: 1;"><svg
        ...
        <div>
            <table width="352" cellpadding="0" style="border-collapse: collapse;">
                <tr>
                    <td
                        style="margin: 0.1px; padding: 15px 0px 0px; font: 12.1px / 15.3px &quot;Palatino Linotype&quot;, &quot;Book Antiqua&quot;, Palatino, serif; color: rgb(0, 0, 1); cursor: pointer;">
            ...
            <table cellpadding="0" width="500"
                ...
                <tr style="cursor: pointer;">
                    <td width="27" height="27" align="center"
                        style="padding: 23px 0px 0px; margin: 0.1px; min-width: 27px;"><svg viewBox="0 0 1024 1024"
                            xmlns="http://www.w3.org/2000/svg" style="width: 17.55px;">
                            <path
                    ...
                    <td
                        style="font-family: &quot;Palatino Linotype&quot;, &quot;Book Antiqua&quot;, Palatino, serif; font-size: 14.1px; padding: 23px 0px 0px; margin: 0.1px;">
                        <span>Book your seat on our webinar.&nbsp;</span><span
