                    ...
                    <table cellpadding="0" style="border-collapse: collapse;">
                        <tr>
                            <td valign="top" style="margin: 0.1px; padding: 0px 15px 0px 0px; cursor: pointer;"><img
                                    src="https://img.mysignature.io/p/c/1/9/c196f085-aef3-5525-a243-a6515f806b07.png?time=1685569257"
                                    width="94" alt=" &quot;created with MySignature.io&quot;"
                                    style="display: block; min-width: 94px;"></td>
                            <td valign="top" style="margin: 0.1px; padding: 0px 15px 0px 0px;">
                                <table cellpadding="0" style="border-collapse: collapse;">
                                    <tr>
                                        <td
                                            style="margin: 0.1px; padding: 0px; font: 16.3px / 20.8px &quot;Times New Roman&quot;, Times, serif; color: rgb(0, 0, 1);">
                                            <span style="cursor: pointer;">KYNAN BURNS</span></td>
                                    </tr>
                                    <tr>
                                        <td
                                            style="margin: 0.1px; padding: 4px 0px; font: 13.6px / 17.3px &quot;Times New Roman&quot;, Times, serif; color: rgb(0, 0, 1);">
                                            <span style="cursor: pointer;">SOUND PRODUCER</span><span
                                                style="cursor: pointer;"></span><span
                                                style="cursor: pointer;"></span></td>
                                    </tr>
                                    <tr style="cursor: pointer;">
                                        <td
                                            style="margin: 0.1px; padding: 0px; font: 13.6px / 17.3px &quot;Times New Roman&quot;, Times, serif; color: rgb(0, 0, 1);">
                                            <span style="color: rgb(0, 0, 0);">mobile:&nbsp;</span><span
                                                style="color: rgb(0, 0, 1); text-decoration: none; font-family: &quot;Times New Roman&quot;, Times, serif;">404-5566-154</span>
                                        </td>
                                    </tr>
                                    <tr style="cursor: pointer;">
                                        <td
                                            style="margin: 0.1px; padding: 0px; font: 13.6px / 17.3px &quot;Times New Roman&quot;, Times, serif; color: rgb(0, 0, 1);">
                                            <span style="color: rgb(0, 0, 0);">email:&nbsp;</span><span
                                                style="color: rgb(0, 0, 1); text-decoration: none; font-family: &quot;Times New Roman&quot;, Times, serif;">jeremy@mysignature.io</span>
                                        </td>
                                    </tr>
                                </table>
                            </td>
                            <td valign="middle"
                                style="border-left: 3px solid rgb(255, 26, 26); margin: 0.1px; padding: 0px 0px 0px 6px; font: 13.6px / 17.3px &quot;Times New Roman&quot;, Times, serif; color: rgb(0, 0, 1);">
                                <table cellpadding="0" style="border-collapse: collapse;">
                                    <tr>
                                        <td style="margin: 0.1px; padding: 4px 0px 0px; cursor: pointer;"><span
                                                style="border-radius: 50%; width: 25px; height: 25px; display: block; text-align: center; background-color: rgb(255, 26, 26); font-size: 12px; font-family: initial; line-height: 1;"><svg
                                                    viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg"
                                                    style="position: relative; top: 5px; width: 15px;">
                                                    <path
                                                        d="M512.156 0c282.708 0.082 511.844 229.285 511.844 511.993 0 207.095-124.759 393.796-316.096 473.034s-411.565 35.407-557.983-111.053c-146.417-146.46-190.185-366.701-110.891-558.015s266.030-316.019 473.125-315.959zM511.772 58.182c-250.538 0.143-453.57 203.273-453.59 453.812 0 183.57 110.592 349.060 280.197 419.288s364.815 31.362 494.586-98.473c129.772-129.835 168.543-325.064 98.232-494.634s-235.855-280.082-419.425-279.992zM721.455 174.582v142.894l-0.257 353.625v1.026c0 44.492-43.872 80.298-96.063 80.298s-94.231-35.916-94.231-80.298c0-44.382 42.039-80.628 94.231-80.628 21.171-0.127 41.883 6.159 59.412 18.031v0-282.197l-277.817 74.984 2.346 309.097 0.953 22.796c1.833 44.455-42.479 80.334-94.67 80.334s-94.267-35.953-94.267-80.334c0-44.382 42.076-80.628 94.267-80.628 19.156-0.114 37.987 4.951 54.5 14.66v0-255.663h-0.403v-142.931h0.403l351.596-95.067z"
                                                        fill="#FFFFFF"></path>
                                                </svg></span></td>
                                    </tr>
                                    <tr>
            ...
            <table cellpadding="0" style="border-collapse: collapse;">
                <tr>
                    <td style="padding: 13px 4px 4px 0px; margin: 0.1px;"><span><img
                                src="https://img.mysignature.io/addons/v2/youtube_v3_shape3_i.png" height="42"
                                width="147" alt="youtube" style="display: block;"></span></td>
                    <td style="padding: 13px 4px 4px 0px; margin: 0.1px;"><span><img
                                src="https://img.mysignature.io/addons/v2/patreon_v3_shape3_i.png" height="42"
                                width="147" alt="patreon" style="display: block;"></span></td>
