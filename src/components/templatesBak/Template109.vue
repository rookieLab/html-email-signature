<template>
    <div><!---->
        <table cellpadding="0" style="border-collapse: collapse; font-size: 13.6px; background-color: rgb(210, 0, 44);">
            <tr>
                <td
                    style="margin: 0.1px; padding: 20px; font: 13.6px / 17.3px &quot;Palatino Linotype&quot;, &quot;Book Antiqua&quot;, Palatino, serif; color: rgb(0, 0, 1);">
                    <table cellpadding="0" style="border-collapse: collapse;">
                        <tr>
                            <td valign="top" style="margin: 0.1px; padding: 0px 15px 0px 0px; cursor: pointer;"><img
                                    src="https://img.mysignature.io/p/7/d/9/7d97465c-c49b-5989-a125-af23006170a3.png?time=1710786394"
                                    width="167" alt=" &quot;created with MySignature.io&quot;"
                                    style="display: block; min-width: 167px;"></td>
                            <td valign="top"
                                style="margin: 0.1px; padding: 0px; font: 13.6px / 17.3px &quot;Palatino Linotype&quot;, &quot;Book Antiqua&quot;, Palatino, serif; color: rgb(0, 0, 1);">
                                <table cellpadding="0" style="border-collapse: collapse;">
                                    <tr>
                                        <td
                                            style="margin: 0.1px; padding: 0px 0px 5px; font: 17.7px / 22.5px &quot;Palatino Linotype&quot;, &quot;Book Antiqua&quot;, Palatino, serif; color: rgb(255, 255, 255); cursor: pointer;">
                                            <span style="font-weight: 600; cursor: pointer;">Jenny Wilson ■
                                                Designer</span><!----><!----></td>
                                    </tr><!---->
                                    <tr style="cursor: pointer;">
                                        <td
                                            style="margin: 0.1px; padding: 5px 0px 0px; font: 13.6px / 17.3px &quot;Palatino Linotype&quot;, &quot;Book Antiqua&quot;, Palatino, serif; color: rgb(255, 255, 255);">
                                            <span>phone:&nbsp;</span><span
                                                style="color: rgb(255, 255, 255); text-decoration: none; font-family: &quot;Palatino Linotype&quot;, &quot;Book Antiqua&quot;, Palatino, serif;">+1
                                                (684) 555-0102</span>&nbsp;|&nbsp;<span>email:&nbsp;</span><span
                                                style="color: rgb(255, 255, 255); text-decoration: none; font-family: &quot;Palatino Linotype&quot;, &quot;Book Antiqua&quot;, Palatino, serif;">Jenny@mysignature.io</span>
                                        </td>
                                    </tr>
                                    <tr style="cursor: pointer;">
                                        <td
                                            style="margin: 0.1px; padding: 5px 0px 0px; font: 13.6px / 17.3px &quot;Palatino Linotype&quot;, &quot;Book Antiqua&quot;, Palatino, serif; color: rgb(255, 255, 255);">
                                            <!----><span
                                                style="color: rgb(255, 255, 255); text-decoration: none; font-family: &quot;Palatino Linotype&quot;, &quot;Book Antiqua&quot;, Palatino, serif;">mysignature.io</span><!----><!---->
                                        </td>
                                    </tr><!---->
                                    <tr>
                                        <td
                                            style="margin: 0.1px; padding: 10px 0px 0px; font: 13.6px / 17.3px &quot;Palatino Linotype&quot;, &quot;Book Antiqua&quot;, Palatino, serif; color: rgb(0, 0, 1);">
                                            <table cellpadding="0" style="border-collapse: collapse;">
                                                <tr>
                                                    <td
                                                        style="margin: 0.1px; padding: 0px 5px 0px 0px; font: 13.6px / 17.3px &quot;Palatino Linotype&quot;, &quot;Book Antiqua&quot;, Palatino, serif; color: rgb(0, 0, 1); cursor: pointer;">
                                                        <span
                                                            style="border-radius: 0%; width: 27px; height: 27px; display: block; text-align: center; background-color: rgb(255, 253, 253); font-size: 12px; font-family: initial; line-height: 1;"><svg
