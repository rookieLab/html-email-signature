        ...
        <table cellpadding="0" style="border-collapse: collapse; font-size: 12.5px;">
            <tr>
                <td align="center" style="margin: 0.1px; padding: 0px 0px 13px; cursor: pointer;"><img
                        src="https://img.mysignature.io/p/3/a/7/3a76b4d8-e23a-54df-939b-b4f330b238fe.png?time=1692633005"
            ...
            <tr style="cursor: pointer;">
                <td align="center"
                    style="margin: 0.1px; padding: 5px 20px; font: 12.5px / 15.9px Tahoma, Geneva, sans-serif; color: rgb(43, 138, 86); border-bottom: 1px solid rgb(235, 228, 228);">
                    <span>phone:&nbsp;</span><span
                        style="color: rgb(0, 0, 1); text-decoration: none; font-family: Tahoma, Geneva, sans-serif;">307-985-980</span>&nbsp;&nbsp;<span>email:&nbsp;</span><span
                        style="color: rgb(0, 0, 1); text-decoration: none; font-family: Tahoma, Geneva, sans-serif;">pete@mysignature.io</span>
                </td>
            </tr>
            <tr style="cursor: pointer;">
                <td align="center"
                    style="margin: 0.1px; padding: 5px 20px; font: 12.5px / 15.9px Tahoma, Geneva, sans-serif; color: rgb(43, 138, 86); border-bottom: 1px solid rgb(235, 228, 228);">
                    <span>address:&nbsp;</span><span style="color: rgb(0, 0, 1);">9th Ave, fl.
                        3</span>&nbsp;&nbsp;<span>website:&nbsp;</span><span
                        style="color: rgb(0, 0, 1); text-decoration: none; font-family: Tahoma, Geneva, sans-serif;">mysignature.io</span>
                </td>
            </tr>
            <tr>
                <td align="center"
                    style="margin: 0.1px; padding: 10px 0px 0px; font: 12.5px / 15.9px Tahoma, Geneva, sans-serif; color: rgb(0, 0, 1);">
                    <table cellpadding="0" align="center" style="border-collapse: collapse;">
                        <tr>
                            <td style="margin: 0.1px; padding: 0px 2.5px; cursor: pointer;"><span
                                    style="border-radius: 15%; width: 30px; height: 30px; display: block; text-align: center; background-color: rgb(255, 255, 255); font-size: 12px; font-family: initial; line-height: 1;"><svg
