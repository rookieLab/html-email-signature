<template>
    <div><!---->
        <table cellpadding="0" style="border-collapse: collapse; font-size: 12.6px; background-color: rgb(85, 85, 85);">
            <tr>
                <td
                    style="margin: 0.1px; padding: 20px; font: 12.6px / 16.1px &quot;Trebuchet MS&quot;, Helvetica, sans-serif; color: rgb(0, 0, 1);">
                    <table cellpadding="0" style="border-collapse: collapse;">
                        <tr>
                            <td valign="top" style="margin: 0.1px; padding: 0px 15px 0px 0px; cursor: pointer;"><img
                                    src="https://img.mysignature.io/p/8/6/0/86053fbc-8766-5e1d-afa7-d9a58cf0132c.png?time=1685569257"
                                    width="140" alt=" &quot;created with MySignature.io&quot;"
                                    style="display: block; min-width: 140px;"></td>
                            <td valign="top"
                                style="margin: 0.1px; padding: 0px; font: 12.6px / 16.1px &quot;Trebuchet MS&quot;, Helvetica, sans-serif; color: rgb(0, 0, 1);">
                                <table cellpadding="0" style="border-collapse: collapse;">
                                    <tr>
                                        <td
                                    ...
                                    <tr style="cursor: pointer;">
                                        <td
                                            ...
                                            <span>mobile:&nbsp;</span><span
                                                style="color: rgb(255, 255, 255); text-decoration: none; font-family: &quot;Trebuchet MS&quot;, Helvetica, sans-serif;">+4-074-20-77</span>&nbsp;|&nbsp;<span>phone:&nbsp;</span><span
                                                style="color: rgb(255, 255, 255); text-decoration: none; font-family: &quot;Trebuchet MS&quot;, Helvetica, sans-serif;">+4-403-67-87</span>
                                        </td>
                                    </tr>
                                    <tr style="cursor: pointer;">
                                        <td
                                    ...
                                    <tr>
                                        <td
                                            ...
                                            <table cellpadding="0" style="border-collapse: collapse;">
                                                <tr>
                                                    <td
                                                        style="margin: 0.1px; padding: 0px 5px 0px 0px; font: 12.6px / 16.1px &quot;Trebuchet MS&quot;, Helvetica, sans-serif; color: rgb(0, 0, 1); cursor: pointer;">
                                                        <span
                                                            style="border-radius: 15%; width: 21px; height: 21px; display: block; text-align: center; background-color: rgb(85, 85, 85); font-size: 12px; font-family: initial; line-height: 1;"><svg
