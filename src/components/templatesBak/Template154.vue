        ...
        <table cellpadding="0" style="border-collapse: collapse;">
            <tr>
                <td style="margin: 0.1px; padding: 10px 0px; cursor: pointer;"><img width="500"
                        src="https://img.mysignature.io/a/v1/3/3/6/336c8bc5-4216-5aee-945d-2c2d68ce75f7.png"
                        alt="Best regards,"></td>
            </tr>
        </table>
        <table cellpadding="0" style="border-collapse: collapse; font-size: 11.7px; background-color: rgb(1, 14, 30);">
            <tr>
                <td
                    style="margin: 0.1px; padding: 20px; font: 11.7px / 14.9px Verdana, Geneva, sans-serif; color: rgb(0, 0, 1);">
                    <table cellpadding="0" style="border-collapse: collapse;">
                        <tr>
                            <td valign="top" style="margin: 0.1px; padding: 0px 15px 0px 0px; cursor: pointer;"><img
                                    src="https://img.mysignature.io/p/8/5/a/85a1421c-aed2-5ed8-b9e5-31ba1ee047a0.png?time=1709298042"
                                    width="154" alt=" &quot;created with MySignature.io&quot;"
                                    style="display: block; min-width: 154px;"></td>
                            <td valign="top"
                                style="margin: 0.1px; padding: 0px; font: 11.7px / 14.9px Verdana, Geneva, sans-serif; color: rgb(0, 0, 1);">
                                <table cellpadding="0" style="border-collapse: collapse;">
                                    <tr>
                                        <td
                                    ...
                                    <tr style="cursor: pointer;">
                                        <td
                                            style="margin: 0.1px; padding: 5px 0px 0px; font: 11.7px / 14.9px Verdana, Geneva, sans-serif; color: rgb(239, 244, 145);">
                                            <span>e:&nbsp;</span><span
                                                style="color: rgb(239, 244, 145); text-decoration: none; font-family: Verdana, Geneva, sans-serif;">jeremy@mysignature.io</span>&nbsp;|&nbsp;<span>w:&nbsp;</span><span
                                                style="color: rgb(239, 244, 145); text-decoration: none; font-family: Verdana, Geneva, sans-serif;">mysignature.io</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td
                                            style="margin: 0.1px; padding: 10px 0px 5px; font: 11.7px / 14.9px Verdana, Geneva, sans-serif; color: rgb(0, 0, 1);">
                                            Follow us:</td>
                                    </tr>
                                    <tr>
                                        <td
                                            ...
                                            <table cellpadding="0" style="border-collapse: collapse;">
                                                <tr>
                                                    <td
                                                        style="margin: 0.1px; padding: 0px 5px 0px 0px; font: 11.7px / 14.9px Verdana, Geneva, sans-serif; color: rgb(0, 0, 1); cursor: pointer;">
                                                        <span
                                                            style="border-radius: 50%; width: 25px; height: 25px; display: block; text-align: center; background-color: rgb(164, 255, 137); font-size: 12px; font-family: initial; line-height: 1;"><svg
            ...
            <table width="500" cellpadding="0" style="border-collapse: collapse;">
                <tr>
                    <td style="padding: 5px 10px 0px 0px; margin: 0.1px; cursor: pointer;"><img
                            alt="Dive into my blog for gadget reviews and tech tips"
