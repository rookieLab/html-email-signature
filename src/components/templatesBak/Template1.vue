        ...
        <table cellpadding="0" style="border-collapse: collapse;">
            <tr>
                <td style="margin: 0.1px; padding: 10px 0px; cursor: pointer;"><img width="500"
                        src="/assets/signoff/8c7f336d-810a-5088-bc33-029256f51e61.png" alt="Regards,"></td>
            </tr>
        </table>
                                ...
                                <table cellpadding="0" style="border-collapse: collapse;">
                                    ...
                                    <tr>
                                        <td
                                            ...
                                            <span style="cursor: pointer;"><span style="color: rgb(0, 0, 1);">BIG BOLD
                                                    Innovations </span></span>
                                        </td>
                                    </tr>
                                    <tr style="cursor: pointer;">
                                        <td
                                            ...
                                            <span
                                                style="color: rgb(0, 0, 1); text-decoration: none; font-family: Tahoma, Geneva, sans-serif;">jason@example.com
                                            </span>
                                        </td>
                                    </tr>
                                    <tr style="cursor: pointer;">
                                    ...
                                    <tr style="cursor: pointer;">
                                        <td
                                            style="margin: 0.1px; padding: 2px 0px; font: 12.1px / 15.3px Tahoma, Geneva, sans-serif; color: rgb(0, 0, 1);">
                                            <span
                                                style="color: rgb(0, 0, 1); text-decoration: none; font-family: Tahoma, Geneva, sans-serif;">+2-535-656-12
                                            </span>
                                        </td>
                                    </tr>
                                    <tr style="cursor: pointer;">
                                        <td
                                            style="margin: 0.1px; padding: 2px 0px; font: 12.1px / 15.3px Tahoma, Geneva, sans-serif; color: rgb(0, 0, 1);">
                                            <span
                                                style="color: rgb(0, 0, 1); text-decoration: none; font-family: Tahoma, Geneva, sans-serif;">bigboldin.io</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td
                                            ...
                                            <table cellpadding="0" style="border-collapse: collapse;">
                                                <tr>
                                                    <td
                                                        ...
                                                        <span
                                                            style="border-radius: 15%; width: 23px; height: 23px; display: block; text-align: center; background-color: rgb(24, 119, 242); font-size: 12px; font-family: initial; line-height: 1;"><svg
                                                    ...
                                                    <td
                                                        style="margin: 0.1px; padding: 0px 4px 0px 0px; font: 12.1px / 15.3px Tahoma, Geneva, sans-serif; color: rgb(0, 0, 1); cursor: pointer;">
                                                        <span
                                                            style="border-radius: 15%; width: 23px; height: 23px; display: block; text-align: center; background-color: rgb(29, 161, 242); font-size: 12px; font-family: initial; line-height: 1;"><svg
                ...
                <tr>
                    <td style="padding: 20px 0px 0px; margin: 0.1px; cursor: pointer;">
                        <span>
                            ...
                            <!-- <img src="https://img.mysignature.io/a/v1/f/5/4/f54a1792-9dfe-5bb1-89c8-0768acb7d13d.png"
                                alt="Meet me on Google Meet" width="203" style="display: block;"> -->
                        </span>
                    </td>
                </tr>
            </table>
