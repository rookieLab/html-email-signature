        ...
        <table cellpadding="0" style="border-collapse: collapse;">
            <tr>
                <td style="margin: 0.1px; padding: 10px 0px; cursor: pointer;"><img width="500"
                        src="https://img.mysignature.io/a/v1/d/4/4/d442b938-a608-5a8d-8074-e0199ac4edc2.png"
                        alt="Sincerely,"></td>
            </tr>
        </table>
                    ...
                    <table cellpadding="0" style="border-collapse: collapse;">
                        <tr>
                            <td valign="top" style="margin: 0.1px; padding: 0px 15px 0px 0px; cursor: pointer;"><img
                                    src="https://img.mysignature.io/p/a/3/c/a3c921fb-8337-52e1-a281-df6a0dff237c.png?time=1709132107"
                                    width="103" alt=" &quot;created with MySignature.io&quot;"
                                    style="display: block; min-width: 103px;"></td>
                                    ...
                                    <tr>
                                        <td
                                            ...
                                            <table cellpadding="0" style="border-collapse: collapse;">
                                                <tr>
                                                    <td
                                                        style="margin: 0.1px; padding: 0px 4px 0px 0px; font: 12.8px / 16.3px Verdana, Geneva, sans-serif; color: rgb(0, 0, 1); cursor: pointer;">
                                                        <span
                                                            style="border-radius: 50%; width: 20px; height: 20px; display: block; text-align: center; background-color: rgb(153, 172, 176); font-size: 12px; font-family: initial; line-height: 1;"><svg
            ...
            <table width="500" cellpadding="0" style="border-collapse: collapse;"><!---->
                <tr>
                    <td style="padding: 19px 0px 0px; margin: 0.1px; cursor: pointer;"><span><img
                                ...
                                alt="Meet me on GoToMeeting" width="213" style="display: block;"></span></td>
                </tr>
            </table>
            <table width="500" cellpadding="0" style="border-collapse: collapse;">
                <tr style="cursor: pointer;">
                    <td width="30" style="padding: 15px 0px 0px; margin: 0.1px;"><img
                            ...
                            alt="Please don’t print this email" style="display: block;"></td>
                    <td
