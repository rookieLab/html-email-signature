        ...
        <table cellpadding="0" width="400" style="border-collapse: collapse; font-size: 13.3px;">
            <tr>
                <td style="margin: 0.1px; padding: 0px; cursor: pointer;"><img
                        src="https://img.mysignature.io/p/7/5/5/755c6ebf-bcdb-517c-a4a0-d2083bd83644.png?time=1685569257"
            ...
            <tr>
                <td style="margin: 0.1px; padding: 15px 0px;">
                    <table cellpadding="0" style="border-collapse: collapse;">
                        <tr>
                            <td height="1"
                                style="margin: 0.1px; padding: 0px; border-top: 2px solid rgb(231, 142, 11); font: 1px / 1px &quot;Trebuchet MS&quot;, Helvetica, sans-serif; width: 30px;">
                            </td>
                        </tr>
                    </table>
                </td>
            ...
            <tr style="cursor: pointer;">
                <td
                    style="margin: 0.1px; padding: 1px 0px; font: 13.3px / 16.9px &quot;Trebuchet MS&quot;, Helvetica, sans-serif; color: rgb(0, 0, 1);">
                    <span style="font-weight: 600;">M:&nbsp;</span><span
                        style="color: rgb(0, 0, 1); text-decoration: none; font-family: &quot;Trebuchet MS&quot;, Helvetica, sans-serif;">+452-406-30</span>
                </td>
            </tr>
            <tr style="cursor: pointer;">
                <td
                    ...
                    <span style="font-weight: 600;">T:&nbsp;</span><span
                        style="color: rgb(0, 0, 1); text-decoration: none; font-family: &quot;Trebuchet MS&quot;, Helvetica, sans-serif;">+543-324-55</span>
                </td>
            </tr>
            <tr style="cursor: pointer;">
                <td
            ...
            <tr>
                <td
                    ...
                    <table cellpadding="0" style="border-collapse: collapse;">
                        <tr>
                            <td
                                style="margin: 0.1px; padding: 0px 5px 0px 0px; font: 13.3px / 16.9px &quot;Trebuchet MS&quot;, Helvetica, sans-serif; color: rgb(0, 0, 1); cursor: pointer;">
                                <span
                                    style="border-radius: 0%; width: 23px; height: 23px; display: block; text-align: center; background-color: rgb(231, 142, 11); font-size: 12px; font-family: initial; line-height: 1;"><svg
