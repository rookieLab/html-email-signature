                    ...
                    <table cellpadding="0" style="border-collapse: collapse;">
                        <tr>
                            <td valign="middle" style="margin: 0.1px; padding: 0px 15px 0px 0px; cursor: pointer;"><img
                                    src="https://img.mysignature.io/p/1/6/8/168511cc-c20c-50e7-b912-de7f47d4f490.png?time=1709300373"
                                    width="121" alt=" &quot;created with MySignature.io&quot;"
                                    style="display: block; min-width: 121px;"></td>
                            <td valign="middle"
                                style="margin: 0.1px; padding: 0px; font: 11.5px / 14.7px Tahoma; color: rgb(0, 0, 1);">
                                <table cellpadding="0" style="border-collapse: collapse;">
                                    <tr>
                                        <td style="margin: 0.1px; padding: 4px 15px 0px 0px; cursor: pointer;"><span
                                                style="border-radius: 50%; width: 20px; height: 20px; display: block; text-align: center; background-color: rgb(28, 59, 95); font-size: 12px; font-family: initial; line-height: 1;"><svg
                            ...
                            <td valign="middle" style="margin: 0.1px; padding: 0px;">
                                <table cellpadding="0" style="border-collapse: collapse;">
                                    ...
                                    <tr>
                                        <td
                                            style="margin: 0.1px; padding: 0px 0px 5px; font: 11.5px / 14.7px Tahoma; color: rgb(0, 0, 1);">
                                            <span style="cursor: pointer;">Professor of Economics </span>&nbsp;<span
                                                style="cursor: pointer;">?Metropolitan University</span></td>
                                    </tr>
                                    <tr style="cursor: pointer;">
                                        <td
                                            style="margin: 0.1px; padding: 1px 0px; font: 11.5px / 14.7px Tahoma; color: rgb(0, 0, 1);">
                                            <span>Website:&nbsp;</span><span
                                                style="color: rgb(0, 0, 1); text-decoration: none; font-family: Tahoma;">mysignature.io</span>,&nbsp;<span>Email:&nbsp;</span><span
                                                style="color: rgb(0, 0, 1); text-decoration: none; font-family: Tahoma;">garcia@mysignature.io</span>
                                        </td>
                                    </tr>
                                    <tr style="cursor: pointer;">
                                        <td
            ...
            <table width="500" cellpadding="0" style="border-collapse: collapse;">
                <tr>
                    <td style="padding: 15px 10px 0px 0px; margin: 0.1px; cursor: pointer;"><span><img
                                alt="Check out our research publications"
                                src="https://img.mysignature.io/a/v1/d/6/b/d6baad22-828d-5584-9808-306984e2fbad.png"
                                style="max-width: 490px; display: block;" width="296"></span></td>
                </tr>
            </table>
            <table width="477" cellpadding="0" style="border-collapse: collapse;">
                <tr>
                    <td
                        style="margin: 0.1px; padding: 15px 0px 0px; font: 12.1px / 15.3px Tahoma; color: rgb(118, 128, 143); cursor: pointer;">
                        Metropolian University is compliant with the GDPR regulation on data protection and privacy in
