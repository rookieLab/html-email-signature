        ...
        <table cellpadding="0" style="border-collapse: collapse;">
            <tr>
                <td style="margin: 0.1px; padding: 10px 0px; cursor: pointer;"><img width="500"
                        src="https://img.mysignature.io/a/v1/5/a/9/5a9bcfa9-0d01-5f32-9252-3481605b1883.png"
                        alt="Best wishes,"></td>
            </tr>
        </table>
                    ...
                    <table cellpadding="0" style="border-collapse: collapse;">
                        <tr>
                            <td valign="top" style="margin: 0.1px; padding: 0px; cursor: pointer;"><img
                                    src="https://img.mysignature.io/p/9/d/7/9d745d06-51d9-505c-a6bb-c2930922dca1.png?time=1712664717"
                                    width="142" alt=" &quot;created with MySignature.io&quot;"
                                    style="display: block; min-width: 142px;"></td>
                            <td valign="top"
                                style="margin: 0.1px; padding: 0px 0px 0px 15px; font: 12.6px / 16.1px Georgia, serif; color: rgb(0, 0, 1);">
                                <table cellpadding="0" style="border-collapse: collapse;">
                                    <tr>
                                        <td
                                    ...
                                    <tr style="cursor: pointer;">
                                        <td
                                            style="margin: 0.1px; padding: 2px 0px; font: 12.6px / 16.1px Georgia, serif; color: rgb(0, 0, 1);">
                                            <span
                                                style="color: rgb(181, 43, 204); font-weight: 600;">website:&nbsp;</span><span
                                                style="color: rgb(0, 0, 0); text-decoration: none; font-family: Georgia, serif;">mysignature.io</span>
                                        </td>
                                    </tr>
                                    <tr style="cursor: pointer;">
                                        <td
                                            style="margin: 0.1px; padding: 2px 0px; font: 12.6px / 16.1px Georgia, serif; color: rgb(0, 0, 1);">
                                            <span
                                                style="color: rgb(181, 43, 204); font-weight: 600;">email:&nbsp;</span><span
                                                style="color: rgb(0, 0, 0); text-decoration: none; font-family: Georgia, serif;">emma@mysignature.io</span>
                                        </td>
                                    </tr>
                                    <tr style="cursor: pointer;">
                                        <td
                                    ...
                                    <tr>
                                        <td
                                            ...
                                            <table cellpadding="0" style="border-collapse: collapse;">
                                                <tr>
                                                    <td
                                                        style="margin: 0.1px; padding: 0px 4px 0px 0px; font: 12.6px / 16.1px Georgia, serif; color: rgb(0, 0, 1); cursor: pointer;">
                                                        <span
                                                            style="border-radius: 50%; width: 26px; height: 26px; display: block; text-align: center; background-color: rgb(0, 0, 0); font-size: 12px; font-family: initial; line-height: 1;"><svg
            ...
            <table width="500" cellpadding="0" style="border-collapse: collapse;">
                <tr>
                    <td style="padding: 14px 10px 0px 0px; margin: 0.1px; cursor: pointer;"><span><img
                                alt="Live Life to the Fullest"
                                src="https://img.mysignature.io/a/v1/6/7/d/67d1af9f-8033-58db-b649-6024c3fa0ab5.png"
                                style="max-width: 490px; display: block;" width="188"></span></td>
                </tr>
            </table>
            <table width="500" cellspacing="0" cellpadding="0" border="0">
                <tr>
                    <td style="margin: 0.1px; padding-top: 10px; cursor: pointer;"><span><img
                                src="https://img.mysignature.io/b/9/d/7/9d745d06-51d9-505c-a6bb-c2930922dca1.png?time=1712664717"
                                valign="top" width="358" alt="created with MySignature.io"
