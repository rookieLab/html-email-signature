<template>
    <div><!---->
        <table cellpadding="0" width="550" style="border-collapse: collapse; font-size: 12.3px;">
            <tr>
                <td style="margin: 0.1px; padding: 0px;">
                    <table cellpadding="0" style="border-collapse: collapse;">
                        <tr>
                            <td valign="top"
                                style="margin: 0.1px; padding: 0px 20px 0px 0px; border-right: 3px solid rgb(130, 155, 142);">
                                <table cellpadding="0" style="border-collapse: collapse;">
                                    <tr>
                                        <td
                                            style="margin: 0.1px; padding: 0px; font: 17.2px / 21.9px Verdana, Geneva, sans-serif; color: rgb(0, 0, 1);">
                                            <span style="color: rgb(130, 155, 142); cursor: pointer;">AMINA
                                                DELAROSA</span><!----><!----></td>
                                    </tr>
                                    <tr>
                                        <td
                                            style="margin: 0.1px; padding: 2px 0px 0px; font: 200 12.3px / 15.7px Verdana, Geneva, sans-serif; color: rgb(0, 0, 1); cursor: pointer;">
                                            PR MANAGER</td>
                                    </tr><!---->
                                    <tr>
                                        <td
                                            style="margin: 0.1px; padding: 10px 0px 0px; font: 200 12.3px / 15.7px Verdana, Geneva, sans-serif; color: rgb(0, 0, 1);">
                                            Follow us:</td>
                                    </tr>
                                    <tr>
                                        <td
                                            style="margin: 0.1px; padding: 5px 0px 0px; font: 12.3px / 15.7px Verdana, Geneva, sans-serif; color: rgb(0, 0, 1);">
                                            <table cellpadding="0" style="border-collapse: collapse;">
                                                <tr>
                                                    <td
                                                        style="margin: 0.1px; padding: 0px 6px 0px 0px; font: 12.3px / 15.7px Verdana, Geneva, sans-serif; color: rgb(0, 0, 1); cursor: pointer;">
                                                        <span
                                                            style="border-radius: 0%; width: 25px; height: 25px; display: block; text-align: center; background-color: rgb(130, 155, 142); font-size: 12px; font-family: initial; line-height: 1;"><svg
                                ...
                                <table cellpadding="0" style="border-collapse: collapse;">
                                    <tr style="cursor: pointer;">
                                        <td
                                            ...
                                            <span
                                                style="color: rgb(130, 155, 142); font-weight: 600;">A&nbsp;&nbsp;</span><span
                                                style="color: rgb(0, 0, 1);">55 Halsey St Brooklyn,
                                                NY</span>&nbsp;&nbsp;<span
                                                style="color: rgb(130, 155, 142); font-weight: 600;">T&nbsp;&nbsp;</span><span
                                                style="color: rgb(0, 0, 1); text-decoration: none; font-family: Verdana, Geneva, sans-serif;">222
                                                335 3632</span></td>
                                    </tr>
                                    <tr style="cursor: pointer;">
                                        <td
                                            ...
                                            <span
                                                style="color: rgb(130, 155, 142); font-weight: 600;">E&nbsp;&nbsp;</span><span
                                                style="color: rgb(0, 0, 1); text-decoration: none; font-family: Verdana, Geneva, sans-serif;">amina@mysignature.io</span>&nbsp;&nbsp;<!----><span
