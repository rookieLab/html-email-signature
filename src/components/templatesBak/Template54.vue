        ...
        <table cellpadding="0" style="border-collapse: collapse;">
            <tr>
                <td style="margin: 0.1px; padding: 10px 0px; cursor: pointer;"><img width="500"
                        src="https://img.mysignature.io/a/v1/c/8/5/c85217ac-92b9-5bcf-838d-4fe36579e48f.png"
                    ...
                    <table cellpadding="0" style="border-collapse: collapse;">
                        <tr>
                            <td valign="top" style="margin: 0.1px; padding: 0px; cursor: pointer;"><img
                                    src="https://img.mysignature.io/p/2/2/3/2239f27b-c47b-580f-b9aa-208ff8f9f3de.png?time=1685569257"
                                    width="162" alt=" &quot;created with MySignature.io&quot;"
                                    style="display: block; min-width: 162px;"></td>
                            <td valign="top"
                                style="margin: 0.1px; padding: 0px 0px 0px 15px; font: 12.8px / 16.3px Georgia, serif; color: rgb(0, 0, 1);">
                                <table cellpadding="0" style="border-collapse: collapse;">
                                    <tr>
                                        <td
                                    ...
                                    <tr>
                                        <td
                                            style="margin: 0.1px; padding: 0px 0px 5px; font: 12.8px / 16.3px Georgia, serif; color: rgb(0, 0, 1);">
                                            <span style="cursor: pointer;"><span style="color: rgb(0, 0, 1);">Coral
                                                    Coast Academy</span></span>&nbsp;<span
                                                style="cursor: pointer;"><span
                                                    style="color: rgb(0, 0, 1);">History</span></span></td>
                                    </tr>
                                    <tr style="cursor: pointer;">
                                        <td
                                            style="margin: 0.1px; padding: 2px 0px; font: 12.8px / 16.3px Georgia, serif; color: rgb(0, 0, 1);">
                                            <span
                                                style="color: rgb(66, 195, 193); font-weight: 600;">mobile:&nbsp;</span><span
                                                style="color: rgb(0, 0, 1); text-decoration: none; font-family: Georgia, serif;">+355-546-122</span>
                                        </td>
                                    </tr>
                                    <tr style="cursor: pointer;">
                                        <td
                                            style="margin: 0.1px; padding: 2px 0px; font: 12.8px / 16.3px Georgia, serif; color: rgb(0, 0, 1);">
                                            <span
                                                style="color: rgb(66, 195, 193); font-weight: 600;">email:&nbsp;</span><span
                                                style="color: rgb(0, 0, 1); text-decoration: none; font-family: Georgia, serif;">bredtraler@mysignature.io</span>
                                        </td>
                                    </tr>
                                    <tr style="cursor: pointer;">
                                        <td
                                            style="margin: 0.1px; padding: 2px 0px; font: 12.8px / 16.3px Georgia, serif; color: rgb(0, 0, 1);">
                                            <span
                                                style="color: rgb(66, 195, 193); font-weight: 600;">website:&nbsp;</span><span
                                    ...
                                    <tr>
                                        <td
                                            ...
                                            <table cellpadding="0" style="border-collapse: collapse;">
                                                <tr>
                                                    <td
                                                        style="margin: 0.1px; padding: 0px 4px 0px 0px; font: 12.8px / 16.3px Georgia, serif; color: rgb(0, 0, 1); cursor: pointer;">
                                                        <span
                                                            style="border-radius: 15%; width: 21px; height: 21px; display: block; text-align: center; background-color: rgb(29, 161, 242); font-size: 12px; font-family: initial; line-height: 1;"><svg
                                                    ...
                                                    <td
                                                        style="margin: 0.1px; padding: 0px 4px 0px 0px; font: 12.8px / 16.3px Georgia, serif; color: rgb(0, 0, 1); cursor: pointer;">
                                                        <span
                                                            style="border-radius: 15%; width: 21px; height: 21px; display: block; text-align: center; background-color: rgb(255, 0, 0); font-size: 12px; font-family: initial; line-height: 1;"><svg
                                                    ...
                                                    <td
                                                        style="margin: 0.1px; padding: 0px 4px 0px 0px; font: 12.8px / 16.3px Georgia, serif; color: rgb(0, 0, 1); cursor: pointer;">
                                                        <span
                                                            style="border-radius: 15%; width: 21px; height: 21px; display: block; text-align: center; background-color: rgb(24, 119, 242); font-size: 12px; font-family: initial; line-height: 1;"><svg
                                                                viewBox="0 0 1024 1024"
                                                                xmlns="http://www.w3.org/2000/svg"
                                                                style="position: relative; top: 4.2px; width: 12.6px;">
                                                                <path
