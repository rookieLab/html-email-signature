...
<img alt=' "created with MySignature.io"' src="https://img.mysignature.io/p/6/a/f/6af423fb-3dde-595c-8b05-b760faddbb4e.png?time=1685569257" style="display: block; min-width: 200px;" width="200"/>
</td>
...
<span style="color: rgb(194, 87, 85);">website: </span><span style="color: rgb(0, 0, 1); text-decoration: none; font-family: Verdana, Geneva, sans-serif;">mysignature.io</span>
</td>
</tr>
<tr style="cursor: pointer;">
<td style="margin: 0.1px; padding: 0px; font: 14.4px / 18.3px Verdana, Geneva, sans-serif; color: rgb(0, 0, 1);">
<span style="color: rgb(194, 87, 85);">email: </span><span style="color: rgb(0, 0, 1); text-decoration: none; font-family: Verdana, Geneva, sans-serif;">collahan@mysignature.io</span>
</td>
</tr>
<tr style="cursor: pointer;">
<td style="margin: 0.1px; padding: 0px; font: 14.4px / 18.3px Verdana, Geneva, sans-serif; color: rgb(0, 0, 1);">
<span style="color: rgb(194, 87, 85);">phone: </span><span style="color: rgb(0, 0, 1); text-decoration: none; font-family: Verdana, Geneva, sans-serif;">+67-874-123-34</span>
</td>
</tr>
<tr style="cursor: pointer;">
<td style="margin: 0.1px; padding: 0px; font: 14.4px / 18.3px Verdana, Geneva, sans-serif; color: rgb(0, 0, 1);">
<span style="color: rgb(194, 87, 85);">address: </span><span style="color: rgb(0, 0, 1);">1107
...
<td style="border-left: 3px solid rgb(212, 218, 213); margin: 0.1px; padding: 0px 0px 0px 6px; font: 14.4px / 18.3px Verdana, Geneva, sans-serif; color: rgb(0, 0, 1);" valign="middle">
<table cellpadding="0" style="border-collapse: collapse;">
<tr>
<td style="margin: 0.1px; padding: 4px 0px 0px; cursor: pointer;">
<span style="border-radius: 0%; width: 22px; height: 22px; display: block; text-align: center; background-color: rgb(212, 218, 213); font-size: 12px; font-family: initial; line-height: 1;"><svg style="position: relative; top: 4.4px; width: 13.2px;" viewbox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg">
...
<tr>
<td style="margin: 0.1px; padding: 4px 0px 0px; cursor: pointer;">
<span style="border-radius: 0%; width: 22px; height: 22px; display: block; text-align: center; background-color: rgb(212, 218, 213); font-size: 12px; font-family: initial; line-height: 1;"><svg style="position: relative; top: 4.4px; width: 13.2px;" viewbox="0 0 1053 1024" xmlns="http://www.w3.org/2000/svg">
