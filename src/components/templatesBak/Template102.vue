        ...
        <table cellpadding="0" style="border-collapse: collapse;">
            <tr>
                <td style="margin: 0.1px; padding: 10px 0px; cursor: pointer;"><img width="500"
                        src="https://img.mysignature.io/a/v1/8/8/8/888f86f2-ce2d-585e-9da5-9d92ddad15e5.png"
        ...
        <table cellpadding="0" width="500" style="border-collapse: collapse; font-size: 12.1px;">
            <tr>
                <td style="margin: 0.1px; padding: 0px;">
                    <table cellpadding="0" style="border-collapse: collapse;">
                        <tr>
                            <td valign="middle"
                                style="margin: 0.1px; padding: 0px 20px 0px 0px; border-right: 2px solid rgb(69, 15, 7);">
                                <table cellpadding="0" style="border-collapse: collapse;">
                                    <tr>
                                        <td align="center"
                                            style="margin: 0.1px; padding: 0px 0px 10px; cursor: pointer;"><img
                                                src="https://img.mysignature.io/p/7/e/e/7eedd948-c59c-5d4f-9c40-bfe8d5ec076d.png?time=1685569257"
                                                width="148" alt=" &quot;created with MySignature.io&quot;"
                                                style="display: block; min-width: 148px; margin: 0px auto;"></td>
                                    </tr>
                                    <tr>
                                        <td align="center"
                                    ...
                                    <tr>
                                        <td align="center"
                                            style="margin: 0.1px; padding: 5px 0px 0px; font: 200 12.1px / 15.3px Verdana, Geneva, sans-serif; color: rgb(0, 0, 1);">
                                            <span style="cursor: pointer;">CMO</span>&nbsp;<span
                                                style="cursor: pointer;">at Fair</span></td>
                                    </tr>
                                </table>
                            </td>
                            <td valign="middle" style="margin: 0.1px; padding: 0px 0px 0px 20px;">
                                <table cellpadding="0" style="border-collapse: collapse;">
                                    <tr style="cursor: pointer;">
                                        <td
                                            style="margin: 0.1px; padding: 0px; font: 12.1px / 15.3px Verdana, Geneva, sans-serif; color: rgb(0, 0, 1); white-space: nowrap;">
                                            <span
                                                style="color: rgb(69, 15, 7); font-weight: 600;">mobile:&nbsp;&nbsp;</span><span
                                                style="color: rgb(0, 0, 1); text-decoration: none; font-family: Verdana, Geneva, sans-serif;">+45-563-80</span>
                                        </td>
                                    </tr>
                                    <tr style="cursor: pointer;">
                                        <td
                                            style="margin: 0.1px; padding: 5px 0px 0px; font: 12.1px / 15.3px Verdana, Geneva, sans-serif; color: rgb(0, 0, 1); white-space: nowrap;">
                                            <span
                                                style="color: rgb(69, 15, 7); font-weight: 600;">website:&nbsp;&nbsp;</span><span
                                    ...
                                    <tr style="cursor: pointer;">
                                        <td
                                            style="margin: 0.1px; padding: 5px 0px 0px; font: 12.1px / 15.3px Verdana, Geneva, sans-serif; color: rgb(0, 0, 1); white-space: nowrap;">
                                            <span
                                                style="color: rgb(69, 15, 7); font-weight: 600;">email:&nbsp;&nbsp;</span><span
                                                style="color: rgb(0, 0, 1); text-decoration: none; font-family: Verdana, Geneva, sans-serif;">jamila@mysignature.io</span>
                                        </td>
                                    </tr>
                                    <tr style="cursor: pointer;">
                                        <td
                                            style="margin: 0.1px; padding: 5px 0px 0px; font: 12.1px / 15.3px Verdana, Geneva, sans-serif; color: rgb(0, 0, 1); white-space: nowrap;">
                                            <span
                                                style="color: rgb(69, 15, 7); font-weight: 600;">phone:&nbsp;&nbsp;</span><span
                                                style="color: rgb(0, 0, 1); text-decoration: none; font-family: Verdana, Geneva, sans-serif;">+54-254-54</span>
                                        </td>
                                    </tr>
                                    <tr>
                                                ...
                                                <tr>
                                                    <td
                                                        ...
                                                        <table cellpadding="0" style="border-collapse: collapse;">
                                                            <tr>
                                                                <td
                                                                    style="margin: 0.1px; padding: 0px 4px 0px 0px; font: 12.1px / 15.3px Verdana, Geneva, sans-serif; color: rgb(0, 0, 1); cursor: pointer;">
                                                                    <span
                                                                        style="border-radius: 0%; width: 22px; height: 22px; display: block; text-align: center; background-color: rgb(69, 49, 7); font-size: 12px; font-family: initial; line-height: 1;"><svg
            ...
            <tr>
                <td
                    ...
                    <img src="https://img.mysignature.io/b/7/e/e/7eedd948-c59c-5d4f-9c40-bfe8d5ec076d.png?time=1685569257"
                        valign="top" width="339" alt="created with MySignature.io" style="display: block;"></td>
            </tr>
        </table>
        <div>
            <table width="500" cellpadding="0" style="border-collapse: collapse;">
                <tr style="cursor: pointer;">
                    <td width="30" style="padding: 15px 0px 0px; margin: 0.1px;"><img
                            src="https://img.mysignature.io/addons/v2/green-earth.png" alt="Save paper. Don’t print"
