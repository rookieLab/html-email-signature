                    ...
                    <table cellpadding="0" style="border-collapse: collapse;">
                        <tr>
                            <td valign="middle" style="margin: 0.1px; padding: 0px 15px 0px 0px; cursor: pointer;"><img
                                    src="https://img.mysignature.io/p/e/a/2/ea278512-5667-5d54-8cd0-17b776ee41cd.png?time=1709128418"
                                    width="110" alt=" &quot;created with MySignature.io&quot;"
                                    style="display: block; min-width: 110px;"></td>
                            <td valign="middle"
                                style="margin: 0.1px; padding: 0px; font: 14.7px / 18.7px &quot;Times New Roman&quot;, Times, serif; color: rgb(0, 0, 1);">
                                <table cellpadding="0" style="border-collapse: collapse;">
                                    <tr>
                                        <td style="margin: 0.1px; padding: 4px 15px 0px 0px; cursor: pointer;"><span
                                                style="border-radius: 50%; width: 24px; height: 24px; display: block; text-align: center; background-color: rgb(254, 19, 183); font-size: 12px; font-family: initial; line-height: 1;"><svg
                            ...
                            <td valign="middle" style="margin: 0.1px; padding: 0px;">
                                <table cellpadding="0" style="border-collapse: collapse;">
                                    ...
                                    <tr>
                                        <td
                                            style="margin: 0.1px; padding: 0px 0px 5px; font: 14.7px / 18.7px &quot;Times New Roman&quot;, Times, serif; color: rgb(0, 0, 1);">
                                            <span style="cursor: pointer;">Director of</span>&nbsp;<span
                                                style="cursor: pointer;">Wanderlust Interiors </span></td>
                                    </tr>
                                    <tr style="cursor: pointer;">
                                        <td
                                            style="margin: 0.1px; padding: 1px 0px; font: 14.7px / 18.7px &quot;Times New Roman&quot;, Times, serif; color: rgb(0, 0, 1);">
                                            <span>m:&nbsp;</span><span
                                                style="color: rgb(0, 0, 1); text-decoration: none; font-family: &quot;Times New Roman&quot;, Times, serif;">745-318-5933</span>,&nbsp;<span>e:&nbsp;</span><span
                                                style="color: rgb(0, 0, 1); text-decoration: none; font-family: &quot;Times New Roman&quot;, Times, serif;">willy@turner.io</span>
                                        </td>
                                    </tr>
                                    <tr style="cursor: pointer;">
                                        <td
            ...
            <table cellpadding="0" width="500"
                ...
                <tr style="cursor: pointer;">
                    <td width="24" height="24" align="center"
                        style="padding: 13px 0px 0px; margin: 0.1px; min-width: 24px;"><svg viewBox="0 0 1024 1024"
                    ...
                    <td
                        style="font-family: &quot;Times New Roman&quot;, Times, serif; font-size: 14.1px; padding: 13px 0px 0px; margin: 0.1px;">
                        <span>Book a Meeting with me&nbsp;</span><span
                            style="text-decoration: none; font-size: 14.1px; color: rgb(0, 0, 1);">here</span></td>
                </tr>
            </table>
            <table cellpadding="0" style="border-collapse: collapse;">
                <tr>
                    <td style="padding: 14px 4px 4px 0px; margin: 0.1px;"><span><img
                                src="https://img.mysignature.io/addons/v2/instagram_v1_shape2_b.png" height="32"
                                width="112" alt="instagram" style="display: block;"></span></td>
                    <td style="padding: 14px 4px 4px 0px; margin: 0.1px;"><span><img
