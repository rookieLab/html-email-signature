                    ...
                    <table cellpadding="0" style="border-collapse: collapse;">
                        <tr>
                            <td valign="top" style="margin: 0.1px; padding: 0px 15px 0px 0px; cursor: pointer;"><img
                                    ...
                                    style="display: block; min-width: 143px;"></td>
                            ...
                            <td valign="middle"
                                style="border-left: 3px solid rgb(56, 103, 107); margin: 0.1px; padding: 0px 0px 0px 6px; font: 14.4px / 18.3px &quot;Lucida Sans Unicode&quot;, &quot;Lucida Grande&quot;, sans-serif; color: rgb(0, 0, 1);">
                                <table cellpadding="0" style="border-collapse: collapse;">
                                    <tr>
