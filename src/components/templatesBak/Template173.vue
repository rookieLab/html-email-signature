                    ...
                    <table cellpadding="0" style="border-collapse: collapse;">
                        <tr>
                            <td valign="top" style="margin: 0.1px; padding: 0px; cursor: pointer;"><img
                                    src="https://img.mysignature.io/p/c/3/7/c37d9c7e-9b4b-5c26-a6e9-9964530c3939.png?time=1685569257"
                                    width="193" alt=" &quot;created with MySignature.io&quot;"
                                    style="display: block; min-width: 193px;"></td>
                            <td valign="top"
                                    ...
                                    <tr>
                                        <td
                                            ...
                                            <span style="cursor: pointer;"><span
                                                    style="color: rgb(0, 0, 1);">Cartoonist</span></span>&nbsp;<span
                                                style="cursor: pointer;"><span style="color: rgb(0, 0, 1);">at ComicPix
                                                    Studio</span></span></td>
                                    </tr>
                                    <tr style="cursor: pointer;">
                                        <td
                                            ...
                                            <span style="color: rgb(214, 0, 0); font-weight: 600;">?:&nbsp;</span><span
                                                style="color: rgb(0, 0, 1); text-decoration: none; font-family: Verdana, Geneva, sans-serif;">maddox@mysignature.io</span>
                                        </td>
                                    </tr>
                                    <tr style="cursor: pointer;">
                                        <td
                                            ...
                                            <table cellpadding="0" style="border-collapse: collapse;">
                                                <tr>
                                                    <td
                                                        ...
                                                        <span
                                                            style="border-radius: 0%; width: 22px; height: 22px; display: block; text-align: center; background-color: rgb(111, 97, 94); font-size: 12px; font-family: initial; line-height: 1;"><svg
