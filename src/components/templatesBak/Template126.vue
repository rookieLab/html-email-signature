<template>
    <div><!---->
        <table cellpadding="0" width="500" style="border-collapse: collapse; font-size: 12.2px;">
            <tr>
                <td style="margin: 0.1px; padding: 0px;">
                    <table cellpadding="0" style="border-collapse: collapse;">
                        <tr>
                            <td valign="middle" style="margin: 0.1px; padding: 0px 15px 0px 0px; cursor: pointer;"><img
                                    src="https://img.mysignature.io/p/f/1/9/f19a6ae2-a1ec-50f1-b219-ec2e1818d467.png?time=1685569257"
                                    width="185" alt=" &quot;created with MySignature.io&quot;"
                                    style="display: block; min-width: 185px;"></td>
                            <td valign="middle"
                                style="margin: 0.1px; padding: 0px; font: 12.2px / 15.5px Tahoma; color: rgb(0, 0, 1);">
                                <table cellpadding="0" style="border-collapse: collapse;">
                                    <tr>
                                        <td style="margin: 0.1px; padding: 4px 15px 0px 0px; cursor: pointer;"><span
                                                style="border-radius: 0%; width: 26px; height: 26px; display: block; text-align: center; background-color: rgb(0, 0, 0); font-size: 12px; font-family: initial; line-height: 1;"><svg
                            ...
                            <td valign="middle" style="margin: 0.1px; padding: 0px;">
                                <table cellpadding="0" style="border-collapse: collapse;">
                                    <tr>
                                        <td
                                            style="margin: 0.1px; padding: 0px 0px 2px; font: 14.6px / 18.6px Tahoma; color: rgb(0, 0, 1);">
                                            <span style="color: rgb(0, 0, 0); font-weight: 600; cursor: pointer;">Joe
                                                Folen</span><!----><!----></td>
                                    </tr>
                                    <tr>
                                        <td
                                            style="margin: 0.1px; padding: 0px 0px 5px; font: 12.2px / 15.5px Tahoma; color: rgb(0, 0, 1);">
                                            <span style="cursor: pointer;">Graphic designer at</span>&nbsp;<span
                                                style="cursor: pointer;">BY&amp;Partners</span></td>
                                    </tr>
                                    <tr style="cursor: pointer;">
                                        <td
                                            style="margin: 0.1px; padding: 1px 0px; font: 12.2px / 15.5px Tahoma; color: rgb(0, 0, 1);">
                                            <!----><span
                                                style="color: rgb(0, 0, 1); text-decoration: none; font-family: Tahoma;">+4
                                                507 5780</span>,&nbsp;<!----><span
                                                style="color: rgb(0, 0, 1); text-decoration: none; font-family: Tahoma;">+4
                                                435 9503</span></td>
                                    </tr>
                                    <tr style="cursor: pointer;">
                                        <td
                                            style="margin: 0.1px; padding: 1px 0px; font: 12.2px / 15.5px Tahoma; color: rgb(0, 0, 1);">
                                            <!----><span
                                                style="color: rgb(0, 0, 1); text-decoration: none; font-family: Tahoma;">folen@mysignature.io</span><!----><!---->
                                        </td>
                                    </tr>
                                    <tr style="cursor: pointer;">
                                        <td
                                            style="margin: 0.1px; padding: 1px 0px; font: 12.2px / 15.5px Tahoma; color: rgb(0, 0, 1);">
                                            <!----><span
                                                style="color: rgb(0, 0, 1); text-decoration: none; font-family: Tahoma;">mysignature.io</span><!----><!---->
                                        </td>
                                    </tr>
                                </table>
                            </td>
            ...
            <table cellpadding="0" style="border-collapse: collapse;">
                <tr>
                    <td style="padding: 5px 4px 4px 0px; margin: 0.1px;"><span><img
                                src="https://img.mysignature.io/addons/v2/behance_v2_shape1_i.png" height="48"
                                width="168" alt="behance" style="display: block;"></span></td>
                    <td style="padding: 5px 4px 4px 0px; margin: 0.1px;"><span><img
                                src="https://img.mysignature.io/addons/v2/dribbble_v3_shape1_i.png" height="48"
                                width="168" alt="dribbble" style="display: block;"></span></td>
                </tr>
            </table><!---->
