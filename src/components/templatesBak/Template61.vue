<template>
    <div><!---->
        <table cellpadding="0" width="550" style="border-collapse: collapse; font-size: 13.4px;">
            <tr>
                <td style="margin: 0.1px; padding: 0px;">
                    <table cellpadding="0" style="border-collapse: collapse;">
                        <tr>
                            <td valign="top"
                                style="margin: 0.1px; padding: 0px 20px 0px 0px; border-right: 3px solid rgb(212, 8, 109);">
                                <table cellpadding="0" style="border-collapse: collapse;">
                                    <tr>
                                        <td
                                    ...
                                    <tr>
                                        <td
                                            ...
                                            <table cellpadding="0" style="border-collapse: collapse;">
                                                <tr>
                                                    <td
                                                        style="margin: 0.1px; padding: 0px 6px 0px 0px; font: 13.4px / 17.1px Tahoma, Geneva, sans-serif; color: rgb(0, 0, 1); cursor: pointer;">
                                                        <span
                                                            style="border-radius: 15%; width: 20px; height: 20px; display: block; text-align: center; background-color: rgb(212, 8, 109); font-size: 12px; font-family: initial; line-height: 1;"><svg
                            ...
                            <td style="margin: 0.1px; padding: 0px 0px 0px 20px;">
                                <table cellpadding="0" style="border-collapse: collapse;">
                                    ...
                                    <tr>
                                        <td
                                            style="margin: 0.1px; padding: 2px 0px 0px; font: 13.4px / 17.1px Tahoma, Geneva, sans-serif; color: rgb(0, 0, 1);">
                                            <span
            ...
            <tr>
                <td
                    style="margin: 0.1px; padding: 15px 0px 0px; font: 13.4px / 17.1px Tahoma, Geneva, sans-serif; color: rgb(0, 0, 1); cursor: pointer;">
                    <span><img
                            src="https://img.mysignature.io/b/b/f/c/bfcf967c-6b64-5c12-a27c-c31c8baceaf3.png?time=1685569257"
                            valign="top" width="368" alt="created with MySignature.io" style="display: block;"></span>
                </td>
            </tr>
        </table>
        <div>
