<template>
  <a :href="url" target="_blank"
    ...
    <svg viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg"
      ...
      <path
        d="M1023.662 381.304l-390.224-1.281-123.175-372.341-120.699 372.341-388.902 1.281 314.424 228.552-121.851 373.409h1.238l318.351-229.876 315.663 229.876-121.851-372.598 317.028-229.748z"
        :fill="color"></path>
    </svg>
