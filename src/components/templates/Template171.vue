        ...
        <table cellpadding="0" style="border-collapse: collapse;">
            <tr>
                <td style="margin: 0.1px; padding: 10px 0px; cursor: pointer;"><img width="500"
                        src="https://img.mysignature.io/a/v1/4/9/7/497d6a3b-dfe5-51f3-a066-0d441614046e.png"
                        alt="Kobi Hampton"></td>
            </tr>
        </table>
            ...
            <tr>
                <td style="margin: 0.1px; padding: 0px;">
                    <table cellpadding="0" style="border-collapse: collapse;">
                        <tr>
                            <td valign="top"
                                style="margin: 0.1px; padding: 0px 20px 0px 0px; border-right: 3px solid rgb(191, 106, 75);">
                                <table cellpadding="0" style="border-collapse: collapse;">
                                    <tr>
                                        <td
                                    ...
                                    <tr>
                                        <td
                                            style="margin: 0.1px; padding: 10px 0px 0px; font: 200 12.3px / 15.7px Verdana, Geneva, sans-serif; color: rgb(0, 0, 0);">
                                            Follow us:</td>
                                    </tr>
                                    <tr>
                                        <td
                                            ...
                                            <table cellpadding="0" style="border-collapse: collapse;">
                                                <tr>
                                                    <td
                                                        ...
                                                        <span
                                                            style="border-radius: 0%; width: 25px; height: 25px; display: block; text-align: center; background-color: rgb(255, 255, 255); font-size: 12px; font-family: initial; line-height: 1;"><svg
                                ...
                                <table cellpadding="0" style="border-collapse: collapse;">
                                    <tr style="cursor: pointer;">
                                        <td
                                            ...
                                            <span
                                                style="color: rgb(191, 106, 75); font-weight: 600;">A&nbsp;&nbsp;</span><span
                                                style="color: rgb(0, 0, 0);">55 Halsey St Brooklyn,
                                                NY</span>&nbsp;&nbsp;<span
                                                style="color: rgb(191, 106, 75); font-weight: 600;">T&nbsp;&nbsp;</span><span
                                                style="color: rgb(0, 0, 0); text-decoration: none; font-family: Verdana, Geneva, sans-serif;">222
                                                335 3632</span></td>
                                    </tr>
                                    <tr style="cursor: pointer;">
                                        <td
            ...
            <table cellpadding="0" width="500"
                ...
                <tr style="cursor: pointer;">
                    <td width="34" height="34" align="center"
                        style="padding: 19px 0px 0px; margin: 0.1px; min-width: 34px;"><svg viewBox="0 0 1024 1024"
