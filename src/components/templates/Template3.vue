                                ...
                                <table cellpadding="0" style="border-collapse: collapse;">
                                    <tr>
                                        <td
                                            ...
                                            <span
                                                style="color: rgb(0, 0, 1); font-weight: 600; cursor: pointer;">VANESSA
                                                SLATER </span><!-- --><!-- -->
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr style="cursor: pointer;">
                                        <td
                                            style='margin: 0.1px; padding: 1px 0px; font: 12.8px / 16.3px "Palatino Linotype", "Book Antiqua", Palatino, serif; color: rgb(0, 0, 1);'>
                                            <!-- --><span
                                                style='color: rgb(0, 0, 1); text-decoration: none; font-family: "Palatino Linotype", "Book Antiqua", Palatino, serif;'>vanessa@skyline.com</span>
                                        </td>
                                    </tr>
                                    <tr style="cursor: pointer;">
                                        <td
                                            ...
                                            <table cellpadding="0" style="border-collapse: collapse;">
                                                <tr>
                                                    <td
                                                        ...
                                                        <span
                                                            style="border-radius: 50%; width: 25px; height: 25px; display: block; text-align: center; font-size: 12px; font-family: initial; line-height: 1;"><svg
