        ...
        <table cellpadding="0" width="500" style="border-collapse: collapse; font-size: 14.4px;">
                    ...
                    <table cellpadding="0" style="border-collapse: collapse;">
                        <tr>
                            <td valign="top" style="margin: 0.1px; padding: 0px; cursor: pointer;"><img
                                    src="https://img.mysignature.io/p/6/1/1/611f5ed1-5a04-572c-9f66-219871079bae.png?time=1685569257"
                                    width="148" alt=" &quot;created with MySignature.io&quot;"
                                    style="display: block; min-width: 148px;"></td>
                            <td valign="top"
                                ...
                                <table cellpadding="0" style="border-collapse: collapse;">
                                    <tr>
                                        <td
                                            ...
                                            <span
                                                style="font-weight: 600; color: rgb(114, 43, 182); cursor: pointer;">Nyle
                                                Hope</span><!----><!---->&nbsp;<span
                                                style="font: 14.4px / 18.3px Verdana, Geneva, sans-serif; color: rgb(0, 0, 1); cursor: pointer;">Head
                                                of Marketing</span></td>
                                    </tr>
                                    <tr>
                                        <td
                                            style="margin: 0.1px; padding: 0px 0px 5px; font: 14.4px / 18.3px Verdana, Geneva, sans-serif; color: rgb(0, 0, 1);">
                                            <span style="cursor: pointer;"><span
                                                    style="color: rgb(0, 0, 1);">Vortech</span></span><!----><!---->
                                        </td>
                                    </tr>
                                    <tr style="cursor: pointer;">
                                        <td
                                            ...
                                            <span
                                                style="color: rgb(114, 43, 182); font-weight: 600;">email:&nbsp;</span><span
                                                style="color: rgb(0, 0, 1); text-decoration: none; font-family: Verdana, Geneva, sans-serif;">hope@mysignature.io</span>
                                        </td>
                                    </tr>
                                    <tr style="cursor: pointer;">
                                        <td
                                            style="margin: 0.1px; padding: 2px 0px; font: 14.4px / 18.3px Verdana, Geneva, sans-serif; color: rgb(0, 0, 1);">
                                            <span
                                                style="color: rgb(114, 43, 182); font-weight: 600;">website:&nbsp;</span><span
                                    ...
                                    <tr style="cursor: pointer;">
                                        <td
                                            style="margin: 0.1px; padding: 2px 0px; font: 14.4px / 18.3px Verdana, Geneva, sans-serif; color: rgb(0, 0, 1);">
                                            <span
                                                style="color: rgb(114, 43, 182); font-weight: 600;">address:&nbsp;</span><span
                                                style="color: rgb(0, 0, 1);">3413 Post Farm Road, Atlanta</span></td>
                                    </tr><!---->
                                    <tr>
                                        <td
                                            ...
                                            <table cellpadding="0" style="border-collapse: collapse;">
                                                <tr>
                                                    <td
                                                        ...
                                                        <span
                                                            style="border-radius: 15%; width: 22px; height: 22px; display: block; text-align: center; background-color: rgb(114, 43, 182); font-size: 12px; font-family: initial; line-height: 1;"><svg
            ...
            <tr>
                <td
                    ...
                    <span><img
                            src="https://img.mysignature.io/b/6/1/1/611f5ed1-5a04-572c-9f66-219871079bae.png?time=1685569257"
                            valign="top" width="476" alt="created with MySignature.io" style="display: block;"></span>
                </td>
            </tr>
        </table>
        <div><!---->
