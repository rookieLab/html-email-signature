                ...
                <td style="margin: 0.1px; padding: 0px;">
                    <table cellpadding="0" style="border-collapse: collapse;">
                        <tr>
                            ...
                            <td style="margin: 0.1px; padding: 0px 0px 0px 15px; font: 12.8px / 16.3px Georgia, serif; color: rgb(0, 0, 1);"
                                valign="top">
                                <table cellpadding="0" style="border-collapse: collapse;">
                                    <tr>
                                        <td
                                    ...
                                    <tr>
                                        <td
                                            ...
                                            <span style="cursor: pointer;"><span style="color: rgb(0, 0, 1);">Coral
                                                    Coast
                                                    Academy</span></span> <span style="cursor: pointer;"><span
                                                    style="color: rgb(0, 0, 1);">History</span></span>
                                        </td>
                                    </tr>
