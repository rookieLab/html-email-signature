        ...
        <table cellpadding="0" style="border-collapse: collapse; font-size: 14.4px;">
            <tr>
                <td align="center" style="margin: 0.1px; padding: 0px 0px 13px; cursor: pointer;"><img
                        src="https://img.mysignature.io/p/a/f/e/afeef554-e1bf-5b5d-b0d1-062e88f384eb.png?time=1685569257"
                        width="154" alt=" &quot;created with MySignature.io&quot;"
                        style="display: block; min-width: 154px;"></td>
            </tr>
            <tr>
                <td align="center"
                    style="margin: 0.1px; padding: 0px 0px 5px; font: 18.7px / 23.8px Verdana, Geneva, sans-serif; color: rgb(0, 0, 1);">
                    <span style="font-weight: 600; color: rgb(155, 155, 155); cursor: pointer;">KAYDAN
                        PADILLA</span><!----><!----></td>
            </tr>
            <tr>
                <td align="center"
                    style="margin: 0.1px; padding: 0px 0px 5px; font: 600 14.4px / 18.3px Verdana, Geneva, sans-serif; color: rgb(0, 0, 1);">
                    <span style="cursor: pointer;">CUSTOMER SUPPORT AT</span>&nbsp;<span style="cursor: pointer;">PALM
                        THERAPY</span></td>
            </tr>
            <tr style="cursor: pointer;">
                <td align="center"
                    style="margin: 0.1px; padding: 5px 20px; font: 14.4px / 18.3px Verdana, Geneva, sans-serif; color: rgb(155, 155, 155); border-bottom: 1px solid rgb(235, 228, 228);">
                    <span>phone:&nbsp;</span><span
                        style="color: rgb(0, 0, 1); text-decoration: none; font-family: Verdana, Geneva, sans-serif;">+1321400007</span>&nbsp;&nbsp;<span>email:&nbsp;</span><span
                        style="color: rgb(0, 0, 1); text-decoration: none; font-family: Verdana, Geneva, sans-serif;">padilla@mysignature.io</span>
                </td>
            </tr>
            <tr style="cursor: pointer;">
                <td align="center"
                    ...
                    <table cellpadding="0" align="center" style="border-collapse: collapse;">
                        <tr>
                            <td style="margin: 0.1px; padding: 0px 2.5px; cursor: pointer;"><span
                                    style="border-radius: 0%; width: 24px; height: 24px; display: block; text-align: center; background-color: rgb(74, 74, 74); font-size: 12px; font-family: initial; line-height: 1;"><svg
