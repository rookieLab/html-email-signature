        ...
        <table cellpadding="0" style="border-collapse: collapse;">
            <tr>
                <td style="margin: 0.1px; padding: 10px 0px; cursor: pointer;"><img width="500"
                        src="https://img.mysignature.io/a/v1/9/8/f/98fd4a24-c5b1-5a64-b533-e4853a5d262a.png"
                        alt="Regards,"></td>
            </tr>
        </table>
        <table cellpadding="0" style="border-collapse: collapse; font-size: 11.2px;">
            <tr>
                <td align="center" style="margin: 0.1px; padding: 0px 0px 13px; cursor: pointer;"><img
                        src="https://img.mysignature.io/p/6/e/3/6e33096e-5ed0-5972-9000-b46f8596c063.png?time=1709290104"
            ...
            <tr>
                <td align="center"
                    ...
                    <span style="cursor: pointer;">DEPARTMENT OF COMPUTER SCIENCE</span>&nbsp;<span
                        style="cursor: pointer;">MOUNTAINVIEW COLLEGE</span></td>
            </tr>
            <tr style="cursor: pointer;">
                <td align="center"
                    ...
                    <span>email:&nbsp;</span><span
                        style="color: rgb(0, 0, 1); text-decoration: none; font-family: Tahoma, Geneva, sans-serif;">your@mysignature.io</span>&nbsp;&nbsp;<span>phone:&nbsp;</span><span
                    ...
                    <table cellpadding="0" align="center" style="border-collapse: collapse;">
                        <tr>
                            <td style="margin: 0.1px; padding: 0px 2.5px; cursor: pointer;"><span
                                    style="border-radius: 15%; width: 23px; height: 23px; display: block; text-align: center; background-color: rgb(169, 205, 188); font-size: 12px; font-family: initial; line-height: 1;"><svg
            ...
            <table width="500" cellspacing="0" cellpadding="0" border="0">
                <tr>
                    <td style="margin: 0.1px; padding-top: 10px; cursor: pointer;"><span><img
                                src="https://img.mysignature.io/b/6/e/3/6e33096e-5ed0-5972-9000-b46f8596c063.png?time=1709290104"
                                valign="top" width="308" alt="created with MySignature.io"
