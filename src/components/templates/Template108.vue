                    ...
                    <table cellpadding="0" style="border-collapse: collapse;">
                        <tr>
                            <td valign="top" style="margin: 0.1px; padding: 0px; cursor: pointer;"><img
                                    src="https://img.mysignature.io/p/5/3/b/53b64af7-2b23-58b2-9672-6bea257c632f.png?time=1710786416"
                                    width="141" alt=" &quot;created with MySignature.io&quot;"
                                    style="display: block; min-width: 141px;"></td>
                            <td valign="top"
                                style="margin: 0.1px; padding: 0px 0px 0px 15px; font: 13.4px / 17.1px &quot;Arial Black&quot;, Gadget, sans-serif; color: rgb(0, 0, 1);">
                                <table cellpadding="0" style="border-collapse: collapse;">
                                    <tr>
                                        <td
                                            style="margin: 0.1px; padding: 0px 0px 5px; font: 16.1px / 20.5px &quot;Arial Black&quot;, Gadget, sans-serif; color: rgb(0, 0, 1);">
                                            <span
                                                style="font-weight: 600; color: rgb(136, 133, 87); cursor: pointer;">TRAVEL
                                                BLOGER</span><!----><!----><!----><!----></td>
                                    </tr>
                                    <tr>
                                        <td
                                            style="margin: 0.1px; padding: 0px 0px 5px; font: 13.4px / 17.1px &quot;Arial Black&quot;, Gadget, sans-serif; color: rgb(0, 0, 1);">
                                            <span style="cursor: pointer;"><span style="color: rgb(0, 0, 1);">Antony
                                                    Myers</span></span><!----><!----></td>
                                    </tr>
                                    <tr style="cursor: pointer;">
                                        <td
                                            style="margin: 0.1px; padding: 2px 0px; font: 13.4px / 17.1px &quot;Arial Black&quot;, Gadget, sans-serif; color: rgb(0, 0, 1);">
                                            <span
                                                style="color: rgb(136, 133, 87); font-weight: 600;">mobile:&nbsp;</span><span
                                                style="color: rgb(0, 0, 1); text-decoration: none; font-family: &quot;Arial Black&quot;, Gadget, sans-serif;">+1
                                    ...
                                    <tr style="cursor: pointer;">
                                        <td
                                            style="margin: 0.1px; padding: 2px 0px; font: 13.4px / 17.1px &quot;Arial Black&quot;, Gadget, sans-serif; color: rgb(0, 0, 1);">
                                            <span
                                                style="color: rgb(136, 133, 87); font-weight: 600;">email:&nbsp;</span><span
                                                style="color: rgb(0, 0, 1); text-decoration: none; font-family: &quot;Arial Black&quot;, Gadget, sans-serif;">antony@mysignature.io</span>
                                        </td>
                                    </tr>
                                    <tr style="cursor: pointer;">
                                        <td
                                            style="margin: 0.1px; padding: 2px 0px; font: 13.4px / 17.1px &quot;Arial Black&quot;, Gadget, sans-serif; color: rgb(0, 0, 1);">
                                            <span
                                                style="color: rgb(136, 133, 87); font-weight: 600;">website:&nbsp;</span><span
                                                style="color: rgb(0, 0, 1); text-decoration: none; font-family: &quot;Arial Black&quot;, Gadget, sans-serif;">mysignature.io</span>
                                        </td>
                                    </tr><!---->
                                    <tr>
                                        <td
                                            style="margin: 0.1px; padding: 8px 0px 0px; font: 13.4px / 17.1px &quot;Arial Black&quot;, Gadget, sans-serif; color: rgb(0, 0, 1);">
                                            <table cellpadding="0" style="border-collapse: collapse;">
                                                <tr>
                                                    <td
                                                        style="margin: 0.1px; padding: 0px 4px 0px 0px; font: 13.4px / 17.1px &quot;Arial Black&quot;, Gadget, sans-serif; color: rgb(0, 0, 1); cursor: pointer;">
                                                        <span
                                                            style="border-radius: 50%; width: 36px; height: 36px; display: block; text-align: center; background-color: rgb(255, 255, 255); font-size: 12px; font-family: initial; line-height: 1;"><svg
                                                                viewBox="0 0 1024 1024"
                                                                xmlns="http://www.w3.org/2000/svg"
                                                                style="position: relative; top: 7.2px; width: 21.6px;">
                                                                <path
