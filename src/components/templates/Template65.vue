...
<table cellpadding="0" style="border-collapse: collapse; font-size: 11.5px;" width="500">
<tr>
...
<table cellpadding="0" style="border-collapse: collapse;">
<tr>
<td style="margin: 0.1px; padding: 0px 0px 2px; font: 13.8px / 17.6px Arial, Helvetica, sans-serif; color: rgb(0, 0, 1); cursor: pointer;">
<span style="font-weight: 600; color: rgb(0, 0, 0); cursor: pointer;">DANYAL
                                                                                FISHER</span><!-- --><!-- -->
</td>
</tr>
<tr>
<td style="margin: 0.1px; padding: 0px 0px 8px; font: 600 11.5px / 14.7px Arial, Helvetica, sans-serif; color: rgb(0, 0, 1);">
<span style="cursor: pointer;">Commercial
                                                                                Director</span> <span style="cursor: pointer;">at
                                                                                Archer</span>
</td>
</tr>
<tr style="cursor: pointer;">
<td style="margin: 0.1px; padding: 1px 0px; font: 11.5px / 14.7px Arial, Helvetica, sans-serif; color: rgb(0, 0, 1);">
<span>mobile: </span><span style="color: rgb(0, 0, 1); text-decoration: none; font-family: Arial, Helvetica, sans-serif;">+1
                                                                                729 855
                                                                                4555</span>, <!-- --><span style="color: rgb(0, 0, 1); text-decoration: none; font-family: Arial, Helvetica, sans-serif;"></span>
</td>
</tr>
<tr style="cursor: pointer;">
<td style="margin: 0.1px; padding: 1px 0px; font: 11.5px / 14.7px Arial, Helvetica, sans-serif; color: rgb(0, 0, 1);">
...
<tr style="cursor: pointer;">
<td style="margin: 0.1px; padding: 1px 0px; font: 11.5px / 14.7px Arial, Helvetica, sans-serif; color: rgb(0, 0, 1);">
<span>email: </span><span style="color: rgb(0, 0, 1); text-decoration: none; font-family: Arial, Helvetica, sans-serif;">danyalfisher@mysignature.io</span><!-- --><!-- -->
</td>
</tr><!-- -->
<tr>
...
<table cellpadding="0" style="border-collapse: collapse;">
<tr>
<td style="margin: 0.1px; padding: 0px 4px 0px 0px; font: 11.5px / 14.7px Arial, Helvetica, sans-serif; color: rgb(0, 0, 1); cursor: pointer;">
<span style="border-radius: 50%; width: 29px; height: 29px; display: block; text-align: center; background-color: rgb(0, 0, 0); font-size: 12px; font-family: initial; line-height: 1;"><svg style="position: relative; top: 5.8px; width: 17.4px;" viewbox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg">
...
<td style="margin: 0.1px; padding: 0px 4px 0px 0px; font: 11.5px / 14.7px Arial, Helvetica, sans-serif; color: rgb(0, 0, 1); cursor: pointer;">
<span style="border-radius: 50%; width: 29px; height: 29px; display: block; text-align: center; background-color: rgb(0, 0, 0); font-size: 12px; font-family: initial; line-height: 1;"><svg style="position: relative; top: 5.8px; width: 17.4px;" viewbox="0 0 1053 1024" xmlns="http://www.w3.org/2000/svg">
