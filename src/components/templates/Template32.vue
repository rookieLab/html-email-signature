    ...
    <div>
                    ...
                    <table cellpadding="0" style="border-collapse: collapse;">
                        <tr>
                            <td valign="top" style="margin: 0.1px; padding: 0px 15px 0px 0px; cursor: pointer;"><img
                                    ...
                                    width="129" alt=" &quot;created with MySignature.io&quot;"
                                    style="display: block; min-width: 129px;"></td>
                                            ...
                                            <table cellpadding="0" style="border-collapse: collapse;">
                                                <tr>
                                                    <td
                                                        ...
                                                        <span
                                                            style="border-radius: 0%; width: 23px; height: 23px; display: block; text-align: center; background-color: rgb(55, 0, 154); font-size: 12px; font-family: initial; line-height: 1;"><svg
        ...
        <div>
            <table width="359" cellpadding="0" style="border-collapse: collapse;">
                <tr>
                    <td
                        style="margin: 0.1px; padding: 15px 0px 0px; font: 12.1px / 15.3px Verdana, Geneva, sans-serif; color: rgb(131, 131, 131); cursor: pointer;">
                        Please consider the environment before printing this email. Every unprinted email helps the
                        environment.</td>
                </tr>
            </table>
