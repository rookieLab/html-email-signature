                                ...
                                <table cellpadding="0" style="border-collapse: collapse;">
                                    <tr>
                                        <td style="margin: 0.1px; padding: 4px 15px 0px 0px; cursor: pointer;">
                                            <span
                                                style="border-radius: 0%; width: 23px; height: 23px; display: block; text-align: center; background-color: rgb(224, 16, 108); font-size: 12px; font-family: initial; line-height: 1;"><svg
                                    ...
                                    <tr>
                                        <td
                                            ...
                                            <span style="cursor: pointer;"></span><!-- --><span
                                                style="cursor: pointer;">Instagram
                                                Influencer</span>
                                        </td>
                                    </tr>
                                    <tr style="cursor: pointer;">
                                        <td
                                            ...
                                            <span>phone: </span><span
                                                ...
                                                733 953
                                                63</span><!-- --><!-- --><span style="color: rgb(0, 0, 1);"></span>
                                        </td>
                                    </tr>
                                    <tr style="cursor: pointer;">
                                        <td
                                    ...
                                    <tr>
                                        <td
                                            ...
                                            <span
                                                ...
                                                my </span> <span
                                                style="color: rgb(216, 29, 84); font-weight: 600; cursor: pointer;">MEDIAKIT</span>
                                        </td>
                                    </tr>
                                </table>
                            </td>
