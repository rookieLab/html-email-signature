                                ...
                                <table cellpadding="0" style="border-collapse: collapse;">
                                    <tr>
                                        <td
                                            ...
                                            <span style="cursor: pointer;">Addison
                                                Mosley</span><!-- --><!-- -->
                                        </td>
                                    </tr>
                                    <tr>
                                        <td
                                            ...
                                            <span style="cursor: pointer;">
                                                Florist</span> <span style="cursor: pointer;">at
                                                LilyBloom</span><!-- --><span style="cursor: pointer;"></span>
                                        </td>
                                    </tr>
                                    <tr style="cursor: pointer;">
                                        <td
                                            style='margin: 0.1px; padding: 0px; font: 14.4px / 18.3px "Lucida Sans Unicode", "Lucida Grande", sans-serif; color: rgb(0, 0, 1);'>
                                            <span style="color: rgb(132, 118, 108);">e: </span><span
                                                style='color: rgb(0, 0, 1); text-decoration: none; font-family: "Lucida Sans Unicode", "Lucida Grande", sans-serif;'>amosley@mysignature.io</span>
                                        </td>
                                    </tr>
                                    <tr style="cursor: pointer;">
                                        <td
                                            style='margin: 0.1px; padding: 0px; font: 14.4px / 18.3px "Lucida Sans Unicode", "Lucida Grande", sans-serif; color: rgb(0, 0, 1);'>
                                            <span style="color: rgb(132, 118, 108);">w: </span><span
                                    ...
                                    <tr style="cursor: pointer;">
                                        <td
                                            style='margin: 0.1px; padding: 0px; font: 14.4px / 18.3px "Lucida Sans Unicode", "Lucida Grande", sans-serif; color: rgb(0, 0, 1);'>
                                            <span style="color: rgb(132, 118, 108);">p: </span><span
                                                style='color: rgb(0, 0, 1); text-decoration: none; font-family: "Lucida Sans Unicode", "Lucida Grande", sans-serif;'>566-728-42</span>
                                        </td>
                                    </tr>
                                    <tr style="cursor: pointer;">
                                        <td
                                            style='margin: 0.1px; padding: 0px; font: 14.4px / 18.3px "Lucida Sans Unicode", "Lucida Grande", sans-serif; color: rgb(0, 0, 1);'>
                                            <span style="color: rgb(132, 118, 108);">a: </span><span
                                                style="color: rgb(0, 0, 1);">517
                                                Robinson
                                                Lane, Athens</span>
                                        </td>
                                    </tr>
                                    <tr style="cursor: pointer;">
                                        <td
                                            style='margin: 0.1px; padding: 0px; font: 14.4px / 18.3px "Lucida Sans Unicode", "Lucida Grande", sans-serif; color: rgb(0, 0, 1);'>
                                            <span style="color: rgb(132, 118, 108);">m: </span><span
                                                style='color: rgb(0, 0, 1); text-decoration: none; font-family: "Lucida Sans Unicode", "Lucida Grande", sans-serif;'>+6-482-838-59</span>
                                        </td>
                                    </tr>
                                </table>
                            </td>
                            <td style='border-left: 3px solid rgb(56, 103, 107); margin: 0.1px; padding: 0px 0px 0px 6px; font: 14.4px / 18.3px "Lucida Sans Unicode", "Lucida Grande", sans-serif; color: rgb(0, 0, 1);'
                                valign="middle">
                                <table cellpadding="0" style="border-collapse: collapse;">
                                    <tr>
                                        <td style="margin: 0.1px; padding: 4px 0px 0px; cursor: pointer;">
                                            <span
                                                style="border-radius: 0%; width: 22px; height: 22px; display: block; text-align: center; background-color: rgb(56, 103, 107); font-size: 12px; font-family: initial; line-height: 1;"><svg
