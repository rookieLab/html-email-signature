    ...
    <div>
                ...
                <td style="margin: 0.1px; padding: 0px;">
                    <table cellpadding="0" style="border-collapse: collapse;">
                        <tr>
                                    ...
                                    <tr style="cursor: pointer;">
                                        <td
                                            ...
                                            <span style="color: rgb(191, 144, 140);">இ&nbsp;</span><span
                                                style="color: rgb(33, 64, 110); text-decoration: none; font-family: Georgia, serif;">mysignature.io</span>
                                        </td>
                                    </tr>
                                    <tr style="cursor: pointer;">
                                        <td
                                            style="margin: 0.1px; padding: 1px 0px; font: 12.5px / 15.9px Georgia, serif; color: rgb(33, 64, 110);">
                                            <span style="color: rgb(191, 144, 140);">இ&nbsp;</span><span
                                                style="color: rgb(33, 64, 110); text-decoration: none; font-family: Georgia, serif;">email@example.com</span>
                                        </td>
                                    </tr>
                                    <tr style="cursor: pointer;">
                                        <td
                                    ...
                                    <tr>
                                        <td
                                            ...
                                            <table cellpadding="0" style="border-collapse: collapse;">
                                                <tr>
                                                    <td
                                                        style="margin: 0.1px; padding: 0px 4px 0px 0px; font: 12.5px / 15.9px Georgia, serif; color: rgb(0, 0, 1); cursor: pointer;">
                                                        <span
                                                            style="border-radius: 50%; width: 21px; height: 21px; display: block; text-align: center; background-color: rgb(33, 64, 110); font-size: 12px; font-family: initial; line-height: 1;"><svg
                            ...
                            <td valign="top" style="margin: 0.1px; padding: 0px 0px 0px 15px; cursor: pointer;"><img
                                    src="https://img.mysignature.io/p/e/0/c/e0c37f7d-1995-5dc6-aa94-e1dfb5a04abc.png?time=1708942358"
        ...
        <div>
            <table width="383" cellpadding="0" style="border-collapse: collapse;">
                <tr>
                    <td
                        style="margin: 0.1px; padding: 15px 0px 0px; font: 12.1px / 15.3px Georgia, serif; color: rgb(191, 144, 140); cursor: pointer;">
            ...
            <table cellpadding="0" style="border-collapse: collapse;">
                <tr>
                    <td style="padding: 17px 4px 4px 0px; margin: 0.1px;"><span><img
                                src="https://img.mysignature.io/addons/v2/dribbble_v1_shape3_i.png" height="32"
