<template>
    <div>
        ...
        <table cellpadding="0" style="border-collapse: collapse; font-size: 13.4px; background-color: rgb(42, 42, 42);">
            <tr>
                <td
                                    ...
                                    <tr>
                                        <td
                                            ...
                                            <span style="cursor: pointer;">Co-founder</span>&nbsp;|&nbsp;<span
                                                style="cursor: pointer;">| APEXIN DIGITAL</span><!----><!----></td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td
                                            ...
                                            <table cellpadding="0" style="border-collapse: collapse;">
                                                <tr>
                                                    <td
                                                        style="margin: 0.1px; padding: 0px 5px 0px 0px; font: 13.4px / 17.1px Arial, Helvetica, sans-serif; color: rgb(0, 0, 1); cursor: pointer;">
                                                        <span
                                                    ...
                                                    <td
                                                        ...
                                                        <span
                                                            style="border-radius: 0%; width: 25px; height: 25px; display: block; text-align: center; background-color: rgb(255, 255, 255); font-size: 12px; font-family: initial; line-height: 1;"><svg
                                                                ...
                                                                style="position: relative; top: 5px; width: 15px;">
                                                                <path
                                                                    d="M1024 523.874c0 292.672-200.24 500.126-501.668 500.126-288.601 0-522.332-229.109-522.332-512s233.732-512 522.332-512c141.094 0 258.673 50.292 349.884 134.112l-141.805 133.414c-38.481-36.322-106.176-78.93-208.077-78.93-178.149 0-323.518 144.59-323.518 323.405s145.369 323.405 323.518 323.405c206.652 0 284.325-145.987 296.439-220.726h-296.439v-176.022h493.116c4.988 25.845 8.551 51.689 8.551 85.217v0.001z"
                                                                    fill="#3C3C3C"></path>
                                                            </svg></span></td>
                                                </tr>
                                            </table>
