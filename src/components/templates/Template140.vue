...
<img alt="Kind regards," src="https://img.mysignature.io/a/v1/c/c/f/ccfcf715-822d-5d22-88eb-cc5bbbddfc22.png" width="500"/>
</td>
</tr>
</table>
<table cellpadding="0" style="border-collapse: collapse; font-size: 11.7px;" width="500">
<tr>
<td style="margin: 0.1px; padding: 0px;">
<table cellpadding="0" style="border-collapse: collapse;">
<tr>
<td style="margin: 0.1px; padding: 0px 15px 0px 0px; cursor: pointer;" valign="top">
<img alt="SignMaker" src="https://img.mysignature.io/p/0/3/3/033ff455-74e2-5f72-b210-a9c9d3ff18ee.png?time=1708945032" style="display: block; min-width: 122px;" width="122"/>
</td>
<td style="margin: 0.1px; padding: 0px;" valign="top">
<table cellpadding="0" style="border-collapse: collapse;">
<tr>
<td style="margin: 0.1px; padding: 0px 0px 2px; font: 14.1px / 17.8px Tahoma, Geneva, sans-serif; color: rgb(0, 0, 1); cursor: pointer;">
...
<tr>
<td style="margin: 0.1px; padding: 0px 0px 8px; font: 600 11.7px / 14.9px Tahoma, Geneva, sans-serif; color: rgb(0, 0, 0);">
<span style="cursor: pointer;">Cardiologist</span><!-- --><!-- -->
</td>
</tr>
<tr style="cursor: pointer;">
<td style="margin: 0.1px; padding: 1px 0px; font: 11.7px / 14.9px Tahoma, Geneva, sans-serif; color: rgb(0, 0, 0);">
<span>phone: </span><span style="color: rgb(0, 0, 0); text-decoration: none; font-family: Tahoma, Geneva, sans-serif;">+1
                                                                                797 607
                                                                                3422</span>, <span>mobile: </span><span style="color: rgb(0, 0, 0); text-decoration: none; font-family: Tahoma, Geneva, sans-serif;">+1
                                                                                554 342 9908</span>
</td>
</tr>
<tr style="cursor: pointer;">
<td style="margin: 0.1px; padding: 1px 0px; font: 11.7px / 14.9px Tahoma, Geneva, sans-serif; color: rgb(0, 0, 0);">
<span>email: </span><span style="color: rgb(0, 0, 0); text-decoration: none; font-family: Tahoma, Geneva, sans-serif;">name@example.com</span><!-- --><!-- -->
</td>
</tr>
<tr style="cursor: pointer;">
<td style="margin: 0.1px; padding: 1px 0px; font: 11.7px / 14.9px Tahoma, Geneva, sans-serif; color: rgb(0, 0, 0);">
<span>skype: </span><span style="color: rgb(0, 0, 0); text-decoration: none; font-family: Tahoma, Geneva, sans-serif;">Dr.Matthew</span><!-- --><!-- -->
</td>
</tr><!-- -->
<tr>
<td style="margin: 0.1px; padding: 10px 0px 0px; font: 11.7px / 14.9px Tahoma, Geneva, sans-serif; color: rgb(0, 0, 1);">
<table cellpadding="0" style="border-collapse: collapse;">
<tr>
<td style="margin: 0.1px; padding: 0px 4px 0px 0px; font: 11.7px / 14.9px Tahoma, Geneva, sans-serif; color: rgb(0, 0, 1); cursor: pointer;">
<span style="border-radius: 0%; width: 23px; height: 23px; display: block; text-align: center; background-color: rgb(137, 147, 216); font-size: 12px; font-family: initial; line-height: 1;"><svg style="position: relative; top: 4.6px; width: 13.8px;" viewbox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg">
...
<span><img alt="facebook" height="35" src="https://img.mysignature.io/addons/v2/facebook_v1_shape1_b.png" style="display: block;" width="123"/></span>
</td>
<td style="padding: 11px 4px 4px 0px; margin: 0.1px;">
<!-- -->
</td>
