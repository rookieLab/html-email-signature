    ...
    <div>
        <table cellpadding="0" style="border-collapse: collapse;">
            <tr>
                <td style="margin: 0.1px; padding: 10px 0px; cursor: pointer;"><img width="500"
                        src="https://img.mysignature.io/a/v1/5/5/9/5590bef8-c238-583e-b37c-c38f765c50d9.png"
                        alt="Best regards,"></td>
            </tr>
        </table>
        <table cellpadding="0" width="500" style="border-collapse: collapse; font-size: 15.5px;">
            <tr>
                <td style="margin: 0.1px; padding: 0px;">
                    <table cellpadding="0" style="border-collapse: collapse;">
                        <tr>
                            <td valign="top" style="margin: 0.1px; padding: 0px 15px 0px 0px; cursor: pointer;"><img
                                    src="https://img.mysignature.io/p/e/1/3/e133581c-4eba-54a2-a71a-65769c4828aa.png?time=1708946207"
                                    ...
                                    <tr>
                                        <td
                                            ...
                                            <table cellpadding="0" style="border-collapse: collapse;">
                                                <tr>
                                                    <td
                                                        style="margin: 0.1px; padding: 0px 4px 0px 0px; font: 15.5px / 19.7px &quot;Courier New&quot;, Courier, monospace; color: rgb(0, 0, 1); cursor: pointer;">
                                                        <span
                                                            style="border-radius: 50%; width: 30px; height: 30px; display: block; text-align: center; background-color: rgb(0, 0, 1); font-size: 12px; font-family: initial; line-height: 1;"><svg
        ...
        <div>
            <table width="500" cellpadding="0" style="border-collapse: collapse;">
                <tr>
                    <td style="padding: 5px 10px 0px 0px; margin: 0.1px; cursor: pointer;"><img
                            alt="Feel free to contact me. Schedule a meeting"
