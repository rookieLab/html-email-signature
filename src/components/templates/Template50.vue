            ...
            <tr>
                <td
                    ...
                    <table cellpadding="0" style="border-collapse: collapse;">
                        <tr><!-- -->
                            <td style="margin: 0.1px; padding: 0px; font: 10.2px / 13.1px Verdana, Geneva, sans-serif; color: rgb(0, 0, 1);"
                                valign="top">
                                <table cellpadding="0" style="border-collapse: collapse;">
                                    <tr>
                                        <td
                                    ...
                                    <tr style="cursor: pointer;">
                                        <td
                                            ...
                                            <span>mobile: </span><span
                                                ...
                                                729 855
                                                4555</span> | <span>phone: </span><span
                                                style="color: rgb(0, 0, 0); text-decoration: none; font-family: Verdana, Geneva, sans-serif;">+1
                                                728 607 2433</span>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td
                                            ...
                                            <table cellpadding="0" style="border-collapse: collapse;">
                                                <tr>
                                                    <td
                                                        style="margin: 0.1px; padding: 0px 5px 0px 0px; font: 10.2px / 13.1px Verdana, Geneva, sans-serif; color: rgb(0, 0, 1); cursor: pointer;">
                                                        <span
                                                            style="border-radius: 0%; width: 25px; height: 25px; display: block; text-align: center; background-color: rgb(0, 0, 0); font-size: 12px; font-family: initial; line-height: 1;"><svg
