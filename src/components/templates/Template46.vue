    ...
    <div><!---->
                    ...
                    <table cellpadding="0" style="border-collapse: collapse;">
                        <tr>
                            <td valign="top" style="margin: 0.1px; padding: 0px 15px 0px 0px; cursor: pointer;"><img
                                    src="https://img.mysignature.io/p/2/f/3/2f3ce586-4e89-5468-8024-a8fddcb27ab1.png?time=1685569257"
                                ...
                                <table cellpadding="0" style="border-collapse: collapse;">
                                    ...
                                    <tr>
                                        <td
                                            ...
                                            <span style="cursor: pointer;">Marketing Manager</span>&nbsp;<span
                                                style="cursor: pointer;">at Onjoy</span></td>
                                    </tr>
                                    <tr style="cursor: pointer;">
                                        <td
                                            style="margin: 0.1px; padding: 1px 0px; font: 12.5px / 15.9px Georgia, serif; color: rgb(54, 54, 54);">
                                            <span>✦ &nbsp;</span><span
                                                style="color: rgb(54, 54, 54); text-decoration: none; font-family: Georgia, serif;">617-555-0130</span>,&nbsp;<span>✦
                                                &nbsp;</span><span
                                                style="color: rgb(54, 54, 54); text-decoration: none; font-family: Georgia, serif;">mysignature.io</span>
                                        </td>
                                    </tr>
                                    <tr style="cursor: pointer;">
                                        <td
                                            ...
                                            <table cellpadding="0" style="border-collapse: collapse;">
                                                <tr>
                                                    <td
                                                        ...
                                                        <span
                                                            style="border-radius: 50%; width: 27px; height: 27px; display: block; text-align: center; background-color: rgb(59, 171, 214); font-size: 12px; font-family: initial; line-height: 1;"><svg
        ...
        <div>
            <table cellpadding="0" width="500"
                ...
                <tr style="cursor: pointer;">
                    <td width="29" height="29" align="center"
                        style="padding: 17px 0px 0px; margin: 0.1px; min-width: 29px;"><svg viewBox="0 0 1024 1024"
                            xmlns="http://www.w3.org/2000/svg" style="width: 18.85px;">
                            <path
                    ...
                    <td style="font-family: Georgia, serif; font-size: 14.1px; padding: 17px 0px 0px; margin: 0.1px;">
                        <span>Book a meeting.&nbsp;</span><span
                            style="text-decoration: none; font-size: 14.1px; color: rgb(59, 171, 214);">Choose a
                            time</span></td>
                </tr>
            </table>
            <table width="430" cellpadding="0" style="border-collapse: collapse;">
                <tr>
                    <td
                        style="margin: 0.1px; padding: 15px 0px 0px; font: 12.1px / 15.3px Georgia, serif; color: rgb(144, 144, 144); cursor: pointer;">
