    ...
    <div><!-- -->
                    ...
                    <table cellpadding="0" style="border-collapse: collapse;">
                        <tr>
                            <td style="margin: 0.1px; padding: 0px 15px 0px 0px; cursor: pointer;" valign="top">
                                <img alt="SignMaker"
                                    src="/assets/2f3ce586-4e89-5468-8024-a8fddcb27ab1.png"
                                    style="display: block; min-width: 139px;" width="139" />
                            </td>
        ...
        <div>
            <table cellpadding="0"
                ...
                width="500">
                <tr style="cursor: pointer;">
                    <td align="center" height="29" style="padding: 17px 0px 0px; margin: 0.1px; min-width: 29px;"
                        width="29">
                        <svg style="width: 18.85px;" viewbox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg">
                            <path
                    ...
                    <td style="font-family: Georgia, serif; font-size: 14.1px; padding: 17px 0px 0px; margin: 0.1px;">
                        <span>Book a meeting. </span><span
                            style="text-decoration: none; font-size: 14.1px; color: rgb(59, 171, 214);">Choose
                            a time</span>
                    </td>
                </tr>
            </table>
            <table cellpadding="0" style="border-collapse: collapse;" width="430">
                <tr>
                    <td
