        ...
        <table cellpadding="0" style="border-collapse: collapse;">
            <tr>
                <td style="margin: 0.1px; padding: 10px 0px; cursor: pointer;"><img width="500"
                        src="https://img.mysignature.io/a/v1/1/b/e/1be895a7-3e6f-57da-a0c4-3bd43bc8565a.png"
                        alt="Best regards,"></td>
            </tr>
        </table>
        <table cellpadding="0"
            style="border-collapse: collapse; font-size: 13.1px; background-color: rgb(231, 254, 255);">
            <tr>
                <td
                    style="margin: 0.1px; padding: 20px; font: 13.1px / 16.5px &quot;Palatino Linotype&quot;, &quot;Book Antiqua&quot;, Palatino, serif; color: rgb(0, 0, 1);">
                    <table cellpadding="0" style="border-collapse: collapse;">
                        <tr>
                            <td valign="top" style="margin: 0.1px; padding: 0px 15px 0px 0px; cursor: pointer;"><img
                                    src="https://img.mysignature.io/p/3/b/8/3b85d994-3ac5-5255-b9df-8f5b3328829f.png?time=1709046225"
                                    width="136" alt=" &quot;created with MySignature.io&quot;"
                                    style="display: block; min-width: 136px;"></td>
                            <td valign="top"
                                style="margin: 0.1px; padding: 0px; font: 13.1px / 16.5px &quot;Palatino Linotype&quot;, &quot;Book Antiqua&quot;, Palatino, serif; color: rgb(0, 0, 1);">
                                <table cellpadding="0" style="border-collapse: collapse;">
                                    <tr>
                                        <td
                                    ...
                                    <tr style="cursor: pointer;">
                                        <td
                                            ...
                                            <span>●&nbsp;</span><span
                                                style="color: rgb(11, 33, 62); text-decoration: none; font-family: &quot;Palatino Linotype&quot;, &quot;Book Antiqua&quot;, Palatino, serif;">g.@harris.io</span>&nbsp;|&nbsp;<span>●&nbsp;</span><span
                                                style="color: rgb(11, 33, 62); text-decoration: none; font-family: &quot;Palatino Linotype&quot;, &quot;Book Antiqua&quot;, Palatino, serif;">+57-366-274-45</span>
                                        </td>
                                    </tr>
                                    <tr style="cursor: pointer;">
                                        <td
                                    ...
                                    <tr>
                                        <td
                                            ...
                                            <table cellpadding="0" style="border-collapse: collapse;">
                                                <tr>
                                                    <td
                                                        style="margin: 0.1px; padding: 0px 5px 0px 0px; font: 13.1px / 16.5px &quot;Palatino Linotype&quot;, &quot;Book Antiqua&quot;, Palatino, serif; color: rgb(0, 0, 1); cursor: pointer;">
                                                        <span
                                                            style="border-radius: 50%; width: 23px; height: 23px; display: block; text-align: center; background-color: rgb(38, 200, 248); font-size: 12px; font-family: initial; line-height: 1;"><svg
            ...
            <table cellpadding="0" style="border-collapse: collapse;">
                <tr>
                    <td style="padding: 15px 4px 4px 0px; margin: 0.1px;"><span><img
                                src="https://img.mysignature.io/addons/v2/behance_v1_shape3_b.png" height="29"
                                width="102" alt="behance" style="display: block;"></span></td>
                    <td style="padding: 15px 4px 4px 0px; margin: 0.1px;"><span><img
                                src="https://img.mysignature.io/addons/v2/linkedin_v1_shape3_b.png" height="29"
                                width="102" alt="linkedin" style="display: block;"></span></td>
                    <td style="padding: 15px 4px 4px 0px; margin: 0.1px;"><span><img
