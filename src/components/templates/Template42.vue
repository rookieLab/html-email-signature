            ...
            <tr>
                <td style="margin: 0.1px; padding: 0px;">
                    <table cellpadding="0" style="border-collapse: collapse;">
                        <tr>
                            <td style="margin: 0.1px; padding: 0px 20px 0px 0px; border-right: 2px solid rgb(225, 167, 76);"
                                valign="middle">
                                <table cellpadding="0" style="border-collapse: collapse;">
                                    <tr>
                                        <td align="center"
                                    ...
                                    <tr>
                                        <td align="center"
                                            ...
                                            <span style="cursor: pointer;">Motion
                                                Designer</span><!-- --><!-- -->
                                        </td>
                                    </tr>
                                </table>
                                ...
                                <table cellpadding="0" style="border-collapse: collapse;">
                                    <tr style="cursor: pointer;">
                                        <td
                                            ...
                                            <span style="color: rgb(225, 167, 76); font-weight: 600;">A:  </span><span
                                                style="color: rgb(0, 0, 1);">New
                                                York,
                                                USA</span>
                                        </td>
                                    </tr>
                                    <tr style="cursor: pointer;">
                                        <td
                                            ...
                                            <span style="color: rgb(225, 167, 76); font-weight: 600;">T:  </span><span
                                    ...
                                    <tr style="cursor: pointer;">
                                        <td
                                            style='margin: 0.1px; padding: 5px 0px 0px; font: 14.4px / 18.3px "Palatino Linotype", "Book Antiqua", Palatino, serif; color: rgb(0, 0, 1); white-space: nowrap;'>
                                            <span style="color: rgb(225, 167, 76); font-weight: 600;">E:  </span><span
                                    ...
                                    <tr>
                                        <td style="margin: 0.1px; padding: 15px 0px 0px;">
                                            <table cellpadding="0" style="border-collapse: collapse;">
                                                <tr>
                                                    <td
                                                        style='margin: 0.1px; padding: 0px 0px 5px; font: 14.4px / 18.3px "Palatino Linotype", "Book Antiqua", Palatino, serif; color: rgb(0, 0, 1);'>
                                                        Check my animation:
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td
                                                        ...
                                                        <table cellpadding="0" style="border-collapse: collapse;">
                                                            <tr>
                                                                <td
                                                                    style='margin: 0.1px; padding: 0px 4px 0px 0px; font: 14.4px / 18.3px "Palatino Linotype", "Book Antiqua", Palatino, serif; color: rgb(0, 0, 1); cursor: pointer;'>
                                                                    <span
                                                                        style="border-radius: 50%; width: 29px; height: 29px; display: block; text-align: center; background-color: rgb(163, 178, 210); font-size: 12px; font-family: initial; line-height: 1;"><svg
