<template>
    <div>
        <table cellpadding="0" width="500" style="border-collapse: collapse; font-size: 14.1px;">
                    ...
                    <table cellpadding="0" style="border-collapse: collapse;">
                        <tr>
                            <td valign="middle" style="margin: 0.1px; padding: 0px 15px 0px 0px; cursor: pointer;"><img
                                    src="https://img.mysignature.io/p/9/7/b/97bb48f7-13b0-5fd4-8dda-4249428c06b5.png?time=1685569257"
                                    width="134" alt=" &quot;created with MySignature.io&quot;"
                                    style="display: block; min-width: 134px;"></td>
                            <td valign="middle"
                                style="margin: 0.1px; padding: 0px; font: 14.1px / 17.9px &quot;Courier New&quot;, Courier, monospace; color: rgb(0, 0, 1);">
                                <table cellpadding="0" style="border-collapse: collapse;">
                                    <tr>
            ...
            <tr>
                <td
                    style="margin: 0.1px; padding: 15px 0px 0px; font: 14.1px / 17.9px &quot;Courier New&quot;, Courier, monospace; color: rgb(0, 0, 1); cursor: pointer;">
                    <span><img
                            src="https://img.mysignature.io/b/9/7/b/97bb48f7-13b0-5fd4-8dda-4249428c06b5.png?time=1685569257"
                            valign="top" width="350" alt="created with MySignature.io" style="display: block;"></span>
                </td>
            </tr>
        </table>
        <div>
