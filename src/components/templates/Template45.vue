            ...
            <tr>
                <td style="margin: 0.1px; padding: 20px; font: 16.1px / 20.4px Georgia, serif; color: rgb(0, 0, 1);">
                    <table cellpadding="0" style="border-collapse: collapse;">
                        <tr><!-- -->
                            <td style="margin: 0.1px; padding: 0px; font: 16.1px / 20.4px Georgia, serif; color: rgb(0, 0, 1);"
                                valign="top">
                                <table cellpadding="0" style="border-collapse: collapse;">
                                    <tr>
                                        <td
                                    ...
                                    <tr style="cursor: pointer;">
                                        <td
                                            style="margin: 0.1px; padding: 5px 0px 0px; font: 16.1px / 20.4px Georgia, serif; color: rgb(255, 255, 255);">
                                    ...
                                    <tr>
                                        <td
                                            ...
                                            <table cellpadding="0" style="border-collapse: collapse;">
                                                <tr>
                                                    <td
                                                        style="margin: 0.1px; padding: 0px 5px 0px 0px; font: 16.1px / 20.4px Georgia, serif; color: rgb(0, 0, 1); cursor: pointer;">
                                                        <span
