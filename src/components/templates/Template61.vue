...
<template>
 <div><!-- -->
<table cellpadding="0" style="border-collapse: collapse; font-size: 13.4px;" width="550">
<tr>
<td style="margin: 0.1px; padding: 0px;">
<table cellpadding="0" style="border-collapse: collapse;">
<tr>
<td style="margin: 0.1px; padding: 0px 20px 0px 0px; border-right: 3px solid rgb(212, 8, 109);" valign="top">
<table cellpadding="0" style="border-collapse: collapse;">
<tr>
<td style="margin: 0.1px; padding: 0px; font: 18.8px / 23.9px Tahoma, Geneva, sans-serif; color: rgb(0, 0, 1);">
<span style="color: rgb(212, 8, 109); cursor: pointer;">Regina
                                                                                Spils</span><!-- --><!-- -->
</td>
</tr><!-- -->
<tr>
<td style="margin: 0.1px; padding: 2px 0px 0px; font: 200 13.4px / 17.1px Tahoma, Geneva, sans-serif; color: rgb(0, 0, 1); cursor: pointer;">
                                                                            fashion blogger</td>
</tr><!-- -->
<tr>
...
<span style="color: rgb(212, 8, 109); font-weight: 600;">E  </span><span style="color: rgb(0, 0, 1); text-decoration: none; font-family: Tahoma, Geneva, sans-serif;">regina@mysignature.io</span>  <!-- --><span style="color: rgb(0, 0, 1); text-decoration: none; font-family: Tahoma, Geneva, sans-serif;">mysignature.io</span>
</td>
</tr>
<tr>
<td style="margin: 0.1px; padding: 2px 0px 0px; font: 13.4px / 17.1px Tahoma, Geneva, sans-serif; color: rgb(0, 0, 1);">
<span style="color: rgb(212, 8, 109); font-weight: 600; cursor: pointer;">PARTENRSHIPS </span><span style="color: rgb(212, 8, 109); text-decoration: none; font-family: Tahoma, Geneva, sans-serif; font-weight: 600;">544
                                                                                646
                                                                                2662</span> <!-- --><span style="color: rgb(212, 8, 109); font-weight: 600; cursor: pointer;"></span>
</td>
</tr>
</table>
</td>
