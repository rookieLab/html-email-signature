<template>
    <div><!---->
        <table cellpadding="0" width="500" style="border-collapse: collapse; font-size: 11.8px;">
                            ...
                            <td valign="top"
                                ...
                                <table cellpadding="0" style="border-collapse: collapse;">
                                    ...
                                    <tr style="cursor: pointer;">
                                        <td
                                            style="margin: 0.1px; padding: 2px 0px; font: 11.8px / 15.1px Verdana, Geneva, sans-serif; color: rgb(0, 0, 1);">
                                            <span style="color: rgb(67, 67, 67); font-weight: 600;">+1 733 953
                                                6362&nbsp;</span><span
                                                style="color: rgb(130, 130, 130); text-decoration: none; font-family: Verdana, Geneva, sans-serif;">phone</span>
                                        </td>
                                    </tr>
                                    <tr style="cursor: pointer;">
                                        <td
                                            style="margin: 0.1px; padding: 2px 0px; font: 11.8px / 15.1px Verdana, Geneva, sans-serif; color: rgb(0, 0, 1);">
                                            <span
                                                style="color: rgb(67, 67, 67); font-weight: 600;">s.lee@mysignature.io&nbsp;</span><span
                                                style="color: rgb(130, 130, 130); text-decoration: none; font-family: Verdana, Geneva, sans-serif;">email</span>
                                        </td>
                                    </tr>
                                    <tr style="cursor: pointer;">
                                        <td
                                            style="margin: 0.1px; padding: 2px 0px; font: 11.8px / 15.1px Verdana, Geneva, sans-serif; color: rgb(0, 0, 1);">
                                            <span
                                                style="color: rgb(67, 67, 67); font-weight: 600;">mysignature.io&nbsp;</span><span
                                                style="color: rgb(130, 130, 130); text-decoration: none; font-family: Verdana, Geneva, sans-serif;">mysignature.io</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td
                                            style="margin: 0.1px; padding: 8px 0px 3px; font: 11.8px / 15.1px Verdana, Geneva, sans-serif; color: rgb(130, 130, 130);">
                                            Connect with us on social media:</td>
                                    </tr>
                                    <tr>
                                        <td
                                            style="margin: 0.1px; padding: 0px; font: 11.8px / 15.1px Verdana, Geneva, sans-serif; color: rgb(0, 0, 1);">
                                            <table cellpadding="0" style="border-collapse: collapse;">
                                                <tr>
                                                    <td
                                                        style="margin: 0.1px; padding: 0px 4px 0px 0px; font: 11.8px / 15.1px Verdana, Geneva, sans-serif; color: rgb(0, 0, 1); cursor: pointer;">
                                                        <span
                                                            style="border-radius: 15%; width: 23px; height: 23px; display: block; text-align: center; background-color: rgb(253, 80, 34); font-size: 12px; font-family: initial; line-height: 1;"><svg
            ...
            <tr>
                <td
                    style="margin: 0.1px; padding: 15px 0px 0px; font: 11.8px / 15.1px Verdana, Geneva, sans-serif; color: rgb(0, 0, 1); cursor: pointer;">
                    <span><img
                            src="https://img.mysignature.io/b/1/3/8/1386cb6b-b66f-5f6b-a6ae-34de5dfb1c48.png?time=1709544034"
                            valign="top" width="298" alt="created with MySignature.io" style="display: block;"></span>
                </td>
            </tr>
        </table>
        <div>
            <table width="500" cellpadding="0" style="border-collapse: collapse;">
                <tr>
                    <td style="padding: 13px 10px 0px 0px; margin: 0.1px; cursor: pointer;"><span><img
                                alt="Need assistance? Schedule a call"
