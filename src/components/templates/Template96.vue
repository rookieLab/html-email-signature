<template>
    <div>
        <table cellpadding="0" width="500" style="border-collapse: collapse; font-size: 13.3px;">
            <tr>
                        ...
                        <tr>
                            <td valign="top" style="margin: 0.1px; padding: 0px;">
                                <table cellpadding="0" style="border-collapse: collapse;">
                                    <tr>
                                        <td
                                            style="margin: 0.1px; padding: 0px 0px 2px; font: 15.9px / 20.3px Arial, Helvetica, sans-serif; color: rgb(0, 0, 1);">
                                            <span
                                                style="color: rgb(243, 121, 44); font-weight: 600; cursor: pointer;">WILSON
                                                ARMSTRONG</span></td>
                                    </tr>
                                    <tr>
                                        <td
                                            style="margin: 0.1px; padding: 0px 0px 10px; font: 600 13.3px / 16.9px Arial, Helvetica, sans-serif; color: rgb(75, 75, 75);">
                                            <span style="cursor: pointer;">Fitness and Nutrition
                                                Blog</span></td>
                                    </tr>
                                    <tr style="cursor: pointer;">
                                        <td
                                            style="margin: 0.1px; padding: 1px 0px; font: 13.3px / 16.9px Arial, Helvetica, sans-serif; color: rgb(75, 75, 75);">
                                            <span style="color: rgb(243, 121, 44);">W:&nbsp;</span><span
                                                style="color: rgb(75, 75, 75); text-decoration: none; font-family: Arial, Helvetica, sans-serif;">mysignature.io</span>
                                        </td>
                                    </tr>
                                    <tr style="cursor: pointer;">
                                        <td
                                            style="margin: 0.1px; padding: 1px 0px; font: 13.3px / 16.9px Arial, Helvetica, sans-serif; color: rgb(75, 75, 75);">
                                            <span style="color: rgb(243, 121, 44);">E:&nbsp;</span><span
                                                style="color: rgb(75, 75, 75); text-decoration: none; font-family: Arial, Helvetica, sans-serif;">wilson@mysignature.io</span>
                                        </td>
                                    </tr>
                                    <tr style="cursor: pointer;">
                                        <td
                                            style="margin: 0.1px; padding: 1px 0px; font: 13.3px / 16.9px Arial, Helvetica, sans-serif; color: rgb(75, 75, 75);">
                                            <span style="color: rgb(243, 121, 44);">T:&nbsp;</span><span
                                                style="color: rgb(75, 75, 75); text-decoration: none; font-family: Arial, Helvetica, sans-serif;">767
                                                454 9876</span></td>
                                    </tr>
                                    <tr style="cursor: pointer;">
                                        <td
                                            style="margin: 0.1px; padding: 1px 0px; font: 13.3px / 16.9px Arial, Helvetica, sans-serif; color: rgb(75, 75, 75);">
                                            <span style="color: rgb(243, 121, 44);">A:&nbsp;</span><span
                                                style="color: rgb(75, 75, 75);">814 Mission Str 600</span></td>
                                    </tr>
                                    <tr>
                                        <td
                                            style="margin: 0.1px; padding: 10px 0px 0px; font: 13.3px / 16.9px Arial, Helvetica, sans-serif; color: rgb(0, 0, 1);">
                                            <table cellpadding="0" style="border-collapse: collapse;">
                                                <tr>
                                                    <td
                                                        style="margin: 0.1px; padding: 0px 4px 0px 0px; font: 13.3px / 16.9px Arial, Helvetica, sans-serif; color: rgb(0, 0, 1); cursor: pointer;">
                                                        <span
                                                            style="border-radius: 15%; width: 22px; height: 22px; display: block; text-align: center; background-color: rgb(75, 75, 75); font-size: 12px; font-family: initial; line-height: 1;"><svg
                            ...
                            <td valign="top" style="margin: 0.1px; padding: 0px 0px 0px 15px; cursor: pointer;"><img
                                    src="https://img.mysignature.io/p/0/f/8/0f8f1695-2384-518c-b889-6c0eb86b50fa.png?time=1709543825"
                                    width="160" alt=" &quot;created with MySignature.io&quot;"
                                    style="display: block; min-width: 160px;"></td>
                        </tr>
                    </table>
                </td>
            </tr>
            ...
            <table width="500" cellpadding="0" style="border-collapse: collapse;">
                <tr style="cursor: pointer;">
                    <td width="30" style="padding: 15px 0px 0px; margin: 0.1px;"><img
                            src="https://img.mysignature.io/addons/v2/leaf.png"
                            alt="Please consider the environment before printing this email" style="display: block;">
                    </td>
                    <td
                        style="margin: 0.1px; padding: 15px 0px 0px; font: 12.1px / 15.3px Arial, Helvetica, sans-serif; color: gray;">
            ...
            <table width="500" cellspacing="0" cellpadding="0" border="0">
                <tr>
                    <td style="margin: 0.1px; padding-top: 10px; cursor: pointer;"><img
                            src="https://img.mysignature.io/b/0/f/8/0f8f1695-2384-518c-b889-6c0eb86b50fa.png?time=1709543825"
                            valign="top" width="353" alt="created with MySignature.io" style="display: block;"></td>
                </tr>
            </table>
            <table width="500" cellspacing="0" cellpadding="0" border="0">
                <tr>
