                    ...
                    <table cellpadding="0" style="border-collapse: collapse;">
                        <tr>
                            <td valign="top" style="margin: 0.1px; padding: 0px 15px 0px 0px; cursor: pointer;"><img
                                    src="https://img.mysignature.io/p/1/5/c/15c6506a-0e7f-5f82-a369-770ef5c64afd.png?time=1685569257"
                            ...
                            <td valign="top" style="margin: 0.1px; padding: 0px 15px 0px 0px;">
                                <table cellpadding="0" style="border-collapse: collapse;">
                                    ...
                                    <tr style="cursor: pointer;">
                                        <td
                                            style="margin: 0.1px; padding: 0px; font: 14.4px / 18.3px Arial, Helvetica, sans-serif; color: rgb(0, 0, 1);">
                                            <span style="color: rgb(243, 4, 34);">website:&nbsp;</span><span
                                    ...
                                    <tr style="cursor: pointer;">
                                        <td
                                            style="margin: 0.1px; padding: 0px; font: 14.4px / 18.3px Arial, Helvetica, sans-serif; color: rgb(0, 0, 1);">
                                            <span style="color: rgb(243, 4, 34);">email:&nbsp;</span><span
                                                style="color: rgb(0, 0, 1); text-decoration: none; font-family: Arial, Helvetica, sans-serif;">sarahs@mysignature.io</span>
                                        </td>
                                    </tr>
                                    <tr style="cursor: pointer;">
                                        <td
                                            style="margin: 0.1px; padding: 0px; font: 14.4px / 18.3px Arial, Helvetica, sans-serif; color: rgb(0, 0, 1);">
                                            <span style="color: rgb(243, 4, 34);">address:&nbsp;</span><span
                                                style="color: rgb(0, 0, 1);">84 Libron st</span></td>
                                    </tr>
                                    <tr style="cursor: pointer;">
                                        <td
                                            style="margin: 0.1px; padding: 0px; font: 14.4px / 18.3px Arial, Helvetica, sans-serif; color: rgb(0, 0, 1);">
                                            <span style="color: rgb(243, 4, 34);">phone:&nbsp;</span><span
                                                style="color: rgb(0, 0, 1); text-decoration: none; font-family: Arial, Helvetica, sans-serif;">644
                                                848 6363</span></td>
                                    </tr>
                                </table>
                            </td>
                            <td valign="middle"
                                style="border-left: 3px solid rgb(243, 4, 34); margin: 0.1px; padding: 0px 0px 0px 6px; font: 14.4px / 18.3px Arial, Helvetica, sans-serif; color: rgb(0, 0, 1);">
                                <table cellpadding="0" style="border-collapse: collapse;">
                                    <tr>
