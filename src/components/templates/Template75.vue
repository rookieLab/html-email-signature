...
<table cellpadding="0" style="border-collapse: collapse;">
<tr>
<td style='margin: 0.1px; padding: 0px 5px 0px 0px; font: 14.2px / 18.1px "Courier New", Courier, monospace; color: rgb(0, 0, 1); cursor: pointer;'>
<span style="border-radius: 0%; width: 26px; height: 26px; display: block; text-align: center; background-color: rgb(11, 23, 56); font-size: 12px; font-family: initial; line-height: 1;"><svg style="position: relative; top: 5.2px; width: 15.6px;" viewbox="0 0 1053 1024" xmlns="http://www.w3.org/2000/svg">
...
<td style='margin: 0.1px; padding: 0px 5px 0px 0px; font: 14.2px / 18.1px "Courier New", Courier, monospace; color: rgb(0, 0, 1); cursor: pointer;'>
<span style="border-radius: 0%; width: 26px; height: 26px; display: block; text-align: center; background-color: rgb(11, 23, 56); font-size: 12px; font-family: initial; line-height: 1;"><svg style="position: relative; top: 5.2px; width: 15.6px;" viewbox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg">
