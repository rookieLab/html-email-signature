<template>
    <div>
        ...
        <table cellpadding="0" style="border-collapse: collapse; font-size: 17.4px;" width="500">
            <tr>
                <td style="margin: 0.1px; padding: 0px;">
                    <table cellpadding="0" style="border-collapse: collapse;">
                        <tr>
                                ...
                                <table cellpadding="0" style="border-collapse: collapse;">
                                    <tr>
                                        <td
                                            ...
                                            <span style="cursor: pointer;">Alex
                                                Johnson</span><!-- --><!-- -->
                                        </td>
                                    </tr>
                                    <tr>
                                        <td
                                            ...
                                            <span style="cursor: pointer;">Foodie
                                                Extraordinaire</span><!-- --><span
                            ...
                            <td style='border-left: 3px solid rgb(241, 225, 214); margin: 0.1px; padding: 0px 0px 0px 6px; font: 17.4px / 22.2px "Times New Roman", Times, serif; color: rgb(0, 0, 1);'
                                valign="middle">
                                <table cellpadding="0" style="border-collapse: collapse;">
                                    <tr>
        ...
        <div>
            ...
            <table cellpadding="0" style="border-collapse: collapse;" width="360">
                <tr>
                    <td
