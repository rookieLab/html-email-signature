    ...
    <div>
        ...
        <table cellpadding="0" width="400" style="border-collapse: collapse; font-size: 11.2px;">
            ...
            <tr style="cursor: pointer;">
                <td
                    style="margin: 0.1px; padding: 1px 0px; font: 11.2px / 14.2px &quot;Palatino Linotype&quot;, &quot;Book Antiqua&quot;, Palatino, serif; color: rgb(0, 0, 1);">
                    <!----><span style="color: rgb(0, 0, 1);">517 Robinson Lane, Athens</span>
                </td>
            </tr><!---->
            <tr>
                <td
                    ...
                    <table cellpadding="0" style="border-collapse: collapse;">
                        <tr>
                            <td
                                style="margin: 0.1px; padding: 0px 5px 0px 0px; font: 11.2px / 14.2px &quot;Palatino Linotype&quot;, &quot;Book Antiqua&quot;, Palatino, serif; color: rgb(0, 0, 1); cursor: pointer;">
                                <span
                                    style="border-radius: 15%; width: 22px; height: 22px; display: block; text-align: center; background-color: rgb(175, 161, 107); font-size: 12px; font-family: initial; line-height: 1;"><svg
