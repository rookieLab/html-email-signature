    ...
    <div><!---->
                    ...
                    <table cellpadding="0" style="border-collapse: collapse;">
                        <tr>
                            <td valign="top" style="margin: 0.1px; padding: 0px; cursor: pointer;"><img
                                    src="https://img.mysignature.io/p/b/e/9/be973224-2c3d-5c72-8965-c0c27ce1b19d.png?time=1685569257"
                                    ...
                                    <tr>
                                        <td
                                            ...
                                            <span style="cursor: pointer;"><span
                                                    style="color: rgb(0, 0, 1);">Lawfulle</span></span>&nbsp;<span
                                                style="cursor: pointer;"><span style="color: rgb(0, 0, 1);">Legal and
                                                    Democratic Services</span></span></td>
                                    </tr>
                                    <tr style="cursor: pointer;">
                                        <td
                                            ...
                                            <span
                                                ...
                                                style="color: rgb(0, 0, 1); text-decoration: none; font-family: Georgia, serif;">+2-535-656-12</span>
                                        </td>
                                    </tr>
                                    <tr style="cursor: pointer;">
                                        <td
                                            ...
                                            <table cellpadding="0" style="border-collapse: collapse;">
                                                <tr>
                                                    <td
                                                        ...
                                                        <span
                                                            style="border-radius: 15%; width: 21px; height: 21px; display: block; text-align: center; background-color: rgb(0, 0, 0); font-size: 12px; font-family: initial; line-height: 1;"><svg
        ...
        <div>
            <table width="357" cellpadding="0" style="border-collapse: collapse;">
                <tr>
                    <td
                        style="margin: 0.1px; padding: 15px 0px 0px; font: 12.1px / 15.3px Georgia, serif; color: rgb(186, 198, 217); cursor: pointer;">
