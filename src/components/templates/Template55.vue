<template>
    <div><!---->
        <table cellpadding="0" width="500" style="border-collapse: collapse; font-size: 14.9px;">
            <tr>
                <td style="margin: 0.1px; padding: 0px;">
                    <table cellpadding="0" style="border-collapse: collapse;">
                        <tr>
                            <td valign="top" style="margin: 0.1px; padding: 0px; cursor: pointer;"><img
                                    src="https://img.mysignature.io/p/2/8/7/287e6bc7-fe66-5123-98dc-b28470cd2110.png?time=1685569257"
                                    width="182" alt=" &quot;created with MySignature.io&quot;"
                                    style="display: block; min-width: 182px;"></td>
                            <td valign="top"
                                style="margin: 0.1px; padding: 0px 0px 0px 15px; font: 14.9px / 18.9px Verdana, Geneva, sans-serif; color: rgb(0, 0, 1);">
                                <table cellpadding="0" style="border-collapse: collapse;">
                                    <tr>
                                        <td
                                            style="margin: 0.1px; padding: 0px 0px 5px; font: 17.9px / 22.7px Verdana, Geneva, sans-serif; color: rgb(0, 0, 1);">
                                            <span
                                                style="font-weight: 600; color: rgb(144, 19, 254); cursor: pointer;">Arnas
                                                Deleon</span><!----><!---->&nbsp;<span
                                                style="font: 14.9px / 18.9px Verdana, Geneva, sans-serif; color: rgb(0, 0, 1); cursor: pointer;">Sales
                                                Manager</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td
                                            style="margin: 0.1px; padding: 0px 0px 5px; font: 14.9px / 18.9px Verdana, Geneva, sans-serif; color: rgb(0, 0, 1);">
                                            <span style="cursor: pointer;"><span
                                                    style="color: rgb(0, 0, 1);">Mysticorps</span></span><!----><!---->
                                        </td>
                                    </tr>
                                    <tr style="cursor: pointer;">
                                        <td
                                            style="margin: 0.1px; padding: 2px 0px; font: 14.9px / 18.9px Verdana, Geneva, sans-serif; color: rgb(0, 0, 1);">
                                            <span
                                                style="color: rgb(144, 19, 254); font-weight: 600;">mobile:&nbsp;</span><span
                                                style="color: rgb(0, 0, 1); text-decoration: none; font-family: Verdana, Geneva, sans-serif;">745-318-5933</span>
                                        </td>
                                    </tr>
                                    <tr style="cursor: pointer;">
                                        <td
                                            style="margin: 0.1px; padding: 2px 0px; font: 14.9px / 18.9px Verdana, Geneva, sans-serif; color: rgb(0, 0, 1);">
                                            <span
                                                style="color: rgb(144, 19, 254); font-weight: 600;">email:&nbsp;</span><span
                                                style="color: rgb(0, 0, 1); text-decoration: none; font-family: Verdana, Geneva, sans-serif;">arnas@mysignature.io</span>
                                        </td>
                                    </tr>
                                    <tr style="cursor: pointer;">
                                        <td
                                            style="margin: 0.1px; padding: 2px 0px; font: 14.9px / 18.9px Verdana, Geneva, sans-serif; color: rgb(0, 0, 1);">
                                            <span
                                                style="color: rgb(144, 19, 254); font-weight: 600;">website:&nbsp;</span><span
                                    ...
                                    <tr style="cursor: pointer;">
                                        <td
                                            style="margin: 0.1px; padding: 2px 0px; font: 14.9px / 18.9px Verdana, Geneva, sans-serif; color: rgb(0, 0, 1);">
                                            <span
                                                style="color: rgb(144, 19, 254); font-weight: 600;">skype:&nbsp;</span><span
                                                style="color: rgb(0, 0, 1); text-decoration: none; font-family: Verdana, Geneva, sans-serif;">arnasdeleon</span>
                                        </td>
                                    </tr><!---->
                                    <tr>
                                        <td
                                            style="margin: 0.1px; padding: 8px 0px 0px; font: 14.9px / 18.9px Verdana, Geneva, sans-serif; color: rgb(0, 0, 1);">
                                            <table cellpadding="0" style="border-collapse: collapse;">
                                                <tr>
                                                    <td
                                                        style="margin: 0.1px; padding: 0px 4px 0px 0px; font: 14.9px / 18.9px Verdana, Geneva, sans-serif; color: rgb(0, 0, 1); cursor: pointer;">
                                                        <span
                                                            style="border-radius: 0%; width: 22px; height: 22px; display: block; text-align: center; background-color: rgb(74, 74, 74); font-size: 12px; font-family: initial; line-height: 1;">
        ...
        <div>
            <table cellpadding="0" width="500"
                style="width: 500px; color: rgb(128, 128, 128); line-height: 1; font-size: 18.1px; border-collapse: collapse;">
                <tr style="cursor: pointer;">
                    <td width="45" height="45" align="center"
                        style="padding: 30px 0px 0px; margin: 0.1px; min-width: 45px;">
                        <svg viewBox="0 0 768 1024" xmlns="http://www.w3.org/2000/svg" style="width: 29.25px;">
                            <path
                    ...
                    <td
                        style="font-family: Verdana, Geneva, sans-serif; font-size: 18.1px; padding: 30px 0px 0px; margin: 0.1px;">
                        <span>Book a Meeting with me&nbsp;</span><span
                            style="text-decoration: none; font-size: 18.1px; color: rgb(144, 19, 254);">here</span>
                    </td>
                </tr>
            </table><!---->
