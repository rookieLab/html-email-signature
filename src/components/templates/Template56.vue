<template>
    <div><!---->
        <table cellpadding="0"
            ...
            <tr>
                <td
                    style="margin: 0.1px; padding: 20px; font: 13.4px / 17.1px &quot;Lucida Sans Unicode&quot;; color: rgb(0, 0, 1);">
                    <table cellpadding="0" style="border-collapse: collapse;">
                        <tr>
                            <td valign="top" style="margin: 0.1px; padding: 0px 15px 0px 0px; cursor: pointer;"><img
                                    src="https://img.mysignature.io/p/0/2/5/0256c04c-1505-5ee2-9335-e35f5570ba4f.png?time=1685569257"
                                    width="200" alt=" &quot;created with MySignature.io&quot;"
                                    style="display: block; min-width: 200px;"></td>
                            <td valign="top"
                                style="margin: 0.1px; padding: 0px; font: 13.4px / 17.1px &quot;Lucida Sans Unicode&quot;; color: rgb(0, 0, 1);">
                                <table cellpadding="0" style="border-collapse: collapse;">
                                    <tr>
                                        <td
                                    ...
                                    <tr style="cursor: pointer;">
                                        <td
                                            ...
                                            <span>phone:&nbsp;</span><span
                                                style="color: rgb(0, 0, 0); text-decoration: none; font-family: &quot;Lucida Sans Unicode&quot;;">+12027953213</span>&nbsp;|&nbsp;<span>email:&nbsp;</span><span
                                                style="color: rgb(0, 0, 0); text-decoration: none; font-family: &quot;Lucida Sans Unicode&quot;;">sales@mysignature.io</span>
                                        </td>
                                    </tr>
                                    <tr style="cursor: pointer;">
                                        <td
                                    ...
                                    <tr>
                                        <td
                                            ...
                                            <table cellpadding="0" style="border-collapse: collapse;">
                                                <tr>
                                                    <td
                                                        style="margin: 0.1px; padding: 0px 5px 0px 0px; font: 13.4px / 17.1px &quot;Lucida Sans Unicode&quot;; color: rgb(0, 0, 1); cursor: pointer;">
                                                        <span
                                                            style="border-radius: 15%; width: 23px; height: 23px; display: block; text-align: center; background-color: rgb(251, 212, 218); font-size: 12px; font-family: initial; line-height: 1;"><svg
        ...
        <div>
            <table cellpadding="0" style="border-collapse: collapse;">
                <tr>
                    <td style="padding: 9px 4px 4px 0px; margin: 0.1px;"><span><img
                                src="https://img.mysignature.io/addons/v2/amazon_shape2_black.png" height="44"
                                width="154" alt="amazon" style="display: block;"></span></td>
                    <td style="padding: 9px 4px 4px 0px; margin: 0.1px;"><span><img
                                src="https://img.mysignature.io/addons/v2/ebay_shape2_black.png" height="44" width="154"
                                alt="ebay" style="display: block;"></span></td>
                    <td style="padding: 9px 4px 4px 0px; margin: 0.1px;"><span><img
