        ...
        <table cellpadding="0" style="border-collapse: collapse;">
            <tr>
                <td style="margin: 0.1px; padding: 10px 0px; cursor: pointer;">
                    <img alt="Best wishes,"
                        src="https://img.mysignature.io/a/v1/9/5/8/958230ed-64c0-5b1e-b55c-70c432af831c.png"
                        width="500" />
                </td>
            </tr>
        </table>
        <table cellpadding="0"
            style="border-collapse: collapse; font-size: 13.6px; background-color: rgb(190, 194, 205);">
            <tr>
                <td style="margin: 0.1px; padding: 20px; font: 13.6px / 17.3px Georgia, serif; color: rgb(0, 0, 1);">
                    <table cellpadding="0" style="border-collapse: collapse;">
                        <tr>
                            <td style="margin: 0.1px; padding: 0px 15px 0px 0px; cursor: pointer;" valign="top">
                                <img alt="SignMaker"
                                    src="https://img.mysignature.io/p/e/d/9/ed9e8805-c605-5624-aa2a-a8f893790645.png?time=1685569257"
                                    style="display: block; min-width: 182px;" width="182" />
                            </td>
                            <td style="margin: 0.1px; padding: 0px; font: 13.6px / 17.3px Georgia, serif; color: rgb(0, 0, 1);"
                                valign="top">
                                <table cellpadding="0" style="border-collapse: collapse;">
                                    <tr>
                                        <td
                                            style="margin: 0.1px; padding: 0px 0px 5px; font: 17.7px / 22.5px Georgia, serif; color: rgb(255, 255, 255); cursor: pointer;">
                                            <span style="font-weight: 600; cursor: pointer;">Norman
                                                Richardson</span><!-- --><!-- -->
                                        </td>
                                    </tr>
                                    <tr>
                                        <td
                                            ...
                                            <span style="cursor: pointer;">Owner</span> | <span
                                                style="cursor: pointer;">Retter</span><!-- --><!-- -->
                                        </td>
                                    </tr>
                                    <tr style="cursor: pointer;">
                                        <td
                                            style="margin: 0.1px; padding: 5px 0px 0px; font: 13.6px / 17.3px Georgia, serif; color: rgb(255, 255, 255);">
                                            <span>mobile: </span><span
                                                style="color: rgb(255, 255, 255); text-decoration: none; font-family: Georgia, serif;">+1
                                                757 3145
                                                2220</span> | <span>email: </span><span
                                                style="color: rgb(255, 255, 255); text-decoration: none; font-family: Georgia, serif;">norman@mysignature.io</span>
                                        </td>
                                    </tr><!-- -->
                                    <tr>
                                        <td
                                            ...
                                            <table cellpadding="0" style="border-collapse: collapse;">
                                                <tr>
                                                    <td
                                                        style="margin: 0.1px; padding: 0px 5px 0px 0px; font: 13.6px / 17.3px Georgia, serif; color: rgb(0, 0, 1); cursor: pointer;">
                                                        <span
                                                            style="border-radius: 50%; width: 30px; height: 30px; display: block; text-align: center; background-color: rgb(67, 54, 102); font-size: 12px; font-family: initial; line-height: 1;"><svg
