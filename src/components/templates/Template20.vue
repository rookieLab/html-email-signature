        ...
        <table cellpadding="0" style="border-collapse: collapse; font-size: 13.1px;">
            ...
            <tr>
                <td align="center"
                    ...
                    <span style="cursor: pointer;">FOOD CRITIC &amp;
                        RESTAURANT
                        REVIEWER</span><!-- --><!-- -->
                </td>
            </tr>
                    ...
                    <table align="center" cellpadding="0" style="border-collapse: collapse;">
                        <tr>
                            <td style="margin: 0.1px; padding: 0px 2.5px; cursor: pointer;">
                                <span
                                    style="border-radius: 0%; width: 30px; height: 30px; display: block; text-align: center; background-color: rgb(255, 255, 255); font-size: 12px; font-family: initial; line-height: 1;"><svg
                                        style="position: relative; top: 6px; width: 18px;" viewbox="0 0 1024 1024"
                            ...
                            <td style="margin: 0.1px; padding: 0px 2.5px; cursor: pointer;">
                                <span
                                    style="border-radius: 0%; width: 30px; height: 30px; display: block; text-align: center; background-color: rgb(255, 255, 255); font-size: 12px; font-family: initial; line-height: 1;"><svg
                                        style="position: relative; top: 6px; width: 18px;" viewbox="0 0 1053 1024"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
