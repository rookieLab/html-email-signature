    ...
    <div>
        <table cellpadding="0" style="border-collapse: collapse;">
            <tr>
                <td style="margin: 0.1px; padding: 10px 0px; cursor: pointer;"><img width="500"
                        src="https://img.mysignature.io/a/v1/6/0/3/603814ad-3d1f-5c0d-8c48-afbf9b4a74cd.png"
                        alt="Best regards,"></td>
            </tr>
        </table>
                    ...
                    <table cellpadding="0" style="border-collapse: collapse;">
                        <tr>
                            <td valign="top" style="margin: 0.1px; padding: 0px 9px 0px 0px; cursor: pointer;"><img
                                    src="https://img.mysignature.io/p/5/5/7/55765d30-5abe-5cd9-96d9-eac81484d237.png?time=1724157307"
                                    width="171" alt=" &quot;created with MySignature.io&quot;"
                                    style="display: block; min-width: 171px;"></td>
                            <td valign="top"
                                style="border-left: 2px solid rgb(106, 52, 27); margin: 0.1px; padding: 0px 0px 0px 9px;">
                                <table cellpadding="0" style="border-collapse: collapse;">
                                    <tr>
                                        <td
                                            style="margin: 0.1px; padding: 0px; font: 17.9px / 22.7px &quot;Palatino Linotype&quot;, &quot;Book Antiqua&quot;, Palatino, serif; color: rgb(0, 0, 1);">
                                            <span
                                                style="font: 17.9px / 22.7px &quot;Palatino Linotype&quot;, &quot;Book Antiqua&quot;, Palatino, serif; color: rgb(106, 52, 27); cursor: pointer;">Paolo
                                                Brooks</span><!----><!---->&nbsp;&nbsp;<span
                                                style="font: 14.9px / 18.9px &quot;Palatino Linotype&quot;, &quot;Book Antiqua&quot;, Palatino, serif; color: rgb(56, 55, 48); cursor: pointer;">Senior
                                                Attorney </span></td>
                                    </tr><!---->
                                    <tr style="cursor: pointer;">
                                        <td
                                            style="margin: 0.1px; padding: 0px; font: 14.9px / 18.9px &quot;Palatino Linotype&quot;, &quot;Book Antiqua&quot;, Palatino, serif; color: rgb(0, 0, 1);">
                                            <!----><span
                                                style="color: rgb(56, 55, 48); text-decoration: none; font-family: &quot;Palatino Linotype&quot;, &quot;Book Antiqua&quot;, Palatino, serif;">+1
                                    ...
                                    <tr style="cursor: pointer;">
                                        <td
                                            style="margin: 0.1px; padding: 0px; font: 14.9px / 18.9px &quot;Palatino Linotype&quot;, &quot;Book Antiqua&quot;, Palatino, serif; color: rgb(0, 0, 1);">
                                            <!----><span
                                                style="color: rgb(56, 55, 48); text-decoration: none; font-family: &quot;Palatino Linotype&quot;, &quot;Book Antiqua&quot;, Palatino, serif;"></span>
                                        </td>
                                    </tr>
                                    <tr style="cursor: pointer;">
                                        <td
                                            style="margin: 0.1px; padding: 0px; font: 14.9px / 18.9px &quot;Palatino Linotype&quot;, &quot;Book Antiqua&quot;, Palatino, serif; color: rgb(0, 0, 1);">
                                            <!----><span
                                                style="color: rgb(56, 55, 48); text-decoration: none; font-family: &quot;Palatino Linotype&quot;, &quot;Book Antiqua&quot;, Palatino, serif;">mysignature.io</span>
                                        </td>
                                    </tr>
                                    <tr style="cursor: pointer;">
                                        <td
                                            style="margin: 0.1px; padding: 0px; font: 14.9px / 18.9px &quot;Palatino Linotype&quot;, &quot;Book Antiqua&quot;, Palatino, serif; color: rgb(0, 0, 1);">
                                            <!----><span
                                                style="color: rgb(56, 55, 48); text-decoration: none; font-family: &quot;Palatino Linotype&quot;, &quot;Book Antiqua&quot;, Palatino, serif;">paolo@mysignature.io</span>
                                        </td>
                                    </tr><!---->
                                    <tr>
                                        <td
                                            style="margin: 0.1px; padding: 8px 0px 0px; font: 14.9px / 18.9px &quot;Palatino Linotype&quot;, &quot;Book Antiqua&quot;, Palatino, serif; color: rgb(0, 0, 1);">
                                            <table cellpadding="0" style="border-collapse: collapse;">
                                                <tr>
                                                    <td
                                                        style="margin: 0.1px; padding: 0px 4px 0px 0px; font: 14.9px / 18.9px &quot;Palatino Linotype&quot;, &quot;Book Antiqua&quot;, Palatino, serif; color: rgb(0, 0, 1); cursor: pointer;">
                                                        <span
                                                            style="border-radius: 0%; width: 24px; height: 24px; display: block; text-align: center; background-color: rgb(106, 52, 27); font-size: 12px; font-family: initial; line-height: 1;"><svg
        ...
        <div>
            <table width="500" cellpadding="0" style="border-collapse: collapse;">
                <tr>
                    <td style="padding: 17px 10px 0px 0px; margin: 0.1px; cursor: pointer;"><span><img
                                alt="Attend the Speech"
                                src="https://img.mysignature.io/a/v1/8/f/6/8f63c736-d0ed-5fe4-9234-b5f1fecf074f.png"
                                style="max-width: 490px; display: block;" width="177"></span></td>
                </tr>
            </table>
            <table width="428" cellpadding="0" style="border-collapse: collapse;">
                <tr>
                    <td
                        style="margin: 0.1px; padding: 15px 0px 0px; font: 12.1px / 15.3px &quot;Palatino Linotype&quot;, &quot;Book Antiqua&quot;, Palatino, serif; color: rgb(193, 145, 90); cursor: pointer;">
