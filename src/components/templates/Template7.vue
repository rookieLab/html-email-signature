<template>
    <div>
            ...
            <tr>
                <td style="margin: 0.1px; padding: 10px 0px; cursor: pointer;">
                    <img alt="Best regards,"
                        src="/assets/af14d5b1-de92-554a-b267-3120d43451f7.png"
                        width="500" />
                </td>
            </tr>
        </table>
        <table cellpadding="0"
            style="border-collapse: collapse; font-size: 11.1px; background-color: rgb(255, 192, 104);">
            <tr>
                <td
                    ...
                    <table cellpadding="0" style="border-collapse: collapse;">
                        <tr>
                            <td style="margin: 0.1px; padding: 0px 15px 0px 0px; cursor: pointer;" valign="top">
                                <img alt="SignMaker"
                                    src="/assets/f01ae626-b336-56d7-9604-bcd3adf615ff.png"
                                    style="display: block; min-width: 106px;" width="106" />
                            </td>
                            <td style="margin: 0.1px; padding: 0px; font: 11.1px / 14.1px Verdana, Geneva, sans-serif; color: rgb(0, 0, 1);"
                                valign="top">
                                <table cellpadding="0" style="border-collapse: collapse;">
                                    <tr>
                                        <td
                                            style="margin: 0.1px; padding: 0px 0px 5px; font: 14.4px / 18.3px Verdana, Geneva, sans-serif; color: rgb(0, 0, 1); cursor: pointer;">
                                            <span style="font-weight: 600; cursor: pointer;">Dr.
                                                Terrence Baker •
                                                Pediatrician</span><!-- --><!-- -->
                                        </td>
                                    </tr>
                                    <tr>
                                        <td
                                            ...
                                            <!-- --><!-- --><span style="cursor: pointer;">Mount
                                                Sinai
                                                Hospital</span><!-- --><!-- -->
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td
                                            ...
                                            <table cellpadding="0" style="border-collapse: collapse;">
                                                <tr>
                                                    <td
                                                        style="margin: 0.1px; padding: 0px 5px 0px 0px; font: 11.1px / 14.1px Verdana, Geneva, sans-serif; color: rgb(0, 0, 1); cursor: pointer;">
                                                        <span
        ...
        <div>
            <table cellpadding="0" style="border-collapse: collapse;" width="436">
                <tr>
                    <td
