                                ...
                                <table cellpadding="0" style="border-collapse: collapse;">
                                    <tr>
                                        <td style="margin: 0.1px; padding: 4px 15px 0px 0px; cursor: pointer;">
                                            <span
                                                style="border-radius: 0%; width: 25px; height: 25px; display: block; text-align: center; background-color: rgb(0, 0, 1); font-size: 12px; font-family: initial; line-height: 1;"><svg
