...
<img alt="SignMaker" src="https://img.mysignature.io/p/1/7/e/17ec08b4-0d22-5e05-bb2d-14328f430c7b.png?time=1692360877" style="display: block; min-width: 132px;" width="132"/>
</td>
<td style="border-left: 1px solid rgb(224, 157, 195); margin: 0.1px; padding: 0px 0px 0px 12px; font: 13.4px / 17.1px Georgia, serif; color: rgb(0, 0, 1);" valign="top">
<table cellpadding="0" style="border-collapse: collapse;">
<tr>
<td style="margin: 0.1px; padding: 0px 0px 8px; font: 17.5px / 22.2px Georgia, serif; color: rgb(0, 0, 1);">
<span style="font-weight: 600; color: rgb(224, 157, 195); cursor: pointer;">Charlotte
                                                                                    Patterson</span><!-- --><!-- -->
</td>
</tr>
<tr>
<td style="margin: 0.1px; padding: 0px 0px 8px; font: 13.4px / 17.1px Georgia, serif; color: rgb(62, 62, 62);">
<span style="color: rgb(62, 62, 62); cursor: pointer;">Nurse
                                                                                    •</span> <span style="color: rgb(62, 62, 62); cursor: pointer;">UCLA
                                                                                    Medical
                                                                                    Center</span><!-- --><!-- -->
</td>
</tr>
<tr style="cursor: pointer;">
<td style="margin: 0.1px; padding: 0px; font: 13.4px / 17.1px Georgia, serif; color: rgb(0, 0, 1);">
<span style="color: rgb(224, 157, 195); font-weight: 600;">E: </span><span style="color: rgb(62, 62, 62); text-decoration: none; font-family: Georgia, serif;">charlotte@mysignature.io</span>
</td>
</tr>
<tr style="cursor: pointer;">
<td style="margin: 0.1px; padding: 0px; font: 13.4px / 17.1px Georgia, serif; color: rgb(0, 0, 1);">
<span style="color: rgb(224, 157, 195); font-weight: 600;">P: </span><span style="color: rgb(62, 62, 62); text-decoration: none; font-family: Georgia, serif;">733
                                                                                    663 33</span>
</td>
</tr>
<tr style="cursor: pointer;">
<td style="margin: 0.1px; padding: 0px; font: 13.4px / 17.1px Georgia, serif; color: rgb(0, 0, 1);">
<span style="color: rgb(224, 157, 195); font-weight: 600;">W: </span><span style="color: rgb(62, 62, 62); text-decoration: none; font-family: Georgia, serif;">mysignature.io</span>
</td>
</tr>
<tr style="cursor: pointer;">
<td style="margin: 0.1px; padding: 0px; font: 13.4px / 17.1px Georgia, serif; color: rgb(0, 0, 1);">
<span style="color: rgb(224, 157, 195); font-weight: 600;">A: </span><span style="color: rgb(62, 62, 62);">Los
                                                                                    Angeles, California,
                                                                                    USA</span>
</td>
</tr>
<tr>
<td style="margin: 0.1px; padding: 12px 0px 3px; font: 13.4px / 17.1px Georgia, serif; color: rgb(62, 62, 62);">
                                                                                Follow us:</td>
</tr>
<tr>
<td style="margin: 0.1px; padding: 0px; font: 13.4px / 17.1px Georgia, serif; color: rgb(0, 0, 1);">
...
<span><img alt="         Book an online consultation          " src="https://img.mysignature.io/a/v1/e/1/9/e190c88e-99ba-5a38-b2fe-2c4a54ea1992.png" style="max-width: 490px; display: block;" width="346"/></span>
</td>
</tr>
</table><!-- -->
