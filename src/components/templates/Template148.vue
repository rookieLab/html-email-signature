                    ...
                    <table cellpadding="0" style="border-collapse: collapse;">
                        <tr>
                            <td valign="top" style="margin: 0.1px; padding: 0px 12px 0px 0px; cursor: pointer;"><img
                                    src="https://img.mysignature.io/p/1/7/e/17ec08b4-0d22-5e05-bb2d-14328f430c7b.png?time=1692360877"
                                    width="132" alt=" &quot;created with MySignature.io&quot;"
                                    style="display: block; min-width: 132px;"></td>
                            <td valign="top"
                                style="border-left: 1px solid rgb(224, 157, 195); margin: 0.1px; padding: 0px 0px 0px 12px; font: 13.4px / 17.1px Georgia, serif; color: rgb(0, 0, 1);">
                                <table cellpadding="0" style="border-collapse: collapse;">
                                    <tr>
                                        <td
                                    ...
                                    <tr>
                                        <td
                                            style="margin: 0.1px; padding: 0px 0px 8px; font: 13.4px / 17.1px Georgia, serif; color: rgb(62, 62, 62);">
                                    ...
                                    <tr style="cursor: pointer;">
                                        <td
                                            style="margin: 0.1px; padding: 0px; font: 13.4px / 17.1px Georgia, serif; color: rgb(0, 0, 1);">
                                            <span
                                                style="color: rgb(224, 157, 195); font-weight: 600;">E:&nbsp;</span><span
                                                style="color: rgb(62, 62, 62); text-decoration: none; font-family: Georgia, serif;">charlotte@mysignature.io</span>
                                        </td>
                                    </tr>
                                    <tr style="cursor: pointer;">
                                        <td
                                            style="margin: 0.1px; padding: 0px; font: 13.4px / 17.1px Georgia, serif; color: rgb(0, 0, 1);">
                                            <span
                                                style="color: rgb(224, 157, 195); font-weight: 600;">P:&nbsp;</span><span
                                                style="color: rgb(62, 62, 62); text-decoration: none; font-family: Georgia, serif;">733
                                                663 33</span></td>
                                    </tr>
                                    <tr style="cursor: pointer;">
                                        <td
                                            style="margin: 0.1px; padding: 0px; font: 13.4px / 17.1px Georgia, serif; color: rgb(0, 0, 1);">
                                            <span
                                                style="color: rgb(224, 157, 195); font-weight: 600;">W:&nbsp;</span><span
                                                style="color: rgb(62, 62, 62); text-decoration: none; font-family: Georgia, serif;">mysignature.io</span>
                                        </td>
                                    </tr>
                                    <tr style="cursor: pointer;">
                                        <td
                                            style="margin: 0.1px; padding: 0px; font: 13.4px / 17.1px Georgia, serif; color: rgb(0, 0, 1);">
                                            <span
                                                style="color: rgb(224, 157, 195); font-weight: 600;">A:&nbsp;</span><span
                                                style="color: rgb(62, 62, 62);">Los Angeles, California, USA</span></td>
                                    </tr>
                                    <tr>
                                        <td
                                            style="margin: 0.1px; padding: 12px 0px 3px; font: 13.4px / 17.1px Georgia, serif; color: rgb(62, 62, 62);">
                                            Follow us:</td>
                                    </tr>
                                    <tr>
                                        <td
                                            ...
                                            <table cellpadding="0" style="border-collapse: collapse;">
                                                <tr>
                                                    <td
                                                        style="margin: 0.1px; padding: 0px 5px 0px 0px; font: 13.4px / 17.1px Georgia, serif; color: rgb(0, 0, 1); cursor: pointer;">
                                                        <span
