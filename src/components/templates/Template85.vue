            ...
            <tr>
                <td style="margin: 0.1px; padding: 0px;">
                    <table cellpadding="0" style="border-collapse: collapse;">
                        <tr>
                            <td valign="middle"
                                style="margin: 0.1px; padding: 0px 20px 0px 0px; border-right: 2px solid rgb(109, 211, 148);">
                                <table cellpadding="0" style="border-collapse: collapse;">
                                    <tr>
                                        <td align="center"
                                            style="margin: 0.1px; padding: 0px 0px 10px; cursor: pointer;"><img
                                                src="https://img.mysignature.io/p/8/b/1/8b158dcc-eb77-557e-8a22-90b75521feaf.png?time=1688718520"
                                                width="120" alt=" &quot;created with MySignature.io&quot;"
                                                style="display: block; min-width: 120px; margin: 0px auto;"></td>
                                    </tr>
                                    <tr>
                                        <td align="center"
                                    ...
                                    <tr>
                                        <td align="center"
                                            style="margin: 0.1px; padding: 5px 0px 0px; font: 200 12.5px / 15.9px Verdana, Geneva, sans-serif; color: rgb(0, 0, 1);">
                                            <span style="cursor: pointer;">Blogger |</span>&nbsp;<span
                                                style="cursor: pointer;">Plant-Based Food Advocate</span></td>
                                    </tr>
                                </table>
                            </td>
                                                ...
                                                <tr>
                                                    <td
                                                        ...
                                                        <table cellpadding="0" style="border-collapse: collapse;">
                                                            <tr>
                                                                <td
                                                                    style="margin: 0.1px; padding: 0px 4px 0px 0px; font: 12.5px / 15.9px Verdana, Geneva, sans-serif; color: rgb(0, 0, 1); cursor: pointer;">
                                                                    <span
                                                                        style="border-radius: 15%; width: 20px; height: 20px; display: block; text-align: center; background-color: rgb(242, 184, 239); font-size: 12px; font-family: initial; line-height: 1;"><svg
            ...
            <table width="500" cellpadding="0" style="border-collapse: collapse;">
                <tr>
                    <td style="padding: 20px 10px 0px 0px; margin: 0.1px; cursor: pointer;"><img
                            alt="Get my free recipe e-book"
                            src="https://img.mysignature.io/a/v1/6/5/e/65e14274-ffdd-5694-a07d-f3f6ac394f5b.png"
                            style="max-width: 490px; display: block;" width="239"></td>
                </tr>
            </table>
            <table width="500" cellpadding="0" style="border-collapse: collapse;">
                <tr style="cursor: pointer;">
