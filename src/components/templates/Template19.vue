<template>
    <div>
        ...
        <table cellpadding="0"
            style="border-collapse: collapse; font-size: 15.7px; background-color: rgb(5, 132, 239);">
            <tr>
                <td
                    style="margin: 0.1px; padding: 20px 20px 0px; font: 15.7px / 19.9px Verdana, Geneva, sans-serif; color: rgb(0, 0, 1);">
                    <table cellpadding="0" style="border-collapse: collapse;">
                        <tr>
                            <td style="margin: 0.1px; padding: 0px; font: 15.7px / 19.9px Verdana, Geneva, sans-serif; color: rgb(0, 0, 1);"
                                valign="top">
                                <table cellpadding="0" style="border-collapse: collapse;">
                                    <tr>
                                        <td
                                            style="margin: 0.1px; padding: 0px 0px 5px; font: 20.4px / 25.9px Verdana, Geneva, sans-serif; color: rgb(241, 241, 241); cursor: pointer;">
                                    ...
                                    <tr style="cursor: pointer;">
                                        <td
                                            style="margin: 0.1px; padding: 5px 0px 0px; font: 15.7px / 19.9px Verdana, Geneva, sans-serif; color: rgb(241, 241, 241);">
                                            <span
                                                style="color: rgb(241, 241, 241); text-decoration: none; font-family: Verdana, Geneva, sans-serif;">+1
                                                (555)
                                                724-9632</span> | <span
                                                style="color: rgb(241, 241, 241); text-decoration: none; font-family: Verdana, Geneva, sans-serif;">cooper@mysignature.io</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td
                                            ...
                                            <table cellpadding="0" style="border-collapse: collapse;">
                                                ...
                                                <tr>
                                                    <td
                                                        ...
                                                        <span
                                                            style="border-radius: 0%; width: 22px; height: 22px; display: block; text-align: center; background-color: rgb(0, 30, 100); font-size: 12px; font-family: initial; line-height: 1;"><svg
            ...
            <Banner :data="editing?.Image" type="tr" :styles="{ padding: '15px 20px 20px' }" />
        </table>
        <div>
            <table cellpadding="0" style="border-collapse: collapse;">
                <tr>
