<template>
    <div><!---->
        <table cellpadding="0" width="500" style="border-collapse: collapse; font-size: 13.6px;">
                                    ...
                                    <tr>
                                        <td
                                            ...
                                            <table cellpadding="0" style="border-collapse: collapse;">
                                                <tr>
                                                    <td
                                                        style="margin: 0.1px; padding: 0px 4px 0px 0px; font: 13.6px / 17.3px &quot;Trebuchet MS&quot;, Helvetica, sans-serif; color: rgb(0, 0, 1); cursor: pointer;">
                                                        <span
                                                            style="border-radius: 50%; width: 24px; height: 24px; display: block; text-align: center; background-color: rgb(253, 92, 99); font-size: 12px; font-family: initial; line-height: 1;"><svg
                                                    ...
                                                    <td
                                                        style="margin: 0.1px; padding: 0px 4px 0px 0px; font: 13.6px / 17.3px &quot;Trebuchet MS&quot;, Helvetica, sans-serif; color: rgb(0, 0, 1); cursor: pointer;">
                                                        <span
                                                            style="border-radius: 50%; width: 24px; height: 24px; display: block; text-align: center; background-color: rgb(37, 211, 102); font-size: 12px; font-family: initial; line-height: 1;"><svg
                                                                viewBox="0 0 1024 1024"
                                                                xmlns="http://www.w3.org/2000/svg"
                                                                style="position: relative; top: 4.8px; width: 14.4px;">
                                                                <path
                                                    ...
                                                    <td
                                                        style="margin: 0.1px; padding: 0px 4px 0px 0px; font: 13.6px / 17.3px &quot;Trebuchet MS&quot;, Helvetica, sans-serif; color: rgb(0, 0, 1); cursor: pointer;">
                                                        <span
                                                            style="border-radius: 50%; width: 24px; height: 24px; display: block; text-align: center; background-color: rgb(255, 0, 105); font-size: 12px; font-family: initial; line-height: 1;"><svg
                                                                viewBox="0 0 1024 1024"
                                                                xmlns="http://www.w3.org/2000/svg"
                                                                style="position: relative; top: 4.8px; width: 14.4px;">
                                                                <path
            ...
            <tr>
                <td
                    style="margin: 0.1px; padding: 15px 0px 0px; font: 13.6px / 17.3px &quot;Trebuchet MS&quot;, Helvetica, sans-serif; color: rgb(0, 0, 1); cursor: pointer;">
                    <span><img
                            src="https://img.mysignature.io/b/2/3/0/230b3885-145e-557d-8c71-f3cb65ae984e.png?time=1685569257"
                            valign="top" width="409" alt="created with MySignature.io" style="display: block;"></span>
                </td>
            </tr>
        </table>
        <div>
            <table width="500" cellpadding="0" style="border-collapse: collapse;">
                <tr>
                    <td style="padding: 10px 10px 0px 0px; margin: 0.1px; cursor: pointer;"><span><img
                                alt="Check dates to stay in the best place to in New York >>>"
