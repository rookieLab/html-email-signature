...
export default {
    ...
    methods: {
        ...
        loadTemplateFromStore() {
            const data = this.store.loadTemplateByName('Template1');
            if (data) {
                this.general = data;
            }
        },
        setEditingStore() {
            this.editing.setGeneral(this.general);
        },
        loadSocialIcons() {
    ...
    mounted() {
        ...
        this.loadTemplateFromStore();
        this.setEditingStore();
