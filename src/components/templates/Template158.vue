    ...
    <div>
        <table cellpadding="0" style="border-collapse: collapse;">
            <tr>
                <td style="margin: 0.1px; padding: 10px 0px; cursor: pointer;"><img width="500"
                        src="https://img.mysignature.io/a/v1/1/4/3/143c291a-6702-53b1-b595-bb5f45010690.png"
                        alt="Best wishes,"></td>
            </tr>
        </table>
        <table cellpadding="0" style="border-collapse: collapse; font-size: 12.8px;">
            <tr>
                <td align="center" style="margin: 0.1px; padding: 0px 0px 13px; cursor: pointer;"><img
                        src="https://img.mysignature.io/p/7/b/1/7b1ad43a-1189-529f-83f7-53e245ae764b.png?time=1709216197"
            ...
            <tr>
                <td align="center"
                    style="margin: 0.1px; padding: 0px 0px 5px; font: 600 12.8px / 16.3px &quot;Times New Roman&quot;, Times, serif; color: rgb(75, 73, 79);">
                    <span style="cursor: pointer;">REAL ESTATE ADVISOR</span>&nbsp;<span
                        style="cursor: pointer;">CITYSCAPE HOMES</span></td>
            </tr>
            <tr style="cursor: pointer;">
                <td align="center"
                    style="margin: 0.1px; padding: 5px 20px; font: 12.8px / 16.3px &quot;Times New Roman&quot;, Times, serif; color: rgb(75, 73, 79); border-bottom: 1px solid rgb(235, 228, 228);">
                    <span>E:&nbsp;</span><span
                        style="color: rgb(75, 73, 79); text-decoration: none; font-family: &quot;Times New Roman&quot;, Times, serif;">sarahthompson@mysignature.io</span>&nbsp;&nbsp;<span>P:&nbsp;</span><span
                        style="color: rgb(75, 73, 79); text-decoration: none; font-family: &quot;Times New Roman&quot;, Times, serif;">8463
                        366 337</span></td>
            </tr>
            <tr style="cursor: pointer;">
                <td align="center"
                    style="margin: 0.1px; padding: 5px 20px; font: 12.8px / 16.3px &quot;Times New Roman&quot;, Times, serif; color: rgb(75, 73, 79); border-bottom: 1px solid rgb(235, 228, 228);">
                    <span>A:&nbsp;</span><span style="color: rgb(75, 73, 79);">984 E 9th St, Stuart, FL
                        36780</span>&nbsp;&nbsp;<span>W:&nbsp;</span><span
                        style="color: rgb(75, 73, 79); text-decoration: none; font-family: &quot;Times New Roman&quot;, Times, serif;">mysignature.io</span>
                </td>
            </tr>
            <tr>
                <td align="center"
                    ...
                    <table cellpadding="0" align="center" style="border-collapse: collapse;">
                        <tr>
                            <td style="margin: 0.1px; padding: 0px 2.5px; cursor: pointer;"><span
                                    style="border-radius: 50%; width: 29px; height: 29px; display: block; text-align: center; background-color: rgb(255, 245, 103); font-size: 12px; font-family: initial; line-height: 1;"><svg
        ...
        <div>
            <table width="500" cellpadding="0" style="border-collapse: collapse;">
                <tr>
                    <td style="padding: 15px 10px 0px 0px; margin: 0.1px; cursor: pointer;"><img
                            alt="Find your perfect urban oasis! Click here"
