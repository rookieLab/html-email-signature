    ...
    <div><!-- -->
                        ...
                        <tr>
                            <td style="margin: 0.1px; padding: 0px 15px 0px 0px; cursor: pointer;" valign="top">
                                <img alt="SignMaker"
                                    ...
                                    style="display: block; min-width: 171px;" width="171" />
                            </td>
                            <td style='margin: 0.1px; padding: 0px; font: 13.4px / 17.1px "Courier New", Courier, monospace; color: rgb(0, 0, 1);'
                                valign="top">
                                <table cellpadding="0" style="border-collapse: collapse;">
                                    <tr>
                                        <td
        ...
        <div>
            <table cellpadding="0"
                ...
                width="500">
                <tr style="cursor: pointer;">
                    <td align="center" height="37" style="padding: 10px 0px 0px; margin: 0.1px; min-width: 37px;"
                        width="37">
                        <svg style="width: 24.05px;" viewbox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg">
                            <path
                    ...
                    <td
                        ...
                        <span>LIVE SHOW: How to be happy </span><span
                            style="text-decoration: none; font-size: 15.1px; color: rgb(0, 0, 0);">August
                            26th, 6 p.m.</span>
                    </td>
                </tr>
            </table>
            <table cellpadding="0" style="border-collapse: collapse;" width="500">
                <tr>
                    <td style="padding: 8px 10px 0px 0px; margin: 0.1px; cursor: pointer;">
                        <span><img alt="Best Selling Book: Happines Guide"
                                src="https://img.mysignature.io/a/v1/e/3/f/e3fe5267-60ee-516b-b192-332e421d0f66.png"
                                style="max-width: 490px; display: block;" width="348" /></span>
                    </td>
                </tr>
            </table><!-- -->
