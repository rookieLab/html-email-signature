<template>
    <div>
        <table cellpadding="0"
            ...
            <tr>
                <td
                    style="margin: 0.1px; padding: 20px; font: 13.4px / 17.1px &quot;Courier New&quot;, Courier, monospace; color: rgb(0, 0, 1);">
                    <table cellpadding="0" style="border-collapse: collapse;">
                        <tr>
                            <td valign="top" style="margin: 0.1px; padding: 0px 15px 0px 0px; cursor: pointer;"><img
                                    src="https://img.mysignature.io/p/e/d/d/eddd7e23-a5a3-5a9d-9170-71f7361e8cb3.png?time=1685569257"
                                    width="171" alt=" &quot;created with MySignature.io&quot;"
                                    style="display: block; min-width: 171px;"></td>
                            <td valign="top"
                                style="margin: 0.1px; padding: 0px; font: 13.4px / 17.1px &quot;Courier New&quot;, Courier, monospace; color: rgb(0, 0, 1);">
                                <table cellpadding="0" style="border-collapse: collapse;">
                                    <tr>
                                        <td
                                    ...
                                    <tr>
                                        <td
                                            ...
                                            <table cellpadding="0" style="border-collapse: collapse;">
                                                <tr>
                                                    <td
                                                        style="margin: 0.1px; padding: 0px 5px 0px 0px; font: 13.4px / 17.1px &quot;Courier New&quot;, Courier, monospace; color: rgb(0, 0, 1); cursor: pointer;">
                                                        <span
                                                            style="border-radius: 15%; width: 25px; height: 25px; display: block; text-align: center; background-color: rgb(254, 207, 54); font-size: 12px; font-family: initial; line-height: 1;"><svg
            ...
            <table cellpadding="0" width="500"
                ...
                <tr style="cursor: pointer;">
                    <td width="37" height="37" align="center"
                        style="padding: 10px 0px 0px; margin: 0.1px; min-width: 37px;"><svg viewBox="0 0 1024 1024"
                            xmlns="http://www.w3.org/2000/svg" style="width: 24.05px;">
                            <path
                    ...
                    <td
                        style="font-family: &quot;Courier New&quot;, Courier, monospace; font-size: 15.1px; padding: 10px 0px 0px; margin: 0.1px;">
                        <span>LIVE SHOW: How to be happy&nbsp;</span><span
                            style="text-decoration: none; font-size: 15.1px; color: rgb(0, 0, 0);">August 26th, 6
                            p.m.</span></td>
                </tr>
            </table>
            <table width="500" cellpadding="0" style="border-collapse: collapse;">
                <tr>
                    <td style="padding: 8px 10px 0px 0px; margin: 0.1px; cursor: pointer;"><span><img
                                alt="Best Selling Book: Happines Guide"
