...
<img alt="SignMaker" src="https://img.mysignature.io/p/c/d/2/cd2f7a98-ee7e-5e35-8076-ab6e3c3f87f0.png?time=1685569257" style="display: block; min-width: 188px;" width="188"/>
</td>
</tr>
<tr>
<td align="center" style="margin: 0.1px; padding: 0px 0px 5px; font: 14.6px / 18.5px Tahoma, Geneva, sans-serif; color: rgb(0, 0, 1);">
<span style="font-weight: 600; color: rgb(255, 21, 167); cursor: pointer;">KATE
                                                        WINSORT </span><!-- --><!-- -->
</td>
</tr>
<tr>
...
<span style="cursor: pointer;">FOUNDER
                                                        AT</span> <span style="cursor: pointer;">XOXO
                                                        COSMETICS</span>
</td>
</tr>
<tr style="cursor: pointer;">
<td align="center" style="margin: 0.1px; padding: 5px 20px; font: 11.2px / 14.2px Tahoma, Geneva, sans-serif; color: rgb(255, 21, 167); border-bottom: 1px solid rgb(235, 228, 228);">
<span>phone: </span><span style="color: rgb(0, 0, 1); text-decoration: none; font-family: Tahoma, Geneva, sans-serif;">8463
                                                        366
                                                        33</span>  <span>email: </span><span style="color: rgb(0, 0, 1); text-decoration: none; font-family: Tahoma, Geneva, sans-serif;">kate@mysignature.io</span>
</td>
</tr>
<tr style="cursor: pointer;">
<td align="center" style="margin: 0.1px; padding: 5px 20px; font: 11.2px / 14.2px Tahoma, Geneva, sans-serif; color: rgb(255, 21, 167); border-bottom: 1px solid rgb(235, 228, 228);">
<span>address: </span><span style="color: rgb(0, 0, 1);">5th
                                                        Ave,
                                                        fl. 3</span>  <!-- --><span style="color: rgb(0, 0, 1); text-decoration: none; font-family: Tahoma, Geneva, sans-serif;">mysignature.io</span>
</td>
</tr>
<tr>
