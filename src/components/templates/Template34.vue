                                ...
                                <table cellpadding="0" style="border-collapse: collapse;">
                                    <tr>
                                        <td style="margin: 0.1px; padding: 4px 15px 0px 0px; cursor: pointer;">
                                            <span
                                                style="border-radius: 0%; width: 22px; height: 22px; display: block; text-align: center; font-size: 12px; font-family: initial; line-height: 1;"><svg
                                ...
                                <table cellpadding="0" style="border-collapse: collapse;">
                                    ...
                                    <tr>
                                        <td
                                            ...
                                            <span style="cursor: pointer;">Preschool
                                                Teacher</span><!-- --><span style="cursor: pointer;"></span>
                                        </td>
                                    </tr>
                                    ...
                                    <tr style="cursor: pointer;">
                                        <td
                                            style='margin: 0.1px; padding: 1px 0px; font: 12.6px / 16.1px "Times New Roman", Times, serif; color: rgb(0, 0, 0);'>
                                            <!-- --><span style="color: rgb(0, 0, 0);">Primary
                                                School,
                                            </span><!-- --><!-- -->
                                        </td>
                                    </tr>
