        ...
        <table cellpadding="0" style="border-collapse: collapse;">
            <tr>
                <td style="margin: 0.1px; padding: 10px 0px; cursor: pointer;"><img width="500"
                        src="https://img.mysignature.io/a/v1/6/8/6/6868853a-512f-5d92-b648-fd4c3d868623.png"
                        alt="We'll be happy to shop for you!"></td>
            </tr>
        </table>
        <table cellpadding="0" style="border-collapse: collapse; font-size: 11.2px;">
            <tr>
                <td align="center" style="margin: 0.1px; padding: 0px 0px 13px; cursor: pointer;"><img
                        src="https://img.mysignature.io/p/d/f/8/df8dbd3a-0253-5cb6-9595-c954c48ba33e.png?time=1685569257"
            ...
            <tr style="cursor: pointer;">
                <td align="center"
                    ...
                    <span>phone:&nbsp;</span><span
                        ...
                        style="color: rgb(0, 0, 1); text-decoration: none; font-family: &quot;Comic Sans MS&quot;, cursive, sans-serif;">your@mysignature.io</span>
                </td>
            </tr>
            <tr style="cursor: pointer;">
                <td align="center"
            ...
            <tr>
                <td align="center"
                    style="margin: 0.1px; padding: 10px 0px 0px; font: 11.2px / 14.2px &quot;Comic Sans MS&quot;, cursive, sans-serif; color: rgb(0, 0, 1);">
                    <table cellpadding="0" align="center" style="border-collapse: collapse;">
                        <tr>
                            <td style="margin: 0.1px; padding: 0px 2.5px; cursor: pointer;"><span
                                    style="border-radius: 15%; width: 23px; height: 23px; display: block; text-align: center; background-color: rgb(224, 16, 108); font-size: 12px; font-family: initial; line-height: 1;"><svg
            ...
            <tr>
                <td align="center"
                    style="margin: 0.1px; padding: 15px 0px 0px; font: 11.2px / 14.2px &quot;Comic Sans MS&quot;, cursive, sans-serif; color: rgb(0, 0, 1); cursor: pointer;">
                    <span><img
                            src="https://img.mysignature.io/b/d/f/8/df8dbd3a-0253-5cb6-9595-c954c48ba33e.png?time=1685569257"
