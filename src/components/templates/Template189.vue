                ...
                <td style="margin: 0.1px; padding: 0px;">
                    <table cellpadding="0" style="border-collapse: collapse;">
                        <tr>
                            ...
                            <td style="margin: 0.1px; padding: 0px 0px 0px 15px; font: 14.4px / 18.3px Verdana, Geneva, sans-serif; color: rgb(0, 0, 1);"
                                valign="top">
                                <table cellpadding="0" style="border-collapse: collapse;">
                                    <tr>
                                        <td
                                    ...
                                    <tr style="cursor: pointer;">
                                        <td
                                            ...
                                            <span style="color: rgb(89, 86, 151); font-weight: 600;">email: </span><span
                                    ...
                                    <tr style="cursor: pointer;">
                                        <td
                                            style="margin: 0.1px; padding: 2px 0px; font: 14.4px / 18.3px Verdana, Geneva, sans-serif; color: rgb(0, 0, 1);">
                                            <span style="color: rgb(89, 86, 151); font-weight: 600;">skype: </span><span
                ...
                <tr>
                    <td style="padding: 13px 4px 4px 0px; margin: 0.1px;">
                        <span><img alt="facebook" height="41"
                                src="https://img.mysignature.io/addons/v2/facebook_v1_shape2_b.png"
                                style="display: block;" width="144" /></span>
                    </td>
                    <td style="padding: 13px 4px 4px 0px; margin: 0.1px;">
                        <span><img alt="pinterest" height="41"
                                src="https://img.mysignature.io/addons/v2/pinterest_v1_shape2_b.png"
                                style="display: block;" width="144" /></span>
                    </td>
                    <td style="padding: 13px 4px 4px 0px; margin: 0.1px;">
                        <!-- -->
