        ...
        <table cellpadding="0" style="border-collapse: collapse;">
            <tr>
                <td style="margin: 0.1px; padding: 10px 0px; cursor: pointer;"><img width="500"
                        src="https://img.mysignature.io/a/v1/e/9/0/e906e3bb-42ba-5e39-9fb2-6b87f8bf2f72.png"
                        alt="Best regards,"></td>
            </tr>
        </table>
                    ...
                    <table cellpadding="0" style="border-collapse: collapse;">
                        <tr>
                            <td valign="top" style="margin: 0.1px; padding: 0px 9px 0px 0px; cursor: pointer;"><img
                                    src="https://img.mysignature.io/p/d/a/c/dac638f9-ec7a-5576-b8ed-2fbef1d0245e.png?time=1685569257"
                                    width="188" alt=" &quot;created with MySignature.io&quot;"
                                    style="display: block; min-width: 188px;"></td>
                            <td valign="top"
                                style="border-left: 2px solid rgb(161, 80, 26); margin: 0.1px; padding: 0px 0px 0px 9px;">
                                <table cellpadding="0" style="border-collapse: collapse;">
                                    <tr>
                                        <td
                                    ...
                                    <tr style="cursor: pointer;">
                                        <td
                                            style="margin: 0.1px; padding: 0px; font: 14.7px / 18.7px Georgia, serif; color: rgb(0, 0, 1);">
                                            <span style="color: rgb(0, 0, 1);">m:&nbsp;</span><span
                                                style="color: rgb(0, 0, 1); text-decoration: none; font-family: Georgia, serif;">+12023893201</span>
                                        </td>
                                    </tr>
                                    <tr style="cursor: pointer;">
                                        <td
                                    ...
                                    <tr style="cursor: pointer;">
                                        <td
                                            ...
                                            <span style="color: rgb(0, 0, 1);">e:&nbsp;</span><span
                                                style="color: rgb(0, 0, 1); text-decoration: none; font-family: Georgia, serif;">hr@mysignature.io</span>
                                        </td>
                                    </tr>
                                    <tr style="cursor: pointer;">
                                        <td
                                    ...
                                    <tr>
                                        <td
                                            ...
                                            <table cellpadding="0" style="border-collapse: collapse;">
                                                <tr>
                                                    <td
                                                        style="margin: 0.1px; padding: 0px 4px 0px 0px; font: 14.7px / 18.7px Georgia, serif; color: rgb(0, 0, 1); cursor: pointer;">
                                                        <span
                                                            style="border-radius: 15%; width: 26px; height: 26px; display: block; text-align: center; background-color: rgb(161, 80, 26); font-size: 12px; font-family: initial; line-height: 1;"><svg
