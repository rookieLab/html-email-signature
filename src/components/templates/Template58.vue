<template>
    <div><!---->
        <table cellpadding="0" width="500" style="border-collapse: collapse; font-size: 14.4px;">
                    ...
                    <table cellpadding="0" style="border-collapse: collapse;">
                        <tr>
                            <td valign="top" style="margin: 0.1px; padding: 0px 15px 0px 0px; cursor: pointer;"><img
                                    src="https://img.mysignature.io/p/9/c/6/9c6c8864-ecd8-54e4-a1dc-2b6bf2710a2c.png?time=1685569257"
                            ...
                            <td valign="top" style="margin: 0.1px; padding: 0px 15px 0px 0px;">
                                <table cellpadding="0" style="border-collapse: collapse;">
                                    <tr>
                                        <td
                                            style="margin: 0.1px; padding: 0px; font: 17.3px / 22.1px Tahoma, Geneva, sans-serif; color: rgb(0, 0, 1);">
                                            <span style="cursor: pointer;">Adriana Jacobs</span><!----><!----></td>
                                    </tr>
                                    <tr>
                                        <td
                                            style="margin: 0.1px; padding: 4px 0px; font: 14.4px / 18.3px Tahoma, Geneva, sans-serif; color: rgb(0, 0, 1);">
                                            <span style="cursor: pointer;">HR Manager</span>&nbsp;<span
                                                style="cursor: pointer;">Capitol Max</span><!----><span
                                                style="cursor: pointer;"></span></td>
                                    </tr>
                                    <tr style="cursor: pointer;">
                                        <td
                                            style="margin: 0.1px; padding: 0px; font: 14.4px / 18.3px Tahoma, Geneva, sans-serif; color: rgb(0, 0, 1);">
                                            <span style="color: rgb(245, 166, 35);">website:&nbsp;</span><span
                                    ...
                                    <tr style="cursor: pointer;">
                                        <td
                                            style="margin: 0.1px; padding: 0px; font: 14.4px / 18.3px Tahoma, Geneva, sans-serif; color: rgb(0, 0, 1);">
                                            <span style="color: rgb(245, 166, 35);">email:&nbsp;</span><span
                                                style="color: rgb(0, 0, 1); text-decoration: none; font-family: Tahoma, Geneva, sans-serif;">Jacobs@mysignature.io</span>
                                        </td>
                                    </tr>
                                    <tr style="cursor: pointer;">
                                        <td
                                            style="margin: 0.1px; padding: 0px; font: 14.4px / 18.3px Tahoma, Geneva, sans-serif; color: rgb(0, 0, 1);">
                                            <span style="color: rgb(245, 166, 35);">phone:&nbsp;</span><span
                                                style="color: rgb(0, 0, 1); text-decoration: none; font-family: Tahoma, Geneva, sans-serif;">+3
                                                455-56-02</span></td>
                                    </tr>
                                </table>
                            </td>
                            <td valign="middle"
                                style="border-left: 3px solid rgb(245, 166, 35); margin: 0.1px; padding: 0px 0px 0px 6px; font: 14.4px / 18.3px Tahoma, Geneva, sans-serif; color: rgb(0, 0, 1);">
                                <table cellpadding="0" style="border-collapse: collapse;">
                                    <tr>
                                        <td style="margin: 0.1px; padding: 4px 0px 0px; cursor: pointer;"><span
                                                style="border-radius: 0%; width: 22px; height: 22px; display: block; text-align: center; background-color: rgb(245, 166, 35); font-size: 12px; font-family: initial; line-height: 1;"><svg
            ...
            <tr>
                <td
                    style="margin: 0.1px; padding: 15px 0px 0px; font: 14.4px / 18.3px Tahoma, Geneva, sans-serif; color: rgb(0, 0, 1); cursor: pointer;">
                    <span><img
                            src="https://img.mysignature.io/b/9/c/6/9c6c8864-ecd8-54e4-a1dc-2b6bf2710a2c.png?time=1685569257"
