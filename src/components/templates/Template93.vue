...
<span style="border-radius: 50%; width: 20px; height: 20px; display: block; text-align: center; background-color: rgb(28, 59, 95); font-size: 12px; font-family: initial; line-height: 1;"><svg style="position: relative; top: 4px; width: 12px;" viewbox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg">
...
<table cellpadding="0" style="border-collapse: collapse;">
<tr>
<td style="margin: 0.1px; padding: 0px 0px 2px; font: 13.8px / 17.6px Tahoma; color: rgb(0, 0, 1);">
<span style="color: rgb(0, 0, 0); font-weight: 600; cursor: pointer;">Benjamin
                                                                                Garcia </span><!-- --><!-- -->
</td>
</tr>
<tr>
<td style="margin: 0.1px; padding: 0px 0px 5px; font: 11.5px / 14.7px Tahoma; color: rgb(0, 0, 1);">
<span style="cursor: pointer;">Professor
                                                                                of
                                                                                Economics </span> <span style="cursor: pointer;">?Metropolitan
                                                                                University</span>
</td>
</tr>
<tr style="cursor: pointer;">
<td style="margin: 0.1px; padding: 1px 0px; font: 11.5px / 14.7px Tahoma; color: rgb(0, 0, 1);">
<span>Website: </span><span style="color: rgb(0, 0, 1); text-decoration: none; font-family: Tahoma;">mysignature.io</span>, <span>Email: </span><span style="color: rgb(0, 0, 1); text-decoration: none; font-family: Tahoma;">garcia@mysignature.io</span>
</td>
</tr>
<tr style="cursor: pointer;">
<td style="margin: 0.1px; padding: 1px 0px; font: 11.5px / 14.7px Tahoma; color: rgb(0, 0, 1);">
<span>Address: </span><span style="color: rgb(0, 0, 1);">10
                                                                                California
                                                                                st, fl
                                                                                6</span><!-- --><!-- -->
</td>
...
<tr style="cursor: pointer;">
<td style="margin: 0.1px; padding: 1px 0px; font: 11.5px / 14.7px Tahoma; color: rgb(0, 0, 1);">
<span>Phone: </span><span style="color: rgb(0, 0, 1); text-decoration: none; font-family: Tahoma;">+1
                                                                                (555)
                                                                                876-5432</span><!-- --><!-- -->
</td>
</tr>
...
<table cellpadding="0" style="border-collapse: collapse;" width="477">
<tr>
<td style="margin: 0.1px; padding: 15px 0px 0px; font: 12.1px / 15.3px Tahoma; color: rgb(118, 128, 143); cursor: pointer;">
                                                        Metropolian University is compliant with the GDPR
                                                        regulation
                                                        on data
