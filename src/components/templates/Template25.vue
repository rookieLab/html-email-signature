    ...
    <div>
        <table cellpadding="0" style="border-collapse: collapse;">
            <tr>
                <td style="margin: 0.1px; padding: 10px 0px; cursor: pointer;">
                    <img alt="Thank you, for your choice"
                        src="/assets/9dd8a81d-69c4-5cc2-8095-b1808b2bd825.png"
                        width="500" />
                </td>
            </tr>
        </table>
                    ...
                    <table cellpadding="0" style="border-collapse: collapse;">
                        <tr>
                            <td style="margin: 0.1px; padding: 0px; cursor: pointer;" valign="top">
                                <img alt="SignMaker"
                                    src="/assets/89245067-42b6-5218-b1d1-390132167ace.png"
                                    style="display: block; min-width: 138px;" width="138" />
                            </td>
                            <td style="margin: 0.1px; padding: 0px 0px 0px 15px; font: 12.8px / 16.3px Verdana, Geneva, sans-serif; color: rgb(0, 0, 1);"
                                valign="top">
                                <table cellpadding="0" style="border-collapse: collapse;">
                                    <tr>
                                        <td
                                    ...
                                    <tr style="cursor: pointer;">
                                        <td
                                            ...
                                            <span style="color: rgb(51, 124, 201); font-weight: 600;">p: </span><span
                                    ...
                                    <tr style="cursor: pointer;">
                                        <td
                                            style="margin: 0.1px; padding: 2px 0px; font: 12.8px / 16.3px Verdana, Geneva, sans-serif; color: rgb(0, 0, 1);">
                                            <span style="color: rgb(51, 124, 201); font-weight: 600;">e: </span><span
                                                style="color: rgb(0, 0, 1); text-decoration: none; font-family: Verdana, Geneva, sans-serif;">
                                    ...
                                    <tr style="cursor: pointer;">
                                        <td
                                            style="margin: 0.1px; padding: 2px 0px; font: 12.8px / 16.3px Verdana, Geneva, sans-serif; color: rgb(0, 0, 1);">
                                            <span style="color: rgb(51, 124, 201); font-weight: 600;">w: </span><span
        ...
        <div>
            <table cellpadding="0"
                ...
                width="500">
                <tr style="cursor: pointer;">
                    <td align="center" height="27" style="padding: 19px 0px 0px; margin: 0.1px; min-width: 27px;"
                        width="27">
                        <svg style="width: 17.55px;" viewbox="0 0 768 1024" xmlns="http://www.w3.org/2000/svg">
                            <path
                ...
                <tr>
                    <td style="margin: 0.1px; padding-top: 10px; cursor: pointer;">
                        <img alt="created with MySignature.io"
                            src="/assets/89245067-42b6-5218-b1d1-390132167ace.png"
                            style="display: block;" valign="top" width="360" />
                    </td>
                </tr>
            </table>
            <table border="0" cellpadding="0" cellspacing="0" width="500">
