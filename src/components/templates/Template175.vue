                        ...
                        <table cellpadding="0" style="border-collapse: collapse;">
                            <tr>
                                <td valign="top" style="margin: 0.1px; padding: 0px 12px 0px 0px; cursor: pointer;"><img
                                        src="https://img.mysignature.io/p/5/1/7/517f6d18-512c-550a-84e0-b338e1000bb3.png?time=1685569257"
                                        width="137" alt=" &quot;created with MySignature.io&quot;"
                                        style="display: block; min-width: 137px;"></td>
                                <td valign="top"
                                    style="border-left: 1px solid rgb(218, 187, 26); margin: 0.1px; padding: 0px 0px 0px 12px; font: 14.4px / 18.3px Georgia, serif; color: rgb(0, 0, 1);">
                                    <table cellpadding="0" style="border-collapse: collapse;">
                                        <tr>
                                            <td
                                                style="margin: 0.1px; padding: 0px 0px 8px; font: 18.7px / 23.8px Georgia, serif; color: rgb(0, 0, 1);">
                                                <span
                                                    style="font-weight: 600; color: rgb(218, 187, 26); cursor: pointer;">MACK
                                                    MEADOWS </span><!----><!----></td>
                                        </tr>
                                        <tr>
                                            <td
                                                style="margin: 0.1px; padding: 0px 0px 8px; font: 14.4px / 18.3px Georgia, serif; color: rgb(0, 0, 1);">
                                                <!----><!----><span
                                                    style="color: rgb(0, 0, 1); cursor: pointer;">Business
                                                    Consultant</span><!----><!----></td>
                                        </tr>
                                        <tr style="cursor: pointer;">
                                            <td
                                                style="margin: 0.1px; padding: 0px; font: 14.4px / 18.3px Georgia, serif; color: rgb(0, 0, 1);">
                                                <span
                                                    style="color: rgb(218, 187, 26); font-weight: 600;">✉:&nbsp;</span><span
                                                    style="color: rgb(0, 0, 1); text-decoration: none; font-family: Georgia, serif;">meadows@mysignature.io</span>
                                            </td>
                                        </tr>
                                        <tr style="cursor: pointer;">
                                            <td
                                                ...
                                                <span
                                                    style="color: rgb(218, 187, 26); font-weight: 600;">☏:&nbsp;</span><span
                                                    style="color: rgb(0, 0, 1); text-decoration: none; font-family: Georgia, serif;">+55-686-876-3572</span>
                                            </td>
                                        </tr>
                                        <tr style="cursor: pointer;">
                                            <td
                                                style="margin: 0.1px; padding: 0px; font: 14.4px / 18.3px Georgia, serif; color: rgb(0, 0, 1);">
                                                <!----><span
                                                    style="color: rgb(0, 0, 1); text-decoration: none; font-family: Georgia, serif;"></span>
                                            </td>
                                        </tr><!---->
                                        <tr>
                                            <td
                                                ...
                                                <table cellpadding="0" style="border-collapse: collapse;">
                                                    <tr>
                                                        <td
                                                            style="margin: 0.1px; padding: 0px 5px 0px 0px; font: 14.4px / 18.3px Georgia, serif; color: rgb(0, 0, 1); cursor: pointer;">
                                                            <span
                                                                style="border-radius: 0%; width: 22px; height: 22px; display: block; text-align: center; background-color: rgb(23, 23, 23); font-size: 12px; font-family: initial; line-height: 1;"><svg
