            ...
            <tr>
                <td style="margin: 0.1px; padding: 0px;">
                    <table cellpadding="0" style="border-collapse: collapse;">
                        <tr>
                            <td valign="middle"
                                style="margin: 0.1px; padding: 0px 20px 0px 0px; border-right: 2px solid rgb(99, 204, 200);">
                                <table cellpadding="0" style="border-collapse: collapse;">
                                    <tr>
                                        <td align="center"
                                            style="margin: 0.1px; padding: 0px 0px 10px; cursor: pointer;"><img
                                                src="https://img.mysignature.io/p/3/1/a/31a6799e-8110-53c6-9db7-3aa9d1c7749e.png?time=1685569257"
                                                width="92" alt=" &quot;created with MySignature.io&quot;"
                                                style="display: block; min-width: 92px; margin: 0px auto;"></td>
                                    </tr>
                                    <tr>
                                        <td align="center"
                                    ...
                                    <tr>
                                        <td align="center"
                                            style="margin: 0.1px; padding: 5px 0px 0px; font: 200 13.1px / 16.5px Arial, Helvetica, sans-serif; color: rgb(0, 0, 1);">
                                            <span style="cursor: pointer;">Customer Success Manager</span>&nbsp;<span
                                                style="cursor: pointer;"> at Gravity</span></td>
                                    </tr>
                                </table>
                            </td>
                                ...
                                <table cellpadding="0" style="border-collapse: collapse;">
                                    <tr style="cursor: pointer;">
                                        <td
                                            ...
                                            <span
                                                style="color: rgb(99, 204, 200); font-weight: 600;">A:&nbsp;&nbsp;</span><span
                                                style="color: rgb(0, 0, 1);">814 Mission Str 600</span></td>
                                    </tr>
                                    <tr style="cursor: pointer;">
                                        <td
                                            style="margin: 0.1px; padding: 5px 0px 0px; font: 13.1px / 16.5px Arial, Helvetica, sans-serif; color: rgb(0, 0, 1); white-space: nowrap;">
                                            <span
                                                style="color: rgb(99, 204, 200); font-weight: 600;">T:&nbsp;&nbsp;</span><span
                                                style="color: rgb(0, 0, 1); text-decoration: none; font-family: Arial, Helvetica, sans-serif;">767
                                                454 9876</span></td>
                                    </tr>
                                    <tr style="cursor: pointer;">
                                        <td
                                            style="margin: 0.1px; padding: 5px 0px 0px; font: 13.1px / 16.5px Arial, Helvetica, sans-serif; color: rgb(0, 0, 1); white-space: nowrap;">
                                            <span
                                                style="color: rgb(99, 204, 200); font-weight: 600;">E:&nbsp;&nbsp;</span><span
                                                style="color: rgb(0, 0, 1); text-decoration: none; font-family: Arial, Helvetica, sans-serif;">marissa@mysignature.io</span>
                                        </td>
                                    </tr>
                                    <tr style="cursor: pointer;">
                                        <td
                                                        ...
                                                        <table cellpadding="0" style="border-collapse: collapse;">
                                                            <tr>
                                                                <td
                                                                    ...
                                                                    <span
                                                                        style="border-radius: 15%; width: 22px; height: 22px; display: block; text-align: center; background-color: rgb(99, 204, 200); font-size: 12px; font-family: initial; line-height: 1;"><svg
