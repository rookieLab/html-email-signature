<template>
    <div>
        <table cellpadding="0" style="border-collapse: collapse;">
            <tr>
                <td style="margin: 0.1px; padding: 10px 0px; cursor: pointer;"><img width="500"
                        src="https://img.mysignature.io/a/v1/7/3/b/73b41d1d-c0c8-57d8-a156-e513a2a055bc.png"
                        alt="Kind regards,"></td>
            </tr>
        </table>
        <table cellpadding="0" width="500" style="border-collapse: collapse; font-size: 14.4px;">
                    ...
                    <table cellpadding="0" style="border-collapse: collapse;">
                        <tr>
                                ...
                                <table cellpadding="0" style="border-collapse: collapse;">
                                    ...
                                    <tr style="cursor: pointer;">
                                        <td
                                            ...
                                            <span style="color: rgb(166, 130, 86);">w:&nbsp;</span><span
                                    ...
                                    <tr style="cursor: pointer;">
                                        <td
                                            style="margin: 0.1px; padding: 1px 0px; font: 14.4px / 18.3px Georgia, serif; color: rgb(0, 0, 1);">
                                            <span style="color: rgb(166, 130, 86);">e:&nbsp;</span><span
                                                style="color: rgb(0, 0, 1); text-decoration: none; font-family: Georgia, serif;">rosie@mysignature.io</span>
                                        </td>
                                    </tr>
                                    <tr style="cursor: pointer;">
                                        <td
                                            style="margin: 0.1px; padding: 1px 0px; font: 14.4px / 18.3px Georgia, serif; color: rgb(0, 0, 1);">
                                            <span style="color: rgb(166, 130, 86);">a:&nbsp;</span><span
                                                style="color: rgb(0, 0, 1);">5th Ave, fl. 3</span></td>
                                    </tr>
                                    <tr style="cursor: pointer;">
                                        <td
                                            style="margin: 0.1px; padding: 1px 0px; font: 14.4px / 18.3px Georgia, serif; color: rgb(0, 0, 1);">
                                            <span style="color: rgb(166, 130, 86);">p:&nbsp;</span><span
                                                style="color: rgb(0, 0, 1); text-decoration: none; font-family: Georgia, serif;">838
                                                3837 3344</span></td>
                                    </tr>
                                    <tr>
                                        <td
                                    ...
                                    <tr>
                                        <td
                                            ...
                                            <table cellpadding="0" style="border-collapse: collapse;">
                                                <tr>
                                                    <td
                                                        style="margin: 0.1px; padding: 0px 4px 0px 0px; font: 14.4px / 18.3px Georgia, serif; color: rgb(0, 0, 1); cursor: pointer;">
                                                        <span
                            ...
                            <td valign="top" style="margin: 0.1px; padding: 0px 0px 0px 15px; cursor: pointer;"><img
                                    ...
                                    width="180" alt=" &quot;created with MySignature.io&quot;"
                                    style="display: block; min-width: 180px;"></td>
                        </tr>
                    </table>
                </td>
            </tr>
            <tr>
                <td
                    style="margin: 0.1px; padding: 15px 0px 0px; font: 14.4px / 18.3px Georgia, serif; color: rgb(0, 0, 1); cursor: pointer;">
                    <img src="https://img.mysignature.io/b/9/b/5/9b533b35-6a10-5163-97a2-10c739f8f10e.png?time=1685569257"
