        ...
        <table cellpadding="0" style="border-collapse: collapse;">
            <tr>
                <td style="margin: 0.1px; padding: 10px 0px; cursor: pointer;"><img width="500"
                        src="https://img.mysignature.io/a/v1/0/2/1/02181f9f-a48e-5bfe-9097-f3dd07b0d66e.png"
                        alt="Happy Holidays!"></td>
            </tr>
        </table>
        <table cellpadding="0" width="550" style="border-collapse: collapse; font-size: 12.6px;">
            <tr>
                <td style="margin: 0.1px; padding: 0px;">
                    <table cellpadding="0" style="border-collapse: collapse;">
                        <tr>
                            <td valign="top"
                                style="margin: 0.1px; padding: 0px 20px 0px 0px; border-right: 3px solid rgb(220, 0, 0);">
                                <table cellpadding="0" style="border-collapse: collapse;">
                                    <tr>
                                        <td
                                    ...
                                    <tr>
                                        <td
                                            ...
                                            <table cellpadding="0" style="border-collapse: collapse;">
                                                <tr>
                                                    <td
                                                        style="margin: 0.1px; padding: 0px 6px 0px 0px; font: 12.6px / 16.1px &quot;Courier New&quot;, Courier, monospace; color: rgb(0, 0, 1); cursor: pointer;">
                                                        <span
                                                            style="border-radius: 50%; width: 28px; height: 28px; display: block; text-align: center; font-size: 12px; font-family: initial; line-height: 1;"><svg
            ...
            <tr>
                <td
                    style="margin: 0.1px; padding: 15px 0px 0px; font: 12.6px / 16.1px &quot;Courier New&quot;, Courier, monospace; color: rgb(0, 0, 1); cursor: pointer;">
                    <img src="https://img.mysignature.io/b/6/3/1/631d8503-6a46-52f7-94c2-ef65e4381efe.png?time=1709111467"
