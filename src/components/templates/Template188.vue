                    ...
                    <table cellpadding="0" style="border-collapse: collapse;">
                        <tr>
                            <td valign="top" style="margin: 0.1px; padding: 0px 9px 0px 0px; cursor: pointer;"><img
                                    src="https://img.mysignature.io/p/9/a/9/9a9be290-0f29-5353-93bb-02fdce1659bb.png?time=1685569257"
                                    width="157" alt=" &quot;created with MySignature.io&quot;"
                                    style="display: block; min-width: 157px;"></td>
                            <td valign="top"
                                style="border-left: 2px solid rgb(99, 202, 204); margin: 0.1px; padding: 0px 0px 0px 9px;">
                                <table cellpadding="0" style="border-collapse: collapse;">
                                    <tr>
                                        <td
                                    ...
                                    <tr style="cursor: pointer;">
                                        <td
                                            ...
                                            <span style="color: rgb(0, 0, 1);">m:&nbsp;</span><span
                                                style="color: rgb(0, 0, 1); text-decoration: none; font-family: Arial, Helvetica, sans-serif;">+435-567-323</span>
                                        </td>
                                    </tr>
                                    <tr style="cursor: pointer;">
                                        <td
                                    ...
                                    <tr style="cursor: pointer;">
                                        <td
                                            ...
                                            <span style="color: rgb(0, 0, 1);">e:&nbsp;</span><span
                                                style="color: rgb(0, 0, 1); text-decoration: none; font-family: Arial, Helvetica, sans-serif;">amara-decker@mysignature.io</span>
                                        </td>
                                    </tr>
                                    <tr style="cursor: pointer;">
                                        <td
                                    ...
                                    <tr>
                                        <td
                                            ...
                                            <table cellpadding="0" style="border-collapse: collapse;">
                                                <tr>
                                                    <td
                                                        style="margin: 0.1px; padding: 0px 4px 0px 0px; font: 13.6px / 17.3px Arial, Helvetica, sans-serif; color: rgb(0, 0, 1); cursor: pointer;">
                                                        <span
                                                            style="border-radius: 0%; width: 23px; height: 23px; display: block; text-align: center; background-color: rgb(26, 183, 234); font-size: 12px; font-family: initial; line-height: 1;"><svg
                                                                viewBox="0 0 1024 1024"
                                                                xmlns="http://www.w3.org/2000/svg"
                                                                style="position: relative; top: 4.6px; width: 13.8px;">
                                                                <path
                                                                    d="M1023.514 271.040c-4.601 100.794-74.208 239.031-208.823 414.307-139.216 182.967-257.029 274.653-353.439 274.653-59.607 0-110.212-55.659-151.417-167.18-27.603-102.211-55.006-204.421-82.609-306.632-30.603-111.521-63.407-167.18-98.611-167.18-7.601 0-34.404 16.394-80.409 48.778l-48.205-62.743c50.606-44.932 100.411-89.864 149.417-134.797 67.408-58.898 118.013-89.864 151.817-93.103 79.609-7.691 128.814 47.361 147.216 165.359 19.802 127.308 33.604 206.445 41.405 237.412 23.003 105.651 48.205 158.477 75.808 158.477 21.402 0 53.606-34.205 96.611-102.818 42.805-68.41 65.807-120.629 69.008-156.453 6.201-59.1-16.802-88.852-69.008-88.852-24.603 0-49.806 5.667-75.808 17.001 50.406-166.775 146.416-247.734 288.432-243.079 105.012 2.834 154.617 71.851 148.617 206.85z"
                                                                    fill="#ffffff"></path>
                                                            </svg></span></td>
                                                    <td
                                                        style="margin: 0.1px; padding: 0px 4px 0px 0px; font: 13.6px / 17.3px Arial, Helvetica, sans-serif; color: rgb(0, 0, 1); cursor: pointer;">
                                                        <span
                                                            style="border-radius: 0%; width: 23px; height: 23px; display: block; text-align: center; background-color: rgb(29, 161, 242); font-size: 12px; font-family: initial; line-height: 1;"><svg
                                                    ...
                                                    <td
                                                        style="margin: 0.1px; padding: 0px 4px 0px 0px; font: 13.6px / 17.3px Arial, Helvetica, sans-serif; color: rgb(0, 0, 1); cursor: pointer;">
                                                        <span
                                                            style="border-radius: 0%; width: 23px; height: 23px; display: block; text-align: center; background-color: rgb(24, 119, 242); font-size: 12px; font-family: initial; line-height: 1;"><svg
                                                                viewBox="0 0 1024 1024"
                                                                xmlns="http://www.w3.org/2000/svg"
                                                                style="position: relative; top: 4.6px; width: 13.8px;">
                                                                <path
