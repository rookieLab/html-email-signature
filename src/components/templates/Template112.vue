<template>
    <div><!---->
        <table cellpadding="0"
            ...
            <tr>
                <td
                    style="margin: 0.1px; padding: 20px; font: 11.5px / 14.7px &quot;Comic Sans MS&quot;, cursive, sans-serif; color: rgb(0, 0, 1);">
                    <table cellpadding="0" style="border-collapse: collapse;">
                        <tr>
                            <td valign="top" style="margin: 0.1px; padding: 0px 15px 0px 0px; cursor: pointer;"><img
                                    src="https://img.mysignature.io/p/6/c/d/6cd4e680-196d-5d83-a3a6-67182aa13694.png?time=1685569257"
                                    width="179" alt=" &quot;created with MySignature.io&quot;"
                                    style="display: block; min-width: 179px;"></td>
                            <td valign="top"
                                style="margin: 0.1px; padding: 0px; font: 11.5px / 14.7px &quot;Comic Sans MS&quot;, cursive, sans-serif; color: rgb(0, 0, 1);">
                                <table cellpadding="0" style="border-collapse: collapse;">
                                    <tr>
                                        <td
                                    ...
                                    <tr>
                                        <td
                                            style="margin: 0.1px; padding: 10px 0px 0px; font: 11.5px / 14.7px &quot;Comic Sans MS&quot;, cursive, sans-serif; color: rgb(255, 255, 255);">
                                            <span
                                    ...
                                    <tr>
                                        <td
                                            ...
                                            <table cellpadding="0" style="border-collapse: collapse;">
                                                <tr>
                                                    <td
                                                        style="margin: 0.1px; padding: 0px 5px 0px 0px; font: 11.5px / 14.7px &quot;Comic Sans MS&quot;, cursive, sans-serif; color: rgb(0, 0, 1); cursor: pointer;">
                                                        <span
                                                            style="border-radius: 0%; width: 37px; height: 37px; display: block; text-align: center; background-color: rgb(0, 207, 217); font-size: 12px; font-family: initial; line-height: 1;"><svg
                                                                viewBox="0 0 1024 1024"
                                                                xmlns="http://www.w3.org/2000/svg"
                                                                style="position: relative; top: 7.4px; width: 22.2px;">
                                                                <path
            ...
            <table width="500" cellpadding="0" style="border-collapse: collapse;">
                <tr>
                    <td style="padding: 5px 10px 0px 0px; margin: 0.1px; cursor: pointer;"><span><img
                                alt="Join live stream with Mat Zabia! 10/12/2020, Tuesday  10 p.m."
