...
<template>
 <div><!-- -->
<table cellpadding="0" style="border-collapse: collapse; font-size: 11.5px; background-color: rgb(0, 207, 217);">
<tr>
<td style='margin: 0.1px; padding: 20px; font: 11.5px / 14.7px "Comic Sans MS", cursive, sans-serif; color: rgb(0, 0, 1);'>
<table cellpadding="0" style="border-collapse: collapse;">
<tr>
<td style="margin: 0.1px; padding: 0px 15px 0px 0px; cursor: pointer;" valign="top">
<img alt="SignMaker" src="https://img.mysignature.io/p/6/c/d/6cd4e680-196d-5d83-a3a6-67182aa13694.png?time=1685569257" style="display: block; min-width: 179px;" width="179"/>
</td>
<td style='margin: 0.1px; padding: 0px; font: 11.5px / 14.7px "Comic Sans MS", cursive, sans-serif; color: rgb(0, 0, 1);' valign="top">
<table cellpadding="0" style="border-collapse: collapse;">
<tr>
<td style='margin: 0.1px; padding: 0px 0px 5px; font: 15.1px / 19.1px "Comic Sans MS", cursive, sans-serif; color: rgb(255, 255, 255); cursor: pointer;'>
<span style="font-weight: 600; cursor: pointer;">dj
                                                                                Emmi
                                                                                Wave</span><!-- --><!-- -->
</td>
</tr>
<tr>
<td style='margin: 0.1px; padding: 5px 0px; font: 11.5px / 14.7px "Comic Sans MS", cursive, sans-serif; color: rgb(255, 255, 255); text-transform: uppercase; border-top: 1px solid rgb(255, 255, 255);'>
...
<td style='margin: 0.1px; padding: 5px 0px 0px; font: 11.5px / 14.7px "Comic Sans MS", cursive, sans-serif; color: rgb(255, 255, 255);'>
<span>email: </span><span style='color: rgb(255, 255, 255); text-decoration: none; font-family: "Comic Sans MS", cursive, sans-serif;'>emmiwave@mysignature.io</span><!-- --><!-- -->
</td>
</tr>
<tr>
<td style='margin: 0.1px; padding: 10px 0px 0px; font: 11.5px / 14.7px "Comic Sans MS", cursive, sans-serif; color: rgb(255, 255, 255);'>
<span style="color: rgb(255, 255, 255); font-weight: 400; cursor: pointer;">partnerships</span> <span style="color: rgb(255, 255, 255); font-weight: 400; cursor: pointer;">+1
                                                                                746 337
                                                                                8333</span><!-- --><!-- -->
</td>
</tr><!-- -->
<tr>
<td style='margin: 0.1px; padding: 10px 0px 0px; font: 11.5px / 14.7px "Comic Sans MS", cursive, sans-serif; color: rgb(0, 0, 1);'>
<table cellpadding="0" style="border-collapse: collapse;">
<tr>
<td style='margin: 0.1px; padding: 0px 5px 0px 0px; font: 11.5px / 14.7px "Comic Sans MS", cursive, sans-serif; color: rgb(0, 0, 1); cursor: pointer;'>
<span style="border-radius: 0%; width: 37px; height: 37px; display: block; text-align: center; background-color: rgb(0, 207, 217); font-size: 12px; font-family: initial; line-height: 1;"><svg style="position: relative; top: 7.4px; width: 22.2px;" viewbox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg">
...
<span><img alt="Join live stream with Mat Zabia! 10/12/2020, Tuesday  10 p.m." src="https://img.mysignature.io/a/v1/e/a/3/ea345d03-8520-5c37-8a34-5aec2651652f.png" style="max-width: 490px; display: block;" width="464"/></span>
</td>
</tr>
</table><!-- -->
