    ...
    <div><!---->
                        ...
                        <table cellpadding="0" style="border-collapse: collapse;">
                            <tr>
                                <td valign="top" style="margin: 0.1px; padding: 0px 12px 0px 0px; cursor: pointer;"><img
                                        src="https://img.mysignature.io/p/4/d/d/4dd95bb4-0381-5756-a89f-c6eb6bf4b625.png?time=1709302061"
                                        width="141" alt=" &quot;created with MySignature.io&quot;"
                                        style="display: block; min-width: 141px;"></td>
                                <td valign="top"
                                    style="border-left: 1px solid rgb(0, 0, 0); margin: 0.1px; padding: 0px 0px 0px 12px; font: 12.6px / 16.1px Verdana, Geneva, sans-serif; color: rgb(0, 0, 1);">
                                    <table cellpadding="0" style="border-collapse: collapse;">
                                        <tr>
                                            <td
                                                style="margin: 0.1px; padding: 0px 0px 8px; font: 16.4px / 20.9px Verdana, Geneva, sans-serif; color: rgb(0, 0, 1);">
                                                <span
                                                    style="font-weight: 600; color: rgb(0, 0, 0); cursor: pointer;">Ryan
                                                    Davis</span><!----><!----></td>
                                        </tr>
                                        <tr>
                                            <td
                                                style="margin: 0.1px; padding: 0px 0px 8px; font: 12.6px / 16.1px Verdana, Geneva, sans-serif; color: rgb(73, 66, 56);">
                                                <span style="color: rgb(73, 66, 56); cursor: pointer;">Food
                                                    Writer</span><!----><!----><!----><!----></td>
                                        </tr>
                                        <tr style="cursor: pointer;">
                                            <td
                                                style="margin: 0.1px; padding: 0px; font: 12.6px / 16.1px Verdana, Geneva, sans-serif; color: rgb(0, 0, 1);">
                                                <span
                                                    style="color: rgb(0, 0, 0); font-weight: 600;">email:&nbsp;</span><span
                                                    style="color: rgb(73, 66, 56); text-decoration: none; font-family: Verdana, Geneva, sans-serif;">ryan@mysignature.io</span>
                                            </td>
                                        </tr>
                                        <tr style="cursor: pointer;">
                                            <td
                                                style="margin: 0.1px; padding: 0px; font: 12.6px / 16.1px Verdana, Geneva, sans-serif; color: rgb(0, 0, 1);">
                                                <span
                                                    style="color: rgb(0, 0, 0); font-weight: 600;">website:&nbsp;</span><span
                                                    style="color: rgb(73, 66, 56); text-decoration: none; font-family: Verdana, Geneva, sans-serif;">mysignature.io</span>
                                            </td>
                                        </tr>
                                        <tr style="cursor: pointer;">
                                            <td
                                                ...
                                                <span
                                                    ...
                                                    style="color: rgb(73, 66, 56); text-decoration: none; font-family: Verdana, Geneva, sans-serif;">+5-354-23-445</span>
                                            </td>
                                        </tr><!---->
                                        <tr>
                                            <td
                                                style="margin: 0.1px; padding: 12px 0px 0px; font: 12.6px / 16.1px Verdana, Geneva, sans-serif; color: rgb(0, 0, 1);">
                                                <table cellpadding="0" style="border-collapse: collapse;">
                                                    <tr>
                                                        <td
                                                            style="margin: 0.1px; padding: 0px 5px 0px 0px; font: 12.6px / 16.1px Verdana, Geneva, sans-serif; color: rgb(0, 0, 1); cursor: pointer;">
                                                            <span
                                                                style="border-radius: 15%; width: 25px; height: 25px; display: block; text-align: center; background-color: rgb(236, 228, 228); font-size: 12px; font-family: initial; line-height: 1;"><svg
        ...
        <div>
            <table width="500" cellpadding="0" style="border-collapse: collapse;">
                <tr>
                    <td style="padding: 13px 10px 0px 0px; margin: 0.1px; cursor: pointer;"><span><img
                                alt="Newsletter subscription form"
                                src="https://img.mysignature.io/a/v1/1/c/d/1cde870e-7d06-571b-8294-33203f0b9cd8.png"
                                style="max-width: 490px; display: block;" width="264"></span></td>
                </tr>
            </table>
            <table width="500" cellspacing="0" cellpadding="0" border="0">
                <tr>
                    <td style="margin: 0.1px; padding-top: 10px; cursor: pointer;"><img
                            src="https://img.mysignature.io/b/4/d/d/4dd95bb4-0381-5756-a89f-c6eb6bf4b625.png?time=1709302061"
