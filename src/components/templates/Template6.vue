        ...
        <table cellpadding="0" width="500" style="border-collapse: collapse; font-size: 12.5px;">
                ...
                <td style="margin: 0.1px; padding: 0px;">
                    <table cellpadding="0" style="border-collapse: collapse;">
                        <tr>
                            ...
                            <td valign="top"
                                style="margin: 0.1px; padding: 0px 0px 0px 15px; font: 12.5px / 15.9px Tahoma, Geneva, sans-serif; color: rgb(0, 0, 1);">
                                <table cellpadding="0" style="border-collapse: collapse;">
                                    <tr>
                                        <td
            ...
            <tr>
                <td
                    ...
                    <img src="https://img.mysignature.io/b/8/d/3/8d3c292b-c231-52c5-ac42-ce03bc09d651.png?time=1708944413"
                        valign="top" width="346" alt="created with MySignature.io" style="display: block;"></td>
            </tr>
        </table>
        <div><!---->
