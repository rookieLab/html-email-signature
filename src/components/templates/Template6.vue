<template>
    <div><!-- -->
        <table cellpadding="0" style="border-collapse: collapse; font-size: 12.5px;" width="500">
                    ...
                    <table cellpadding="0" style="border-collapse: collapse;">
                        <tr>
                            <td style="margin: 0.1px; padding: 0px; cursor: pointer;" valign="top">
                                <img alt="SignMaker"
                                    src="https://img.mysignature.io/p/8/d/3/8d3c292b-c231-52c5-ac42-ce03bc09d651.png?time=1708944413"
                                    style="display: block; min-width: 133px;" width="133" />
                            </td>
                            <td style="margin: 0.1px; padding: 0px 0px 0px 15px; font: 12.5px / 15.9px Tahoma, Geneva, sans-serif; color: rgb(0, 0, 1);"
                                valign="top">
                                <table cellpadding="0" style="border-collapse: collapse;">
                                    <tr>
                                        <td
                                            ...
                                            <span
                                                style="font-weight: 600; color: rgb(234, 127, 76); cursor: pointer;">JULIANA
                                                SILVA</span><!-- --><!-- --><!-- --><!-- -->
                                        </td>
                                    </tr>
                                    <tr>
                                        <td
                                            style="margin: 0.1px; padding: 0px 0px 5px; font: 12.5px / 15.9px Tahoma, Geneva, sans-serif; color: rgb(0, 0, 1);">
                                    ...
                                    <tr style="cursor: pointer;">
                                        <td
                                            style="margin: 0.1px; padding: 2px 0px; font: 12.5px / 15.9px Tahoma, Geneva, sans-serif; color: rgb(0, 0, 1);">
                                            <span style="color: rgb(234, 127, 76); font-weight: 600;">email </span><span
                                    ...
                                    <tr style="cursor: pointer;">
                                        <td
                                            style="margin: 0.1px; padding: 2px 0px; font: 12.5px / 15.9px Tahoma, Geneva, sans-serif; color: rgb(0, 0, 1);">
                                            <span style="color: rgb(234, 127, 76); font-weight: 600;">phone </span><span
                                    ...
                                    <tr>
                                        <td
                                            ...
                                            <table cellpadding="0" style="border-collapse: collapse;">
                                                <tr>
                                                    <td
                                                        style="margin: 0.1px; padding: 0px 4px 0px 0px; font: 12.5px / 15.9px Tahoma, Geneva, sans-serif; color: rgb(0, 0, 1); cursor: pointer;">
                                                        <span
                                                            style="border-radius: 0%; width: 21px; height: 21px; display: block; text-align: center; background-color: rgb(234, 127, 76); font-size: 12px; font-family: initial; line-height: 1;"><svg
            ...
            <tr>
                <td
                    style="margin: 0.1px; padding: 15px 0px 0px; font: 12.5px / 15.9px Tahoma, Geneva, sans-serif; color: rgb(0, 0, 1); cursor: pointer;">
                    <img alt="created with MySignature.io"
                        src="https://img.mysignature.io/b/8/d/3/8d3c292b-c231-52c5-ac42-ce03bc09d651.png?time=1708944413"
                        style="display: block;" valign="top" width="346" />
                </td>
            </tr>
        </table>
        <div><!-- -->
