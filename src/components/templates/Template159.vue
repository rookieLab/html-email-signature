        ...
        <table cellpadding="0" width="400" style="border-collapse: collapse; font-size: 13.8px;">
            <tr>
                <td style="margin: 0.1px; padding: 0px; cursor: pointer;"><img
                        src="https://img.mysignature.io/p/5/8/a/58a4c807-45e5-5cee-b65a-ab776ad737b7.png?time=1709224847"
            ...
            <tr>
                <td style="margin: 0.1px; padding: 15px 0px;">
                    <table cellpadding="0" style="border-collapse: collapse;">
                        <tr>
                            <td height="1"
                                style="margin: 0.1px; padding: 0px; border-top: 2px solid rgb(25, 32, 32); font: 1px / 1px &quot;Times New Roman&quot;, Times, serif; width: 30px;">
                            </td>
                        </tr>
                    </table>
                </td>
            ...
            <tr style="cursor: pointer;">
                <td
                    style="margin: 0.1px; padding: 1px 0px; font: 13.8px / 17.5px &quot;Times New Roman&quot;, Times, serif; color: rgb(0, 0, 1);">
                    <span style="font-weight: 600;">address:&nbsp;</span><span style="color: rgb(54, 42, 44);">84 Libron
                        st</span></td>
            </tr>
            <tr style="cursor: pointer;">
                <td
                    ...
                    <span style="font-weight: 600;">phone:&nbsp;</span><span
                        style="color: rgb(54, 42, 44); text-decoration: none; font-family: &quot;Times New Roman&quot;, Times, serif;">644
                        848 6363</span></td>
            </tr>
            <tr style="cursor: pointer;">
                <td
            ...
            <tr>
                <td
                    ...
                    <table cellpadding="0" style="border-collapse: collapse;">
                        <tr>
                            <td
                                style="margin: 0.1px; padding: 0px 5px 0px 0px; font: 13.8px / 17.5px &quot;Times New Roman&quot;, Times, serif; color: rgb(0, 0, 1); cursor: pointer;">
                                <span
                                    style="border-radius: 0%; width: 26px; height: 26px; display: block; text-align: center; background-color: rgb(204, 100, 190); font-size: 12px; font-family: initial; line-height: 1;"><svg
