<template>
    <div>
        ...
        <table cellpadding="0" width="500" style="border-collapse: collapse; font-size: 14.2px;">
                    ...
                    <table cellpadding="0" style="border-collapse: collapse;">
                        <tr>
                            <td valign="top" style="margin: 0.1px; padding: 0px 9px 0px 0px; cursor: pointer;"><img
                                    ...
                                    width="126" alt=" &quot;created with MySignature.io&quot;"
                                    style="display: block; min-width: 126px;"></td>
                            <td valign="top"
                                style="border-left: 2px solid rgb(0, 0, 1); margin: 0.1px; padding: 0px 0px 0px 9px;">
                                <table cellpadding="0" style="border-collapse: collapse;">
                                    <tr>
                                        <td
                                    ...
                                    <tr style="cursor: pointer;">
                                        <td
                                            ...
                                            <span style="color: rgb(61, 36, 7);">?&nbsp;</span><span
                                                style="color: rgb(61, 36, 7); text-decoration: none; font-family: Verdana, Geneva, sans-serif;">844-388-4309</span>
                                        </td>
                                    </tr>
                                    <tr style="cursor: pointer;">
                                        <td
                                            style="margin: 0.1px; padding: 0px; font: 14.2px / 18.1px Verdana, Geneva, sans-serif; color: rgb(0, 0, 1);">
                                            <span style="color: rgb(61, 36, 7);">?&nbsp;</span><span
                                                style="color: rgb(61, 36, 7); text-decoration: none; font-family: Verdana, Geneva, sans-serif;">mysignature.io</span>
                                        </td>
                                    </tr>
                                    <tr style="cursor: pointer;">
                                        <td
                                            style="margin: 0.1px; padding: 0px; font: 14.2px / 18.1px Verdana, Geneva, sans-serif; color: rgb(0, 0, 1);">
                                            <span style="color: rgb(61, 36, 7);">?&nbsp;</span><span
                                                style="color: rgb(61, 36, 7); text-decoration: none; font-family: Verdana, Geneva, sans-serif;">info@mysignature.io</span>
                                        </td>
                                    </tr>
                                    <tr style="cursor: pointer;">
                                        <td
                                    ...
                                    <tr>
                                        <td
                                            ...
                                            <table cellpadding="0" style="border-collapse: collapse;">
                                                <tr>
                                                    <td
                                                        style="margin: 0.1px; padding: 0px 4px 0px 0px; font: 14.2px / 18.1px Verdana, Geneva, sans-serif; color: rgb(0, 0, 1); cursor: pointer;">
                                                        <span
                                                            style="border-radius: 15%; width: 22px; height: 22px; display: block; text-align: center; background-color: rgb(249, 113, 37); font-size: 12px; font-family: initial; line-height: 1;"><svg
            ...
            <tr>
                <td
                    style="margin: 0.1px; padding: 15px 0px 0px; font: 14.2px / 18.1px Verdana, Geneva, sans-serif; color: rgb(0, 0, 1); cursor: pointer;">
                    <span><img
                            src="https://img.mysignature.io/b/e/1/0/e10d1f37-8498-5e33-8e2a-ea0c5f876941.png?time=1709565519"
                            valign="top" width="284" alt="created with MySignature.io" style="display: block;"></span>
                </td>
            </tr>
        </table>
        <div>
