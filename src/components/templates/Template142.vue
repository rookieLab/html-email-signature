    ...
    <div><!---->
                        ...
                        <table cellpadding="0" style="border-collapse: collapse;">
                            <tr>
                                <td valign="top" style="margin: 0.1px; padding: 0px 12px 0px 0px; cursor: pointer;"><img
                                        src="https://img.mysignature.io/p/c/0/a/c0a80ca5-8d9a-5d78-9ed3-4ac8f3347288.png?time=1708964601"
                                        width="124" alt=" &quot;created with MySignature.io&quot;"
                                        style="display: block; min-width: 124px;"></td>
                                <td valign="top"
                                    style="border-left: 1px solid rgb(68, 139, 153); margin: 0.1px; padding: 0px 0px 0px 12px; font: 13.6px / 17.3px &quot;Times New Roman&quot;, Times, serif; color: rgb(0, 0, 1);">
                                    <table cellpadding="0" style="border-collapse: collapse;">
                                        <tr>
                                            <td
                                        ...
                                        <tr>
                                            <td
                                                style="margin: 0.1px; padding: 0px 0px 8px; font: 13.6px / 17.3px &quot;Times New Roman&quot;, Times, serif; color: rgb(0, 0, 1);">
                                        ...
                                        <tr style="cursor: pointer;">
                                            <td
                                                ...
                                                <span
                                                    style="color: rgb(68, 139, 153); font-weight: 600;">mobile:&nbsp;</span><span
                                                    style="color: rgb(0, 0, 1); text-decoration: none; font-family: &quot;Times New Roman&quot;, Times, serif;">844-388-4309</span>
                                            </td>
                                        </tr>
                                        <tr style="cursor: pointer;">
                                            <td
                                                style="margin: 0.1px; padding: 0px; font: 13.6px / 17.3px &quot;Times New Roman&quot;, Times, serif; color: rgb(0, 0, 1);">
                                                <span
                                                    style="color: rgb(68, 139, 153); font-weight: 600;">email:&nbsp;</span><span
                                                    style="color: rgb(0, 0, 1); text-decoration: none; font-family: &quot;Times New Roman&quot;, Times, serif;">paula@mysignature.io</span>
                                            </td>
                                        </tr>
                                        <tr style="cursor: pointer;">
                                            <td
                                        ...
                                        <tr>
                                            <td
                                                ...
                                                <table cellpadding="0" style="border-collapse: collapse;">
                                                    <tr>
                                                        <td
                                                            style="margin: 0.1px; padding: 0px 5px 0px 0px; font: 13.6px / 17.3px &quot;Times New Roman&quot;, Times, serif; color: rgb(0, 0, 1); cursor: pointer;">
                                                            <span
                                                                style="border-radius: 15%; width: 23px; height: 23px; display: block; text-align: center; background-color: rgb(240, 140, 6); font-size: 12px; font-family: initial; line-height: 1;"><svg
        ...
        <div>
            <table width="500" cellpadding="0" style="border-collapse: collapse;">
                <tr>
                    <td style="padding: 16px 10px 0px 0px; margin: 0.1px; cursor: pointer;"><span><img
                                alt="Come get your vision checked"
                                src="https://img.mysignature.io/a/v1/9/7/f/97f68568-7bde-5d19-90ca-71c8caad0cc4.png"
                                style="max-width: 490px; display: block;" width="232"></span></td>
                </tr>
            </table>
            <table width="500" cellpadding="0" style="border-collapse: collapse;">
                <tr style="cursor: pointer;">
                    <td width="30" style="padding: 15px 0px 0px; margin: 0.1px;"><img
                            src="https://img.mysignature.io/addons/v2/green-earth.png"
