        ...
        <table cellpadding="0" width="500" style="border-collapse: collapse; font-size: 14.4px;">
                    ...
                    <table cellpadding="0" style="border-collapse: collapse;">
                        <tr>
                            <td valign="top" style="margin: 0.1px; padding: 0px 15px 0px 0px; cursor: pointer;"><img
                                    src="https://img.mysignature.io/p/c/a/a/caafa683-54ec-5ae4-88ba-de0bc1aa1fac.png?time=1685569257"
                            ...
                            <td valign="top" style="margin: 0.1px; padding: 0px;">
                                <table cellpadding="0" style="border-collapse: collapse;">
                                    <tr>
                                        <td
                                            style="margin: 0.1px; padding: 0px 0px 2px; font: 17.3px / 22.1px Arial, Helvetica, sans-serif; color: rgb(0, 0, 1); cursor: pointer;">
                                            <span
                                                style="font-weight: 600; color: rgb(92, 216, 237); cursor: pointer;">DILLON
                                                CAMRY</span><!----><!----></td>
                                    </tr>
                                    <tr>
                                        <td
                                            style="margin: 0.1px; padding: 0px 0px 8px; font: 600 14.4px / 18.3px Arial, Helvetica, sans-serif; color: rgb(0, 0, 1);">
                                            <span style="cursor: pointer;">Owner at</span>&nbsp;<span
                                                style="cursor: pointer;">Financial Consulting</span></td>
                                    </tr>
                                    <tr style="cursor: pointer;">
                                        <td
                                            ...
                                            <!----><span
                                                ...
                                                style="color: rgb(0, 0, 1); text-decoration: none; font-family: Arial, Helvetica, sans-serif;">dc@mysignature.io</span>
                                        </td>
                                    </tr>
                                    <tr style="cursor: pointer;">
                                        <td
                                    ...
                                    <tr>
                                        <td
                                            style="margin: 0.1px; padding: 10px 0px 0px; font: 14.4px / 18.3px Arial, Helvetica, sans-serif; color: rgb(0, 0, 1);">
                                            <table cellpadding="0" style="border-collapse: collapse;">
                                                <tr>
                                                    <td
                                                        style="margin: 0.1px; padding: 0px 4px 0px 0px; font: 14.4px / 18.3px Arial, Helvetica, sans-serif; color: rgb(0, 0, 1); cursor: pointer;">
                                                        <span
                                                            style="border-radius: 15%; width: 22px; height: 22px; display: block; text-align: center; background-color: rgb(92, 216, 237); font-size: 12px; font-family: initial; line-height: 1;"><svg
            ...
            <tr>
                <td
                    ...
                    <span><img
                            src="https://img.mysignature.io/b/c/a/a/caafa683-54ec-5ae4-88ba-de0bc1aa1fac.png?time=1685569257"
                            valign="top" width="435" alt="created with MySignature.io" style="display: block;"></span>
                </td>
            </tr>
        </table>
        <div>
            <table width="500" cellpadding="0" style="border-collapse: collapse;">
                <tr>
                    <td
                        style="margin: 0.1px; padding: 15px 0px 0px; font: 12.1px / 15.3px Arial, Helvetica, sans-serif; color: rgb(186, 198, 217); cursor: pointer;">
