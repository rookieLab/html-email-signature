<template>
    <div>
        ...
        <table cellpadding="0" style="border-collapse: collapse; font-size: 13.3px; background-color: rgb(15, 31, 56);">
            <tr>
                <td
                    style='margin: 0.1px; padding: 20px 20px 0px; font: 13.3px / 16.9px "Times New Roman", Times, serif; color: rgb(0, 0, 1);'>
                        ...
                        <tr>
                            ...
                            <td style='margin: 0.1px; padding: 0px; font: 13.3px / 16.9px "Times New Roman", Times, serif; color: rgb(0, 0, 1);'
                                ...
                                <table cellpadding="0" style="border-collapse: collapse;">
                                    ...
                                    <tr>
                                        <td align="left"
                                            style="margin: 0.1px; padding: 5px 0px;text-transform: uppercase;" :style="{
                                                ...textStyle,
                                    ...
                                    <tr>
                                        <td
                                            style='margin: 0.1px; padding: 10px 0px 0px; font: 13.3px / 16.9px "Times New Roman", Times, serif; color: rgb(255, 255, 255);'>
                                            <span
                                                style="color: rgb(255, 255, 255); font-weight: 600; cursor: pointer;">Book
                                                a call</span><span
                                                style="color: rgb(255, 255, 255); font-weight: 600; cursor: pointer;"></span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td
                                            style='margin: 0.1px; padding: 10px 0px 0px; font: 13.3px / 16.9px "Times New Roman", Times, serif; color: rgb(0, 0, 1);'>
                                            <table cellpadding="0" style="border-collapse: collapse;">
                                                <tr>
                                                    <td
                                                        style='margin: 0.1px; padding: 0px 5px 0px 0px; font: 13.3px / 16.9px "Times New Roman", Times, serif; color: rgb(0, 0, 1); cursor: pointer;'>
                                                        <span
                                                            style="border-radius: 0%; width: 28px; height: 28px; display: block; text-align: center; background-color: rgb(15, 31, 56); font-size: 12px; font-family: initial; line-height: 1;"><svg
            ...
            <Banner :data="editing?.Image" type="tr" :styles="{ padding: '15px 20px 20px' }"></Banner>
        </table>
        <div>
