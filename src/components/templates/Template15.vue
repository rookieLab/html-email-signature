        ...
        <table cellpadding="0" style="border-collapse: collapse; font-size: 13.6px;" width="500">
            <tr>
                <td style="margin: 0.1px; padding: 0px;">
                    <table cellpadding="0" style="border-collapse: collapse;">
                        <tr>
                            <td style="margin: 0.1px; padding: 0px 20px 0px 0px; border-right: 2px solid rgb(0, 0, 1);"
                                valign="middle">
                                <table cellpadding="0" style="border-collapse: collapse;">
                                    <tr>
                                        <td align="center"
                                ...
                                <table cellpadding="0" style="border-collapse: collapse;">
                                    ...
                                    <tr style="cursor: pointer;">
                                        <td
                                            ...
                                            <!-- --><span style="color: rgb(14, 14, 40);">Rochester,
                                                Minnesota, USA</span>
                                        </td>
                                    </tr>
                                    <tr>
                                                ...
                                                <tr>
                                                    <td
                                                        ...
                                                        <table cellpadding="0" style="border-collapse: collapse;">
                                                            <tr>
                                                                <td
                                                                    style='margin: 0.1px; padding: 0px 4px 0px 0px; font: 13.6px / 17.3px "Arial Black", Gadget, sans-serif; color: rgb(0, 0, 1); cursor: pointer;'>
                                                                    <span
                                                                        style="border-radius: 15%; width: 26px; height: 26px; display: block; text-align: center; background-color: rgb(0, 0, 1); font-size: 12px; font-family: initial; line-height: 1;"><svg
