                        ...
                        <tr><!---->
                            <td valign="top" style="margin: 0.1px; padding: 0px;">
                                <table cellpadding="0" style="border-collapse: collapse;">
                                    ...
                                    <tr>
                                        <td
                                            style="margin: 0.1px; padding: 0px 0px 8px; font: 600 13.4px / 17.1px &quot;Palatino Linotype&quot;, &quot;Book Antiqua&quot;, Palatino, serif; color: rgb(0, 0, 1);">
                                            <span style="cursor: pointer;">Logistics manager at</span>&nbsp;<span
                                                style="cursor: pointer;">GetDelivered</span></td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td
                                            ...
                                            <table cellpadding="0" style="border-collapse: collapse;">
                                                <tr>
                                                    <td
                                                        style="margin: 0.1px; padding: 0px 4px 0px 0px; font: 13.4px / 17.1px &quot;Palatino Linotype&quot;, &quot;Book Antiqua&quot;, Palatino, serif; color: rgb(0, 0, 1); cursor: pointer;">
                                                        <span
                                                            style="border-radius: 15%; width: 20px; height: 20px; display: block; text-align: center; background-color: rgb(126, 211, 33); font-size: 12px; font-family: initial; line-height: 1;"><svg
            ...
            <table cellpadding="0" width="500"
                ...
                <tr style="cursor: pointer;">
                    <td width="34" height="34" align="center"
                        style="padding: 16px 0px 0px; margin: 0.1px; min-width: 34px;"><svg viewBox="0 0 666 1024"
