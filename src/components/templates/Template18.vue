            ...
            <tr>
                <td style="margin: 0.1px; padding: 15px 0px;">
                    <table cellpadding="0" style="border-collapse: collapse;">
                        <tr>
                            <td height="1"
                                style="margin: 0.1px; padding: 0px; border-top: 2px solid rgb(0, 0, 1); font: 1px / 1px Georgia, serif; width: 30px;">
                            </td>
                        </tr>
                    </table>
                </td>
                    ...
                    <table cellpadding="0" style="border-collapse: collapse;">
                        <tr>
                            <td
                                ...
                                <span
                                    style="border-radius: 15%; width: 33px; height: 33px; display: block; text-align: center; background-color: rgb(255, 255, 255); font-size: 12px; font-family: initial; line-height: 1;"><svg
                                        style="position: relative; top: 6.6px; width: 19.8px;" viewbox="0 0 1024 1024"
                            ...
                            <td
                                ...
                                <span
                                    style="border-radius: 15%; width: 33px; height: 33px; display: block; text-align: center; background-color: rgb(255, 255, 255); font-size: 12px; font-family: initial; line-height: 1;"><svg
                                        style="position: relative; top: 6.6px; width: 19.8px;" viewbox="0 0 1053 1024"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
