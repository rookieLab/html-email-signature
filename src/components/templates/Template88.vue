...
<tr><!-- -->
<td style='margin: 0.1px; padding: 0px; font: 11.8px / 15.1px "Palatino Linotype", "Book Antiqua", Palatino, serif; color: rgb(0, 0, 1);' valign="middle">
<table cellpadding="0" style="border-collapse: collapse;">
<tr>
<td style="margin: 0.1px; padding: 4px 15px 0px 0px; cursor: pointer;">
<span style="border-radius: 50%; width: 20px; height: 20px; display: block; text-align: center; background-color: rgb(0, 0, 0); font-size: 12px; font-family: initial; line-height: 1;"><svg style="position: relative; top: 4px; width: 12px;" viewbox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg">
...
<table cellpadding="0" style="border-collapse: collapse;">
<tr>
<td style='margin: 0.1px; padding: 0px 0px 2px; font: 14.2px / 18.1px "Palatino Linotype", "Book Antiqua", Palatino, serif; color: rgb(0, 0, 1);'>
<span style="color: rgb(0, 0, 0); font-weight: 600; cursor: pointer;">Olivia
                                                                                Anderson</span><!-- --><!-- -->
</td>
</tr>
<tr>
<td style='margin: 0.1px; padding: 0px 0px 5px; font: 11.8px / 15.1px "Palatino Linotype", "Book Antiqua", Palatino, serif; color: rgb(0, 46, 255);'>
<span style="cursor: pointer;"></span><!-- --><span style="cursor: pointer;">Real
                                                                                Estate
                                                                                Broker</span>
</td>
</tr>
<tr style="cursor: pointer;">
<td style='margin: 0.1px; padding: 1px 0px; font: 11.8px / 15.1px "Palatino Linotype", "Book Antiqua", Palatino, serif; color: rgb(0, 46, 255);'>
<span>w: </span><span style='color: rgb(0, 46, 255); text-decoration: none; font-family: "Palatino Linotype", "Book Antiqua", Palatino, serif;'>mysignature.io</span>, <span>e: </span><span style='color: rgb(0, 46, 255); text-decoration: none; font-family: "Palatino Linotype", "Book Antiqua", Palatino, serif;'>olivia@mysignature.io</span>
</td>
</tr>
<tr style="cursor: pointer;">
<td style='margin: 0.1px; padding: 1px 0px; font: 11.8px / 15.1px "Palatino Linotype", "Book Antiqua", Palatino, serif; color: rgb(0, 46, 255);'>
<span>m: </span><span style='color: rgb(0, 46, 255); text-decoration: none; font-family: "Palatino Linotype", "Book Antiqua", Palatino, serif;'>+1
                                                                                373 947
                                                                                3340</span><!-- --><!-- -->
</td>
</tr>
<tr style="cursor: pointer;">
<td style='margin: 0.1px; padding: 1px 0px; font: 11.8px / 15.1px "Palatino Linotype", "Book Antiqua", Palatino, serif; color: rgb(0, 46, 255);'>
<span>a: </span><span style="color: rgb(0, 46, 255);">649
                                                                                E Girard
                                                                                Ave Englewood, CO
                                                                                80113</span><!-- --><!-- -->
</td>
