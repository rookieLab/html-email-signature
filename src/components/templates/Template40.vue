                                ...
                                <table cellpadding="0" style="border-collapse: collapse;">
                                    ...
                                    <tr style="cursor: pointer;">
                                        <td
                                            ...
                                            <span style="color: rgb(157, 154, 146); font-weight: 600;">e: </span><span
                                    ...
                                    <tr style="cursor: pointer;">
                                        <td
                                            style='margin: 0.1px; padding: 2px 0px; font: 12.8px / 16.3px "Courier New", Courier, monospace; color: rgb(0, 0, 1);'>
                                            <span style="color: rgb(157, 154, 146); font-weight: 600;">w: </span><span
                                    ...
                                    <tr style="cursor: pointer;">
                                        <td
                                            style='margin: 0.1px; padding: 2px 0px; font: 12.8px / 16.3px "Courier New", Courier, monospace; color: rgb(0, 0, 1);'>
                                            <span style="color: rgb(157, 154, 146); font-weight: 600;">p: </span><span
                                    ...
                                    <tr style="cursor: pointer;">
                                        <td
                                            style='margin: 0.1px; padding: 2px 0px; font: 12.8px / 16.3px "Courier New", Courier, monospace; color: rgb(0, 0, 1);'>
                                            <span style="color: rgb(157, 154, 146); font-weight: 600;">a: </span><span
