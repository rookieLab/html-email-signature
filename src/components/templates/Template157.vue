        ...
        <table cellpadding="0" style="border-collapse: collapse;">
            <tr>
                <td style="margin: 0.1px; padding: 10px 0px; cursor: pointer;"><img width="500"
                        src="https://img.mysignature.io/a/v1/d/c/6/dc6c3afe-8ae9-57fa-bc35-ffec811f3c1f.png"
                        alt="Best wishes,"></td>
            </tr>
        </table>
                    ...
                    <table cellpadding="0" style="border-collapse: collapse;">
                        <tr>
                            <td valign="middle" style="margin: 0.1px; padding: 0px 15px 0px 0px; cursor: pointer;"><img
                                    src="https://img.mysignature.io/p/9/0/1/9018d181-a5e4-53a5-b941-797ba9d1615b.png?time=1709213817"
                                    width="102" alt=" &quot;created with MySignature.io&quot;"
                                    style="display: block; min-width: 102px;"></td>
                            <td valign="middle"
                                style="margin: 0.1px; padding: 0px; font: 13.8px / 17.5px &quot;Courier New&quot;, Courier, monospace; color: rgb(0, 0, 1);">
                                <table cellpadding="0" style="border-collapse: collapse;">
                                    <tr>
                                        <td style="margin: 0.1px; padding: 4px 15px 0px 0px; cursor: pointer;"><span
                                                style="border-radius: 50%; width: 23px; height: 23px; display: block; text-align: center; background-color: rgb(245, 221, 89); font-size: 12px; font-family: initial; line-height: 1;"><svg
            ...
            <table width="500" cellspacing="0" cellpadding="0" border="0">
                <tr>
                    <td style="margin: 0.1px; padding-top: 10px; cursor: pointer;"><span><img
                                src="https://img.mysignature.io/b/9/0/1/9018d181-a5e4-53a5-b941-797ba9d1615b.png?time=1709213817"
                                valign="top" width="389" alt="created with MySignature.io"
