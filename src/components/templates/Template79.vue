        ...
        <table cellpadding="0" style="border-collapse: collapse;">
            <tr>
                <td style="margin: 0.1px; padding: 10px 0px; cursor: pointer;"><img width="500"
                        src="https://img.mysignature.io/a/v1/0/d/b/0db73bcb-d8c3-56bf-9bf2-71baa4a4bc31.png"
                        alt="Kind regards,"></td>
            </tr>
        </table>
        <table cellpadding="0"
            style="border-collapse: collapse; font-size: 12.8px; background-color: rgb(245, 212, 245);">
            <tr>
                <td
                    style="margin: 0.1px; padding: 20px; font: 12.8px / 16.3px Verdana, Geneva, sans-serif; color: rgb(0, 0, 1);">
                    <table cellpadding="0" style="border-collapse: collapse;">
                        <tr>
                            <td valign="top" style="margin: 0.1px; padding: 0px 15px 0px 0px; cursor: pointer;"><img
                                    src="https://img.mysignature.io/p/9/c/d/9cda2103-860f-5c2e-b3dc-1a3b4bda0b80.png?time=1709287065"
                                    width="116" alt=" &quot;created with MySignature.io&quot;"
                                    style="display: block; min-width: 116px;"></td>
                            <td valign="top"
                                style="margin: 0.1px; padding: 0px; font: 12.8px / 16.3px Verdana, Geneva, sans-serif; color: rgb(0, 0, 1);">
                                <table cellpadding="0" style="border-collapse: collapse;">
                                    <tr>
                                        <td
                                    ...
                                    <tr>
                                        <td
                                            ...
                                            <table cellpadding="0" style="border-collapse: collapse;">
                                                <tr>
                                                    <td
                                                        style="margin: 0.1px; padding: 0px 5px 0px 0px; font: 12.8px / 16.3px Verdana, Geneva, sans-serif; color: rgb(0, 0, 1); cursor: pointer;">
                                                        <span
                                                            style="border-radius: 0%; width: 30px; height: 30px; display: block; text-align: center; background-color: rgb(245, 212, 245); font-size: 12px; font-family: initial; line-height: 1;"><svg
            ...
            <table width="500" cellspacing="0" cellpadding="0" border="0">
                <tr>
                    <td style="margin: 0.1px; padding-top: 10px; cursor: pointer;"><span><img
                                src="https://img.mysignature.io/b/9/c/d/9cda2103-860f-5c2e-b3dc-1a3b4bda0b80.png?time=1709287065"
                                valign="top" width="320" alt="created with MySignature.io"
