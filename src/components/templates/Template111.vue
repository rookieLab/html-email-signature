<template>
    <div><!---->
        <table cellpadding="0" width="500" style="border-collapse: collapse; font-size: 14.4px;">
                    ...
                    <table cellpadding="0" style="border-collapse: collapse;">
                        <tr>
                            <td valign="top" style="margin: 0.1px; padding: 0px 9px 0px 0px; cursor: pointer;"><img
                                    src="https://img.mysignature.io/p/1/2/7/12794976-051e-5b58-a5e3-93f13fb5eb1f.png?time=1685569257"
                                    width="139" alt=" &quot;created with MySignature.io&quot;"
                                    style="display: block; min-width: 139px;"></td>
                            <td valign="top"
                                style="border-left: 2px solid rgb(246, 68, 64); margin: 0.1px; padding: 0px 0px 0px 9px;">
                                <table cellpadding="0" style="border-collapse: collapse;">
                                    <tr>
                                        <td
                                            ...
                                            <table cellpadding="0" style="border-collapse: collapse;">
                                                <tr>
                                                    <td
                                                        ...
                                                        <span
                                                            style="border-radius: 15%; width: 27px; height: 27px; display: block; text-align: center; background-color: rgb(255, 255, 255); font-size: 12px; font-family: initial; line-height: 1;"><svg
            ...
            <tr>
                <td
                    style="margin: 0.1px; padding: 15px 0px 0px; font: 14.4px / 18.3px Verdana, Geneva, sans-serif; color: rgb(0, 0, 1); cursor: pointer;">
                    <span><img
                            src="https://img.mysignature.io/b/1/2/7/12794976-051e-5b58-a5e3-93f13fb5eb1f.png?time=1685569257"
                            valign="top" width="337" alt="created with MySignature.io" style="display: block;"></span>
                </td>
            </tr>
        </table>
        <div><!---->
