...
<span style="border-radius: 15%; width: 22px; height: 22px; display: block; text-align: center; background-color: rgb(52, 73, 93); font-size: 12px; font-family: initial; line-height: 1;"><svg style="position: relative; top: 4.4px; width: 13.2px;" viewbox="0 0 1053 1024" xmlns="http://www.w3.org/2000/svg">
...
<tr>
<td style="margin: 0.1px; padding: 4px 15px 0px 0px; cursor: pointer;">
<span style="border-radius: 15%; width: 22px; height: 22px; display: block; text-align: center; background-color: rgb(52, 73, 93); font-size: 12px; font-family: initial; line-height: 1;"><svg style="position: relative; top: 4.4px; width: 13.2px;" viewbox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg">
...
<table cellpadding="0" style="border-collapse: collapse;">
<tr>
<td style="margin: 0.1px; padding: 0px 0px 2px; font: 17.3px / 22.1px Arial, Helvetica, sans-serif; color: rgb(0, 0, 1);">
<span style="color: rgb(53, 54, 61); font-weight: 600; cursor: pointer;">Justin
                                                                                Mccullough</span><!-- --><!-- -->
</td>
</tr>
<tr>
...
<span style="cursor: pointer;">Personal
                                                                                Assistant
                                                                                at</span> <span style="cursor: pointer;">Zenith
                                                                                microsystems</span>
</td>
</tr>
<tr style="cursor: pointer;">
<td style="margin: 0.1px; padding: 1px 0px; font: 14.4px / 18.3px Arial, Helvetica, sans-serif; color: rgb(0, 0, 1);">
<!-- --><span style="color: rgb(0, 0, 1); text-decoration: none; font-family: Arial, Helvetica, sans-serif;">+809-890-75</span>, <!-- --><span style="color: rgb(0, 0, 1); text-decoration: none; font-family: Arial, Helvetica, sans-serif;">mysignature.io</span>
</td>
</tr>
<tr style="cursor: pointer;">
<td style="margin: 0.1px; padding: 1px 0px; font: 14.4px / 18.3px Arial, Helvetica, sans-serif; color: rgb(0, 0, 1);">
<!-- --><span style="color: rgb(0, 0, 1);">984
                                                                                E
                                                                                9th St, Stuart, FL
                                                                                36780</span><!-- --><!-- -->
</td>
