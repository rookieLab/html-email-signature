                    ...
                    <table cellpadding="0" style="border-collapse: collapse;">
                        <tr>
                            <td valign="middle" style="margin: 0.1px; padding: 0px 15px 0px 0px; cursor: pointer;"><img
                                    src="https://img.mysignature.io/p/c/f/1/cf188c51-6819-5d3c-99ce-8b399123d99b.png?time=1685569257"
                                ...
                                <table cellpadding="0" style="border-collapse: collapse;">
                                    <tr>
                                        <td style="margin: 0.1px; padding: 4px 15px 0px 0px; cursor: pointer;"><span
                                                style="border-radius: 15%; width: 22px; height: 22px; display: block; text-align: center; background-color: rgb(52, 73, 93); font-size: 12px; font-family: initial; line-height: 1;"><svg
                                ...
                                <table cellpadding="0" style="border-collapse: collapse;">
                                    ...
                                    <tr>
                                        <td
                                            ...
                                            <span style="cursor: pointer;">Personal Assistant at</span>&nbsp;<span
                                                style="cursor: pointer;">Zenith microsystems</span></td>
                                    </tr>
            ...
            <table width="500" cellpadding="0" style="border-collapse: collapse;"><!---->
                <tr>
                    <td style="padding: 5px 0px 0px; margin: 0.1px; cursor: pointer;"><span><img
                                ...
                                alt="Meet me on Google Meet" width="219" style="display: block;"></span></td>
                </tr>
            </table>
            <table width="500" cellpadding="0" style="border-collapse: collapse;">
                <tr style="cursor: pointer;">
