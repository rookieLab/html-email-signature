                                ...
                                <table cellpadding="0" style="border-collapse: collapse;">
                                    ...
                                    <tr>
                                        <td
                                            ...
                                            <span style="cursor: pointer;">Apollo Hospital</span><!----><!----></td>
                                    </tr>
                                            ...
                                            <table cellpadding="0" style="border-collapse: collapse;">
                                                <tr>
                                                    <td
                                                        ...
                                                        <span
                                                            style="border-radius: 50%; width: 26px; height: 26px; display: block; text-align: center; background-color: rgb(231, 241, 255); font-size: 12px; font-family: initial; line-height: 1;"><svg
            ...
            <table width="500" cellspacing="0" cellpadding="0" border="0">
                <tr>
                    <td style="margin: 0.1px; padding-top: 10px; cursor: pointer;"><span><img
                                ...
                                valign="top" width="321" alt="created with MySignature.io"
