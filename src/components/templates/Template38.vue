            ...
            <table cellpadding="0" style="border-collapse: collapse; font-size: 14.6px;" width="500">
                <tr>
                    <td style="margin: 0.1px; padding: 0px;">
                        <table cellpadding="0" style="border-collapse: collapse;">
                            <tr><!-- -->
                                <td style='border-left: 1px solid rgb(255, 189, 0); margin: 0.1px; padding: 0px 0px 0px 12px; font: 14.6px / 18.5px "Courier New", Courier, monospace; color: rgb(0, 0, 1);'
                                    valign="top">
                                    <table cellpadding="0" style="border-collapse: collapse;">
                                        <tr>
                                            <td
                                        ...
                                        <tr style="cursor: pointer;">
                                            <td
                                                ...
                                                <span style="color: rgb(255, 189, 0); font-weight: 600;">w: </span><span
                                        ...
                                        <tr style="cursor: pointer;">
                                            <td
                                                style='margin: 0.1px; padding: 0px; font: 14.6px / 18.5px "Courier New", Courier, monospace; color: rgb(0, 0, 1);'>
                                                <span style="color: rgb(255, 189, 0); font-weight: 600;">e: </span><span
                                        ...
                                        <tr>
                                            <td
                                                ...
                                                <table cellpadding="0" style="border-collapse: collapse;">
                                                    <tr>
                                                        <td
                                                            style='margin: 0.1px; padding: 0px 5px 0px 0px; font: 14.6px / 18.5px "Courier New", Courier, monospace; color: rgb(0, 0, 1); cursor: pointer;'>
                                                            <span
                                                                style="border-radius: 50%; width: 22px; height: 22px; display: block; text-align: center; background-color: rgb(0, 174, 76); font-size: 12px; font-family: initial; line-height: 1;"><svg
