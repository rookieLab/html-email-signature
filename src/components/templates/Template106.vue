                        ...
                        <table cellpadding="0" style="border-collapse: collapse;">
                            <tr>
                                <td valign="top" style="margin: 0.1px; padding: 0px 12px 0px 0px; cursor: pointer;"><img
                                        src="https://img.mysignature.io/p/3/7/4/374d76d2-645d-5c2a-97e1-6f22b28304a0.png?time=1685569257"
                                        width="131" alt=" &quot;created with MySignature.io&quot;"
                                        style="display: block; min-width: 131px;"></td>
                                <td valign="top"
                                    style="border-left: 1px solid rgb(77, 54, 54); margin: 0.1px; padding: 0px 0px 0px 12px; font: 14.4px / 18.3px &quot;Palatino Linotype&quot;, &quot;Book Antiqua&quot;, Palatino, serif; color: rgb(0, 0, 1);">
                                    <table cellpadding="0" style="border-collapse: collapse;">
                                        <tr>
                                            <td
                                                style="margin: 0.1px; padding: 0px 0px 8px; font: 18.7px / 23.8px &quot;Palatino Linotype&quot;, &quot;Book Antiqua&quot;, Palatino, serif; color: rgb(0, 0, 1);">
                                                <span
                                                    style="font-weight: 600; color: rgb(77, 54, 54); cursor: pointer;">Aditi
                                                    Cline</span><!----><!----></td>
                                        </tr>
                                        <tr>
                                            <td
                                                style="margin: 0.1px; padding: 0px 0px 8px; font: 14.4px / 18.3px &quot;Palatino Linotype&quot;, &quot;Book Antiqua&quot;, Palatino, serif; color: rgb(0, 0, 1);">
                                                <!----><!----><span
                                                    style="color: rgb(0, 0, 1); cursor: pointer;">Theater
                                                    Actress</span><!----><!----></td>
                                        </tr>
                                        <tr style="cursor: pointer;">
                                            <td
                                                ...
                                                <span
                                                    style="color: rgb(77, 54, 54); font-weight: 600;">phone:&nbsp;</span><span
                                                    style="color: rgb(0, 0, 1); text-decoration: none; font-family: &quot;Palatino Linotype&quot;, &quot;Book Antiqua&quot;, Palatino, serif;">+5-70-70-398</span>
                                            </td>
                                        </tr>
                                        <tr style="cursor: pointer;">
                                            <td
                                                style="margin: 0.1px; padding: 0px; font: 14.4px / 18.3px &quot;Palatino Linotype&quot;, &quot;Book Antiqua&quot;, Palatino, serif; color: rgb(0, 0, 1);">
                                                <span
                                                    style="color: rgb(77, 54, 54); font-weight: 600;">email:&nbsp;</span><span
                                                    style="color: rgb(0, 0, 1); text-decoration: none; font-family: &quot;Palatino Linotype&quot;, &quot;Book Antiqua&quot;, Palatino, serif;">cline@mysignature.io</span>
                                            </td>
                                        </tr><!---->
                                        <tr>
                                            <td
                                                style="margin: 0.1px; padding: 12px 0px 0px; font: 14.4px / 18.3px &quot;Palatino Linotype&quot;, &quot;Book Antiqua&quot;, Palatino, serif; color: rgb(0, 0, 1);">
                                                <table cellpadding="0" style="border-collapse: collapse;">
                                                    <tr>
                                                        <td
                                                            style="margin: 0.1px; padding: 0px 5px 0px 0px; font: 14.4px / 18.3px &quot;Palatino Linotype&quot;, &quot;Book Antiqua&quot;, Palatino, serif; color: rgb(0, 0, 1); cursor: pointer;">
                                                            <span
                                                                style="border-radius: 0%; width: 22px; height: 22px; display: block; text-align: center; background-color: rgb(153, 153, 153); font-size: 12px; font-family: initial; line-height: 1;"><svg
