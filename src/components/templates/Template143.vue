<template>
    <div><!---->
        <table cellpadding="0" width="500" style="border-collapse: collapse; font-size: 12.8px;">
                    ...
                    <table cellpadding="0" style="border-collapse: collapse;">
                        <tr>
                            <td valign="top" style="margin: 0.1px; padding: 0px; cursor: pointer;"><img
                                    src="https://img.mysignature.io/p/d/7/2/d725e4d5-f8d2-5e8d-b7b3-eecad0862787.png?time=1709030107"
                                    width="105" alt=" &quot;created with MySignature.io&quot;"
                                    style="display: block; min-width: 105px;"></td>
                            <td valign="top"
                                style="margin: 0.1px; padding: 0px 0px 0px 15px; font: 12.8px / 16.3px &quot;Palatino Linotype&quot;, &quot;Book Antiqua&quot;, Palatino, serif; color: rgb(0, 0, 1);">
                                <table cellpadding="0" style="border-collapse: collapse;">
                                    <tr>
                                        <td
                                    ...
                                    <tr>
                                        <td
                                            style="margin: 0.1px; padding: 0px 0px 5px; font: 12.8px / 16.3px &quot;Palatino Linotype&quot;, &quot;Book Antiqua&quot;, Palatino, serif; color: rgb(0, 0, 1);">
                                            <span style="cursor: pointer;"><span
                                                    style="color: rgb(54, 64, 64);">Employment Lawyer
                                                    |</span></span>&nbsp;<span style="cursor: pointer;"><span
                                                    style="color: rgb(54, 64, 64);">Attorney Association</span></span>
                                        </td>
                                    </tr>
                                    <tr style="cursor: pointer;">
                                        <td
                                            ...
                                            <span style="color: rgb(154, 86, 5); font-weight: 600;">▪︎&nbsp;</span><span
                                                style="color: rgb(54, 64, 64); text-decoration: none; font-family: &quot;Palatino Linotype&quot;, &quot;Book Antiqua&quot;, Palatino, serif;">adam@attorney.io</span>
                                        </td>
                                    </tr>
                                    <tr style="cursor: pointer;">
                                        <td
                                            style="margin: 0.1px; padding: 2px 0px; font: 12.8px / 16.3px &quot;Palatino Linotype&quot;, &quot;Book Antiqua&quot;, Palatino, serif; color: rgb(0, 0, 1);">
                                            <span style="color: rgb(154, 86, 5); font-weight: 600;">▪︎&nbsp;</span><span
                                                style="color: rgb(54, 64, 64); text-decoration: none; font-family: &quot;Palatino Linotype&quot;, &quot;Book Antiqua&quot;, Palatino, serif;">545-567-5634</span>
                                        </td>
                                    </tr>
                                    <tr style="cursor: pointer;">
                                        <td
                                            style="margin: 0.1px; padding: 2px 0px; font: 12.8px / 16.3px &quot;Palatino Linotype&quot;, &quot;Book Antiqua&quot;, Palatino, serif; color: rgb(0, 0, 1);">
                                            <span style="color: rgb(154, 86, 5); font-weight: 600;">▪︎&nbsp;</span><span
                                                style="color: rgb(54, 64, 64); text-decoration: none; font-family: &quot;Palatino Linotype&quot;, &quot;Book Antiqua&quot;, Palatino, serif;">mysignature.io</span>
                                        </td>
                                    </tr>
                                    <tr style="cursor: pointer;">
                                        <td
                                    ...
                                    <tr>
                                        <td
                                            ...
                                            <table cellpadding="0" style="border-collapse: collapse;">
                                                <tr>
                                                    <td
                                                        style="margin: 0.1px; padding: 0px 4px 0px 0px; font: 12.8px / 16.3px &quot;Palatino Linotype&quot;, &quot;Book Antiqua&quot;, Palatino, serif; color: rgb(0, 0, 1); cursor: pointer;">
                                                        <span
                                                            style="border-radius: 0%; width: 22px; height: 22px; display: block; text-align: center; background-color: rgb(154, 86, 5); font-size: 12px; font-family: initial; line-height: 1;"><svg
            ...
            <tr>
                <td
                    style="margin: 0.1px; padding: 15px 0px 0px; font: 12.8px / 16.3px &quot;Palatino Linotype&quot;, &quot;Book Antiqua&quot;, Palatino, serif; color: rgb(0, 0, 1); cursor: pointer;">
                    <img src="https://img.mysignature.io/b/d/7/2/d725e4d5-f8d2-5e8d-b7b3-eecad0862787.png?time=1709030107"
                        valign="top" width="454" alt="created with MySignature.io" style="display: block;"></td>
            </tr>
        </table>
        <div>
