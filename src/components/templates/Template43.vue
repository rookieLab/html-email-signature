            ...
            <tr>
                <td style="margin: 0.1px; padding: 0px;">
                    <table cellpadding="0" style="border-collapse: collapse;">
                        <tr>
                            <td style="margin: 0.1px; padding: 0px 20px 0px 0px; border-right: 3px solid rgb(130, 155, 142);"
                                valign="top">
                                <table cellpadding="0" style="border-collapse: collapse;">
                                    <tr>
                                        <td
                                ...
                                <table cellpadding="0" style="border-collapse: collapse;">
                                    <tr style="cursor: pointer;">
                                        <td
                                            ...
                                            <span style="color: rgb(130, 155, 142); font-weight: 600;">A  </span><span
                                                style="color: rgb(0, 0, 1);">55
                                                Halsey St
                                                Brooklyn,
                                                NY</span>  <span
                                    ...
                                    <tr style="cursor: pointer;">
                                        <td
                                            ...
                                            <span style="color: rgb(130, 155, 142); font-weight: 600;">E  </span><span
