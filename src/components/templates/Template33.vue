    ...
    <div><!---->
                                    ...
                                    <tr>
                                        <td align="center"
                                            style="margin: 0.1px; padding: 0px 0px 10px; cursor: pointer;"><img
                                                ...
                                                style="display: block; min-width: 100px; margin: 0px auto;"></td>
                                    </tr>
                                    <tr>
                                        <td align="center"
        ...
        <div>
            <table width="500" cellpadding="0" style="border-collapse: collapse;">
                <tr>
                    <td style="padding: 21px 10px 0px 0px; margin: 0.1px; cursor: pointer;"><span><img
                                alt="Watch school video tour"
