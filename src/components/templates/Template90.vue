                    ...
                    <table cellpadding="0" style="border-collapse: collapse;">
                        <tr>
                            <td valign="top" style="margin: 0.1px; padding: 0px;">
                                <table cellpadding="0" style="border-collapse: collapse;">
                                    ...
                                    <tr style="cursor: pointer;">
                                        <td
                                            style="margin: 0.1px; padding: 1px 0px; font: 14.6px / 18.5px &quot;Courier New&quot;, Courier, monospace; color: rgb(0, 0, 0);">
                                            <span style="color: rgb(0, 0, 0);">e:&nbsp;</span><span
                                                style="color: rgb(0, 0, 0); text-decoration: none; font-family: &quot;Courier New&quot;, Courier, monospace;">david@mysignature.io</span>
                                        </td>
                                    </tr>
                                    <tr style="cursor: pointer;">
                                        <td
                                    ...
                                    <tr>
                                        <td
                                            ...
                                            <table cellpadding="0" style="border-collapse: collapse;">
                                                <tr>
                                                    <td
                                                        style="margin: 0.1px; padding: 0px 4px 0px 0px; font: 14.6px / 18.5px &quot;Courier New&quot;, Courier, monospace; color: rgb(0, 0, 1); cursor: pointer;">
                                                        <span
                                                            style="border-radius: 15%; width: 21px; height: 21px; display: block; text-align: center; background-color: rgb(142, 162, 191); font-size: 12px; font-family: initial; line-height: 1;"><svg
                            ...
                            <td valign="top" style="margin: 0.1px; padding: 0px 0px 0px 15px; cursor: pointer;"><img
                                    ...
                                    width="146" alt=" &quot;created with MySignature.io&quot;"
                                    style="display: block; min-width: 146px;"></td>
                        </tr>
                    </table>
                </td>
            </tr>
            ...
            <table width="500" cellpadding="0" style="border-collapse: collapse;">
                <tr>
                    <td style="padding: 15px 10px 0px 0px; margin: 0.1px; cursor: pointer;"><span><img
                                alt="Let's make your homeownership dreams come true!"
                                src="https://img.mysignature.io/a/v1/a/e/8/ae87af79-4eb9-5bfe-9ad4-c968b1aa3263.png"
                                style="max-width: 490px; display: block;" width="425"></span></td>
                </tr>
            </table>
            <table width="500" cellspacing="0" cellpadding="0" border="0">
                <tr>
                    <td style="margin: 0.1px; padding-top: 10px; cursor: pointer;"><img
                            src="https://img.mysignature.io/b/e/f/7/ef73206a-9bed-5f2e-aebf-6d8be914e210.png?time=1709220593"
                            valign="top" width="423" alt="created with MySignature.io" style="display: block;"></td>
                </tr>
            </table>
            <table width="500" cellspacing="0" cellpadding="0" border="0">
                <tr>
