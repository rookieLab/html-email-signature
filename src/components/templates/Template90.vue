...
<table cellpadding="0" style="border-collapse: collapse;">
<tr>
<td style='margin: 0.1px; padding: 0px 0px 2px; font: 17.5px / 22.2px "Courier New", Courier, monospace; color: rgb(0, 0, 1);'>
<span style="color: rgb(0, 0, 0); font-weight: 600; cursor: pointer;">DAVID
                                                                                THOMPSON</span><!-- --><!-- -->
</td>
</tr>
<tr>
<td style='margin: 0.1px; padding: 0px 0px 10px; font: 600 14.6px / 18.5px "Courier New", Courier, monospace; color: rgb(0, 0, 0);'>
<span style="cursor: pointer;">Sales
                                                                                Associate</span> <span style="cursor: pointer;">Sunshine
                                                                                Homes</span>
</td>
</tr><!-- -->
<tr style="cursor: pointer;">
<td style='margin: 0.1px; padding: 1px 0px; font: 14.6px / 18.5px "Courier New", Courier, monospace; color: rgb(0, 0, 0);'>
<span style="color: rgb(0, 0, 0);">w: </span><span style='color: rgb(0, 0, 0); text-decoration: none; font-family: "Courier New", Courier, monospace;'>mysignature.io</span>
</td>
</tr>
<tr style="cursor: pointer;">
<td style='margin: 0.1px; padding: 1px 0px; font: 14.6px / 18.5px "Courier New", Courier, monospace; color: rgb(0, 0, 0);'>
<span style="color: rgb(0, 0, 0);">e: </span><span style='color: rgb(0, 0, 0); text-decoration: none; font-family: "Courier New", Courier, monospace;'>david@mysignature.io</span>
</td>
</tr>
<tr style="cursor: pointer;">
<td style='margin: 0.1px; padding: 1px 0px; font: 14.6px / 18.5px "Courier New", Courier, monospace; color: rgb(0, 0, 0);'>
<span style="color: rgb(0, 0, 0);">p </span><span style='color: rgb(0, 0, 0); text-decoration: none; font-family: "Courier New", Courier, monospace;'>
                                                                                (555) 123-4567</span>
</td>
</tr><!-- -->
<tr>
<td style='margin: 0.1px; padding: 10px 0px 0px; font: 14.6px / 18.5px "Courier New", Courier, monospace; color: rgb(0, 0, 1);'>
<table cellpadding="0" style="border-collapse: collapse;">
<tr>
<td style='margin: 0.1px; padding: 0px 4px 0px 0px; font: 14.6px / 18.5px "Courier New", Courier, monospace; color: rgb(0, 0, 1); cursor: pointer;'>
<span style="border-radius: 15%; width: 21px; height: 21px; display: block; text-align: center; background-color: rgb(142, 162, 191); font-size: 12px; font-family: initial; line-height: 1;"><svg style="position: relative; top: 4.2px; width: 12.6px;" viewbox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg">
