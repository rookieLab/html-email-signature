<template>
    <div><!---->
        <table cellpadding="0"
            ...
            <tr>
                <td
                    style="margin: 0.1px; padding: 20px; font: 12.8px / 16.3px &quot;Trebuchet MS&quot;, Helvetica, sans-serif; color: rgb(0, 0, 1);">
                    <table cellpadding="0" style="border-collapse: collapse;">
                        <tr>
                            <td valign="top" style="margin: 0.1px; padding: 0px 15px 0px 0px; cursor: pointer;"><img
                                    src="https://img.mysignature.io/p/0/1/c/01cdf6fe-3ff9-5554-a8f1-924da1693e90.png?time=1709215646"
                                    width="133" alt=" &quot;created with MySignature.io&quot;"
                                    style="display: block; min-width: 133px;"></td>
                            <td valign="top"
                                style="margin: 0.1px; padding: 0px; font: 12.8px / 16.3px &quot;Trebuchet MS&quot;, Helvetica, sans-serif; color: rgb(0, 0, 1);">
                                <table cellpadding="0" style="border-collapse: collapse;">
                                    <tr>
                                        <td
                                    ...
                                    <tr>
                                        <td
                                            ...
                                            <table cellpadding="0" style="border-collapse: collapse;">
                                                <tr>
                                                    <td
                                                        style="margin: 0.1px; padding: 0px 5px 0px 0px; font: 12.8px / 16.3px &quot;Trebuchet MS&quot;, Helvetica, sans-serif; color: rgb(0, 0, 1); cursor: pointer;">
                                                        <span
                                                            style="border-radius: 50%; width: 23px; height: 23px; display: block; text-align: center; background-color: rgb(51, 124, 54); font-size: 12px; font-family: initial; line-height: 1;"><svg
            ...
            <table width="500" cellspacing="0" cellpadding="0" border="0">
                <tr>
                    <td style="margin: 0.1px; padding-top: 10px; cursor: pointer;"><span><img
                                src="https://img.mysignature.io/b/0/1/c/01cdf6fe-3ff9-5554-a8f1-924da1693e90.png?time=1709215646"
                                valign="top" width="397" alt="created with MySignature.io"
