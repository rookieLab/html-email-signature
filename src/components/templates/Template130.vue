                    ...
                    <table cellpadding="0" style="border-collapse: collapse;">
                        <tr>
                            <td valign="middle" style="margin: 0.1px; padding: 0px 15px 0px 0px; cursor: pointer;"><img
                                    src="https://img.mysignature.io/p/8/e/d/8edc20c7-09f8-5f9b-9643-e46c61bcb1f4.png?time=1685569257"
                                ...
                                <table cellpadding="0" style="border-collapse: collapse;">
                                    <tr>
                                        <td style="margin: 0.1px; padding: 4px 15px 0px 0px; cursor: pointer;"><span
                                                style="border-radius: 15%; width: 22px; height: 22px; display: block; text-align: center; background-color: rgb(133, 68, 22); font-size: 12px; font-family: initial; line-height: 1;"><svg
                                    ...
                                    <tr>
                                        <td
                                            ...
                                            <span style="cursor: pointer;">Lawyer at</span>&nbsp;<span
                                                style="cursor: pointer;">Jurisk</span></td>
                                    </tr>
