        ...
        <table cellpadding="0" width="500" style="border-collapse: collapse; font-size: 14.4px;">
                        ...
                        <tr>
                                ...
                                <table cellpadding="0" style="border-collapse: collapse;">
                                    <tr>
                                        <td style="margin: 0.1px; padding: 4px 15px 0px 0px; cursor: pointer;"><span
                                                style="border-radius: 15%; width: 22px; height: 22px; display: block; text-align: center; background-color: rgb(181, 50, 44); font-size: 12px; font-family: initial; line-height: 1;"><svg
                            ...
                            <td valign="middle" style="margin: 0.1px; padding: 0px;">
                                <table cellpadding="0" style="border-collapse: collapse;">
                                    ...
                                    <tr>
                                        <td
                                            style="margin: 0.1px; padding: 0px 0px 5px; font: 14.4px / 18.3px Arial, Helvetica, sans-serif; color: rgb(79, 42, 18);">
                                            <span style="cursor: pointer;">Realtor at</span>&nbsp;<span
                                                style="cursor: pointer;">Coastal Properties</span></td>
                                    </tr>
            ...
            <tr>
                <td
                    ...
                    <img src="https://img.mysignature.io/b/6/c/4/6c480a5c-075a-57fb-8bcf-1c00fa0fd75e.png?time=1724157566"
