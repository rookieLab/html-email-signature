                        ...
                        <table cellpadding="0" style="border-collapse: collapse;">
                            <tr>
                                <td valign="top" style="margin: 0.1px; padding: 0px 12px 0px 0px; cursor: pointer;"><img
                                        src="https://img.mysignature.io/p/d/d/1/dd1459b0-dee8-5c03-acd5-5091149f7889.png?time=1685569257"
                                        width="114" alt=" &quot;created with MySignature.io&quot;"
                                        style="display: block; min-width: 114px;"></td>
                                <td valign="top"
                                    style="border-left: 1px solid rgb(35, 30, 28); margin: 0.1px; padding: 0px 0px 0px 12px; font: 14.4px / 18.3px Verdana, Geneva, sans-serif; color: rgb(0, 0, 1);">
                                    <table cellpadding="0" style="border-collapse: collapse;">
                                        <tr>
                                            <td
                                        ...
                                        <tr>
                                            <td
                                                style="margin: 0.1px; padding: 0px 0px 8px; font: 14.4px / 18.3px Verdana, Geneva, sans-serif; color: rgb(0, 0, 1);">
                                        ...
                                        <tr style="cursor: pointer;">
                                            <td
                                                ...
                                                <span
                                                    style="color: rgb(35, 30, 28); font-weight: 600;">email:&nbsp;</span><span
                                                    style="color: rgb(0, 0, 1); text-decoration: none; font-family: Verdana, Geneva, sans-serif;">mcmanus@mysignature.io</span>
                                            </td>
                                        </tr>
                                        <tr style="cursor: pointer;">
                                            <td
                                                style="margin: 0.1px; padding: 0px; font: 14.4px / 18.3px Verdana, Geneva, sans-serif; color: rgb(0, 0, 1);">
                                                <span
                                                    style="color: rgb(35, 30, 28); font-weight: 600;">website:&nbsp;</span><span
                                        ...
                                        <tr>
                                            <td
                                                ...
                                                <table cellpadding="0" style="border-collapse: collapse;">
                                                    <tr>
                                                        <td
                                                            style="margin: 0.1px; padding: 0px 5px 0px 0px; font: 14.4px / 18.3px Verdana, Geneva, sans-serif; color: rgb(0, 0, 1); cursor: pointer;">
                                                            <span
                                                                style="border-radius: 0%; width: 22px; height: 22px; display: block; text-align: center; background-color: rgb(28, 195, 78); font-size: 12px; font-family: initial; line-height: 1;"><svg
