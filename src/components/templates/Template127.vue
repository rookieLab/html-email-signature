<template>
    <div>
        <table cellpadding="0"
            ...
            <tr>
                <td
                    style="margin: 0.1px; padding: 20px; font: 14.9px / 18.9px Arial, Helvetica, sans-serif; color: rgb(0, 0, 1);">
                    <table cellpadding="0" style="border-collapse: collapse;">
                        <tr>
                            <td valign="top" style="margin: 0.1px; padding: 0px 15px 0px 0px; cursor: pointer;"><img
                                    src="https://img.mysignature.io/p/8/4/b/84b17a8d-81e7-50a6-946e-8da5193dabbb.png?time=1685569257"
                                    width="138" alt=" &quot;created with MySignature.io&quot;"
                                    style="display: block; min-width: 138px;"></td>
                            <td valign="top"
                                style="margin: 0.1px; padding: 0px; font: 14.9px / 18.9px Arial, Helvetica, sans-serif; color: rgb(0, 0, 1);">
                                <table cellpadding="0" style="border-collapse: collapse;">
                                    <tr>
                                        <td
                                    ...
                                    <tr>
                                        <td
                                            style="margin: 0.1px; padding: 10px 0px 0px; font: 14.9px / 18.9px Arial, Helvetica, sans-serif; color: rgb(74, 74, 74);">
                                            <span
                                    ...
                                    <tr>
                                        <td
                                            ...
                                            <table cellpadding="0" style="border-collapse: collapse;">
                                                <tr>
                                                    <td
                                                        style="margin: 0.1px; padding: 0px 5px 0px 0px; font: 14.9px / 18.9px Arial, Helvetica, sans-serif; color: rgb(0, 0, 1); cursor: pointer;">
                                                        <span
                                                            style="border-radius: 0%; width: 28px; height: 28px; display: block; text-align: center; background-color: rgb(255, 255, 255); font-size: 12px; font-family: initial; line-height: 1;"><svg
            ...
            <table cellpadding="0" style="border-collapse: collapse;">
                <tr>
                    <td style="padding: 5px 4px 4px 0px; margin: 0.1px;"><span><img
                                src="https://img.mysignature.io/addons/v2/youtube_v2_shape3_i.png" height="36"
                                width="126" alt="youtube" style="display: block;"></span></td>
                    <td style="padding: 5px 4px 4px 0px; margin: 0.1px;"><span><img
                                src="https://img.mysignature.io/addons/v2/instagram_v2_shape3_i.png" height="36"
                                width="126" alt="instagram" style="display: block;"></span></td>
                    <td style="padding: 5px 4px 4px 0px; margin: 0.1px;"><span><img
