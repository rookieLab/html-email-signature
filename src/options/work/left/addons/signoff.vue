                        ...
                        <div class="o-editor-accordion__description e--addon" style="">
                                ...
                                <div>
                                        ...
                                        <div
                                                ...
                                                <label
                                                        class="o-content-block__label u-wd-12 u-mr-r1f5 u-mr-b2 u-mr-b1@xl">Font
                                                        size</label>
                                                <div
                                                        ...
                                                        <div class="slider-base">
                                                                <div class="slider-connects">
                                                                        <div class="slider-connect"
                                                                                style="transform: translate(0%, 0px) scale(0.28, 1);">
                                                                        </div>
                                                                </div>
                                                                <div class="slider-origin"
                                                                        style="transform: translate(-72%, 0px); z-index: 4;">
                                                                        <div class="slider-handle slider-handle-lower"
